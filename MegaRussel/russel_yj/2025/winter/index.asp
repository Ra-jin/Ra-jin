...
<div class="winter-wrap">
	...
	<!-- Visual -->
	<!--#include virtual="/russel_yj/2025/winter/visual.asp"-->
	<!-- Visual -->
	...
	<div class="container <%=campusName%>">
		...
		<nav class="fix-menu">
			<div class="menu">
				<a class="on" href="javascript:void(0);"><%=txtCampus02%>학원</a>
				<a href="javascript:void(0);">러셀의 윈터스쿨</a>
				<a href="javascript:void(0);">최상위권 대입 결과</a>
				<a href="javascript:void(0);">입학안내 및 학습계획표</a>
			</div>
		</nav>
		<!-- //fix-menu -->

		<!-- 최상위권 집결-->
		<!--#include virtual="/russel_yj/2025/winter/cont01.asp"-->
		<!-- //최상위권 집결, 러셀 -->

		<!-- 최상위권 대입 결과 -->
		<!--#include virtual="/russel_yj/2025/winter/cont02.asp"-->
		<!-- //최상위권 대입 결과 -->

		<!-- 실전 콘텐츠 라인업 -->
		<!-- #include virtual="/russel_yj/2025/winter/cont03.asp"-->
		<!-- //실전 콘텐츠 라인업 -->
		...
		<%
			...
			dirFile = "/russel_yj/2025/winter/"&campusName02&".asp"
		...
		<div class="bottom-bar">
			<p data-aos="fade-down" data-aos-offset="100">
				...
				2026 <%=txtCampus%> 윈터스쿨에서 Win 하는 학습 습관을 완성하세요.
			</p>
		</div>

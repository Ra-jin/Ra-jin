...
<!-- // 공통 최상단 -->
<% If Trim(GetCampusVarsSiteMGC("_CAMPUS_CODE_")) = "CD0347" OR Trim(GetCampusVarsSiteMGC("_CAMPUS_CODE_")) = "CD0348" Then '남기숙/여기숙 %>
<!-- half-wrap -->
<div class="half-wrap">

	<!-- Visual -->
	<!--#include virtual="/russel_yj/2025/half/visual.asp"-->
	<!-- Visual -->
	...
	<div class="container <%=campusName%>">
		...
		<%
			...
			dirFile = "/russel_yj/2025/half/"&campusName02&".asp"
			Server.Execute(dirFile)
		%>
		<!-- //정규반 입학 안내 -->
		
		<!-- 최상위권 집결-->
		<!--#include virtual="/russel_yj/2025/half/con01_top_rank.asp"-->
		<!-- //최상위권 집결, 러셀 -->

		<!-- 정규반 프로그램 -->
		<!--#include virtual="/russel_yj/2025/half/con02_danka.asp"-->
		<!-- //정규반 프로그램 -->

		<!-- 실전 콘텐츠 라인업 -->
		<!--#include virtual="/russel_yj/2025/half/con03_baja.asp"-->
		<!-- //실전 콘텐츠 라인업 -->

		<!-- 실전 콘텐츠 라인업 -->
		<!--include virtual="/russel_yj/2025/half/con04_lineup.asp"-->
		<!-- //실전 콘텐츠 라인업 -->

		<!-- 학습계획표&일과표 -->
		<!--include virtual="/russel_yj/2025/regular/con05_schedule.asp"-->
		<!-- //학습계획표&일과표 -->

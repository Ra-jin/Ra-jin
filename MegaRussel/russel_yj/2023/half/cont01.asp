<div class="js-cont <%=campus_name%>">
    <div class="cont01">
        ...
        <% If sCampusCode = "CD0347" Then '서의치기숙 %>
            <div class="v-img02 pt20"><img src="<%=img_path_russelsm%>/2023/half/cont01_tit.png" alt="메가스터디 최초, 최상위권 여학생 전문관 러셀 기숙학원" /></div>
    ...
    <div class="cont02">
        ...
        <div class="cont02_1">
            <div class="inner">
                ...
                <p class="img" style="position: relative;left:-70px;"><img src="<%=img_path_russelsm%>/2023/half/cont02_img2.png" alt=""></p>
                <ul class="list-02 r-txt" style="margin-right:70px;">
        ...
        <div class="pass-wrap">
            <div class="inner">
                ...
                <p class="img"><img src="<%=img_path_russelsm%>/2023/half/pass_img01.png" alt=""></p>
                <p class="pt20"><img src="<%=img_path_russelsm%>/2023/half/pass_img02.png" alt=""></p>
                <p class="img" style="padding-top:16px;"><img src="<%=img_path_russelsm%>/2023/half/pass_list.png" alt=""></p>
            </div>
        </div>
        <% ElseIf sCampusCode = "CD0348" Then '기숙여최상위권 %>
        <div class="inner">
            <div class="img"><img src="<%=img_path_russelw%>/2023/half/cont02_tit_n.png" alt="왜 여학생 전문 기숙학원이 필요할까요?" /></div>
        ...
        <div class="cont02_1">
            <div class="inner">
                <div class="v-img mb60"><img src="<%=img_path_russelw%>/2023/half/cont02_tit02.png" alt="그렇다면 왜, 최상위권 여학생 전문관 러셀 기숙학원 일까요?" /></div>
                <p class="img"><img src="<%=img_path_russelw%>/2023/half/cont02_01_stit.png" alt=""></p>
            </div>
            <div class="full-img">
                <div class="l-area">
                    <p><img src="<%=img_path_russelw%>/2023/half/right_text.png" alt=""></p>
                </div>
                <div class="r-area">
                    <p><img src="<%=img_path_russelw%>/2023/half/left_text.png" alt=""></p>
                </div>
            </div>
            <div class="inner">
                <!-- 데이터 산출 기준 -->
                ...
                <ul class="data-txt">
                    <li>1) 메가스터디 전 학원 내 2020-2023학년도 의·치·한·수·약 대학 합격자수 기준 (홈페이지 대입 실적 기준 / 2023.02.20 기준) 및<br>
        ...
        <div class="pass-wrap">
            ...
            <div class="inner">
                <p style="padding:59px 0;"><img src="<%=img_path_russelw%>/2023/half/ico_plus.png" alt=""></p>
                <p style="padding-bottom:30px;"><img src="<%=img_path_russelw%>/2023/half/pass_txt.png" alt=""></p>
                <p class="img" style="padding-bottom: 0;"><img src="<%=img_path_russelw%>/2023/half/pass_img.png" alt=""></p>
            </div>
        </div>
        <% Else %>
        <div class="inner">

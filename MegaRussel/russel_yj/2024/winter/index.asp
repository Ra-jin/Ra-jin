...
<div class="winter-wrap">
	...
	<!-- Visual -->
	<!--#include virtual="/russel_yj/2024/winter/visual.asp"-->
	<!-- //Visual -->

	<!-- Contents -->
	
	<!-- 최상위권의 선택 -->
	<!-- #include virtual="/russel_yj/2024/winter/tab01_top_choice.asp"-->
	<!-- //최상위권의 선택 -->

	<!-- 윈터스쿨 프로그램-->
	<!-- #include virtual="/russel_yj/2024/winter/tab02_program.asp"-->
	<!-- //윈터스쿨 프로그램-->
	
	<!-- 학원별 컨텐츠 -->
	<%
		dirFile = "/russel_yj/2024/winter/"&campusName02&".asp"
    ...
    <div class="bottom-bar">
        ...
        <p>
			<strong>최상위권 여학생 소수정예 관리,</strong><br>
			러셀 기숙학원 윈터스쿨은 대입성공의 첫걸음 입니다.
        </p>
		<%  ElseIf sCampusCode = "CD0347" Then '서의치 %>
        <p>
			최상위권 학생들, 검증된 강사진과 함께<br>
			남학생 전문관 러셀 기숙학원 윈터스쿨에서 시작하면<br>
			<strong>결과는 최상위권 대입성공입니다.</strong>
        </p>
		<% Else %>
        <p>
            러셀 기숙학원 윈터스쿨은 <strong>대입성공의 시작</strong>입니다.
        </p>
		<% End If %>
    </div>
	<!-- //Contents -->

	...
	<div class="layer-wrap">
		...
		<table class="tbl-01">
			...
			<tbody>
				...
				<tr>
					...
					<td>PM 11:00</td>
					<td>50분</td>
					<td colspan="2" rowspan="2"><span class="ico-txt s">자습</span></td>
					<td rowspan="2">(이용불가)</td>
				</tr>
				<tr>
					<td>10교시</td>
		...
		<table class="tbl-01">
			...
			<tbody>
				<tr>
					<th rowspan="4" class="bg-sky">오전</th>
					<td class="bg-gray">0교시</td>
					<td class="bg-gray">AM 07:00~AM 07:50</td>
					<td class="bg-gray">50분</td>
					<td class="bg-gray"><span class="ico-txt s">선택자습</span></td>
					<td class="bg-gray"><span class="ico-txt s">선택자습</span></td>
					<td class="bg-gray"><span class="ico-txt s">선택자습</span></td>
				</tr>
				<tr>
					...
					<td>
						...
						<span class="red_txt">*1월만 진행</span>
					</td>
					<td rowspan="3">
					...
					<td class="bg-gray" rowspan="3"><span class="ico-txt s">선택자습</span></td>
				</tr>
				<tr>
					<td>2교시</td>
					<td>AM 08:50~AM 10:10</td>
				...
				<tr>
					...
					<td rowspan="3" class="bg-gray"><span class="ico-txt s">선택자습</span></td>
				</tr>
				<tr>
					<td>5교시</td>
					<td>PM 02:40~PM 04:00</td>
				...
				<tr>
					...
					<td class="bg-gray" rowspan="2"><span class="ico-txt s">선택자습</span></td>
				</tr>
				<tr>
					<td>8교시</td>
					<td>PM 08:20~PM 09:50</td>
				...
				<tr>
					...
					<td class="bg-gray">PM 10:10~PM 11:00</td>
					<td class="bg-gray">50분</td>
					<td class="bg-gray" rowspan="2" colspan="2"><span class="ico-txt s">선택자습</span></td>
					<td class="bg-gray" rowspan="2">(이용불가)</td>
				</tr>
				<tr>
					<td class="bg-gray">10교시</td>
					<td class="bg-gray">PM 11:10~AM 12:00</td>
					<td class="bg-gray">50분</td>
				</tr>
			</tbody>
		</table>
		...
		<table class="tbl-01">
			...
			<tbody>
				...
				<tr>
					<th colspan="2">일일 학습컨텐츠</th>
					<td>PM 01:10</td>
					<td>PM 01:20</td>
					<td>10분</td>
					<td colspan="2"><strong>[월~금 : 주간지 또는 영단어 테스트 / 토 : 영어듣기 / 일 : 자습]</strong><br>
						<span class="fz12">(* 단, 토요일은 “PM 01:00”부터 영어듣기 진행)</span>
					</td>
				</tr>
				<tr>
					<th rowspan="4" class="bg-sky">오후</th>
		...
		<table class="tbl-01">
			...
			<tbody>
				...
				<tr>
					...
					<td>23:10</td>
					<td>50분</td>
					<td rowspan="2"><span class="ico-txt s">선택자습</span><br> (신청서 제출)</td>
					<td rowspan="2">(이용불가)</td>
				</tr>
				<tr>
					<td>10교시</td>
		...
		<p class="r-stxt mt10">
			※ 바자관 표준 시간표는 층별 및 시기별 학습 전략에 따라 유동적으로 운영됩니다.</p>
		...
		<table class="tbl-01">
			...
			<tbody>
				...
				<tr>
					...
					<td>50분</td>
					<td rowspan="2"><span class="ico-txt s">선택자습</span></td>
					<td rowspan="2" colspan="2" class="red">이용불가</td>
				</tr>
				<tr>
					<td>10교시</td>
					<td>PM 11:10 ~ AM 12:00</td>

...
<div class="cont js-cont <%=campusName%>">
    ...
    <div class="cont01">
        <div class="inner">      
            <p data-aos="fade-up"><img src="<%=imgUrl%>/cont01_tit.png" alt="" /></p>    
            <p class="mt72"><img src="<%=imgUrl%>/cont01_img.png" alt="매년 성적 향상과 최상위권 대학 합격의 결과로 검증된 러셀 기숙학원입니다." /></p>
    ...
    <div class="cont01-2">
        <div class="inner">
            <p data-aos="fade-up"><img src="<%=img_path_russelsm%>/2024/regular/cont01-2_tit.png" alt="" /></p>
            <ul class="bulloon-box">
                <li data-aos="fade-up-right"><img src="<%=img_path_russelsm%>/2024/regular/cont01-2_img01.png" alt="" /></li>
                <li data-aos="fade-up-left"><img src="<%=img_path_russelsm%>/2024/regular/cont01-2_img02.png" alt="" /></li>
                <li data-aos="fade-up-right"><img src="<%=img_path_russelsm%>/2024/regular/cont01-2_img03.png" alt="" /></li>
            </ul>
            <p data-aos="fade-up"><img src="<%=img_path_russelsm%>/2024/regular/cont01-2_txt.png" alt="" /></p>
        </div>
    </div>
    <% Else %>
    <div class="cont01">
        <div class="inner">
            <!-- 데이터 산출기준 -->
            <p><img src="<%=img_path_yangji%>/2024/regular/cont01_img.png" alt="매년 성적 향상과 최상위권 대학 합격의 결과로 검증된 러셀 기숙학원입니다." /></p>
            <div class="info-stxt">
    ...
    <div class="cont02">
        <div class="inner">
            <p data-aos="fade-up" class="mb30"><img src="<%=img_path_russelw%>/2024/regular/cont02_tit.png" alt="" /></p>
            <div class="mb80"><img src="<%=img_path_russelw%>/2024/regular/cont02_img.png" alt="" /></div>
            <p data-aos="fade-up" class="mb30"><img src="<%=img_path_russelw%>/2024/regular/cont02_tit02.png" alt="" /></p>
            <div><img src="<%=img_path_russelw%>/2024/regular/cont02_img02.png" alt="" /></div>
        </div>
    </div>
    <% ElseIf sCampusCode = "CD0347" Then '서의치 %>
    <div class="cont02-1">
        <div class="inner">
            <p data-aos="fade-up" class="mb45"><img src="<%=img_path_russelsm%>/2024/regular/cont02_tit.png" alt="" /></p>
            <div><img src="<%=img_path_russelsm%>/2024/regular/cont02_img.png" alt="" /></div>
        </div>
    </div>
    <% Else %>
    <div class="cont02">
        <div class="inner">
            <p class="tit"><img src="<%=img_path_yangji%>/2024/regular/cont02_tit.png" alt="러셀 기숙학원만의 강학 관리력으로 이뤄낸 비약적인 성적 향상의 결과" /></p>
            <ul class="review-list">
                <li data-aos="zoom-in-up">
                    <div style="position:relative;">
                        <img src="<%=img_path_yangji%>/2024/regular/cont02_img01.jpg" alt="김인" />
                ...
                <li data-aos="zoom-in-up">
                    <div style="position:relative;">
                        <img src="<%=img_path_yangji%>/2024/regular/cont02_img02.jpg" alt="오세욱" />
                ...
                <li data-aos="zoom-in-up">
                    <div style="position:relative;">
                        <img src="<%=img_path_yangji%>/2024/regular/cont02_img03.jpg" alt="김동욱" />
                ...
                <li data-aos="zoom-in-up">
                    <div style="position:relative;">
                        <img src="<%=img_path_yangji%>/2024/regular/cont02_img04.jpg" alt="시정우" />
                ...
                <li data-aos="zoom-in-up">
                    <div style="position:relative;">
                        <img src="<%=img_path_yangji%>/2024/regular/cont02_img05.jpg" alt="박성우" />
                ...
                <li data-aos="zoom-in-up">
                    <div style="position:relative;">
                        <img src="<%=img_path_yangji%>/2024/regular/cont02_img06.jpg" alt="박세연" />
    ...
    <div class="cont03">
        <p data-aos="fade-up" class="mb70"><img src="<%=img_path_russelsm%>/2024/regular/cont03_tit.png" alt="" /></p>
        <div><img src="<%=img_path_russelsm%>/2024/regular/cont03_img.jpg" alt="" /></div>
    </div>
    <!-- //cont03 -->
    <!-- cont03-1 -->
    <div class="cont03-1">
        <div class="inner03">
            <p data-aos="fade-up" class="mb60"><img src="<%=img_path_russelsm%>/2024/regular/cont03-1_tit.png" alt="" /></p>
            <div><img src="<%=img_path_russelsm%>/2024/regular/cont03-1_img.jpg" alt="" /></div>
            <p class="r-txt mt20" style="padding-right: 110px;">※ 강사진은 운영 상황에 따라 변경될 수 있습니다.</p>
        </div>
    </div>
    <!-- //cont03-1 -->
    <% End If %>
    ...
    <div class="bottom-bar">
        <% If sCampusCode = "CD0347" Then '서의치 %>
        <p data-aos="zoom-in">기숙학원 재원생의 니즈를 충족시키는 <span>신개념 융합형 기숙학원!</span> <br> <span><%=txtCampus%>이 기숙의 새로운 기준</span>을 만들어가겠습니다.</p>
        <% Else %>
        <p data-aos="zoom-in"><span><%=txtCampus%> 러셀 기숙학원</span>에서 <br> 성적 향상과 최상위권 대입성공의 주인공이 되세요.</p>
        <% End If %>
    </div>
    <!--// 배너 -->

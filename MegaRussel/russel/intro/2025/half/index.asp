...
<div class="half-wrap">
	...
	<div class="container <%=campusName%>">
		...
		<!-- 최소 시간 수준별 맞춤 단과-->
		<!--#include virtual="/intro/2025/half/con01_top_rank.asp"-->
		<!-- //최소 시간 수준별 맞춤 단과-->

		<!-- 정규반 시스템 -->
		<!--#include virtual="/intro/2025/half/con02_system.asp"-->
		<!-- //정규반 시스템 -->

		<!-- 실전 콘텐츠 라인업 -->
		<!--#include virtual="/intro/2025/half/con03_lineup.asp"-->
		<!-- //실전 콘텐츠 라인업 -->
		...
		<!-- 학원별 모집안내 -->
		<div class="cont">
			<div class="cont07" id="cont07">
				<div class="inner">
					<div data-aos="fade-down">
						<h4 class="mb20">
							<strong>2026 러셀 반수반</strong> 모집 안내
						</h4>
						<p class="mb70">학원별 모집 요강, 장학혜택 및 상세 등록 방법은 각 학원으로 문의 바랍니다.</p>
					</div>

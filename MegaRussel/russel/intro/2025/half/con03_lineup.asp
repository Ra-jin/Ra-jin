<div class="cont js-cont <%=campusName%>">
	<div class="cont06">
		<h4 data-aos="flip-up"><img src="<%=Application("img_path_russel")%>/intro/2025/half/cont06_tit.png" alt=""></h4>
		<% If sCampusCode = "CD0257" Then '중계 %>
		<p class="s-tit mb100" data-aos="flip-up">한, 두 문제로 합격의 당락이 좌우되는 수능에서 실전력은 필수입니다.<br>
		...
		<div class="inner02">
			...
			<h4 class="mt100 mb50"><img src="<%=Application("img_path_russel")%>/intro/2025/half/cont06_tit02.png" alt=""></h4>
				...
				<% ElseIf sCampusCode = "CD0343" or sCampusCode = "CD0249" Then '코어원주 %>
				<div class="moth-box">
					<ul class="moth-list">
						<li class="moth">3월</li>
						<li class="bg-y">[풀 모의고사]<br>
				...
				<p class="r-txt">* 상기 일정은 평가원 시행 계획 및 학원별 학사일정에 따라 변경 및 조정될 수 있습니다.</p>
				<% Else %>
...
<div class="bt-banner">
	...
	<p>짧은 시간 더 높은 목표의 대학에 합격하는 공식 <%=txtCampus%> 반수반<br>
		<strong><%=txtCampus%> 반수반과 함께한다면<br>
			2026 대입 합격 결과의 주인공은 여러분입니다.</strong></p>
	<% ElseIf sCampusCode = "CD0340" Then '코어광주 %>
	<p>짧은 시간 더 높은 목표의 대학에 합격하는 공식 <%=txtCampus%> 반수정규반<br>
		<strong><%=txtCampus%> 반수정규반과 함께한다면<br>

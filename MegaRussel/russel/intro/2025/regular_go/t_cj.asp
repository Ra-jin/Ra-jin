        ...
        <div class="inner">
            ...
            <ul class="a-process step-over">
                <li>
                    ...
                    <a href="https://corecj.megastudy.net/russel/apply/yonhab/apply.asp?app_cd=184" class="btn-gray-s mt20">원서접수 바로가기 </a>
                </li>
                <li>
                    ...
                    <ul class="list-05">
                        <li class="fz14">성적표 제출 방식 : 별도 안내 예정</li>
                    </ul>       
                </li>
                <li>
            ...
            <!-- 장학혜택 -->
            <h3 class="tit mt100"><strong>재학생 특별 입학 전형 / 장학혜택</strong></h3>
            <div class="tbl-box type02">
                <!-- 모집요강 자동화 시스템 영역 -->
                <%
                '관리자 코드 입력부 (관리자 > 학사정보관리 > 모집요강 의 idx 값)

    ...
    <div class="cont00">
        <div class="inner">
            ...
            <div class="step-box type02">
                <div class="step-wrap">
                    <p class="tit"><span>STEP 1</span>원서접수 방법 및 합격자 발표
                        <a href="https://russeldc.megastudy.net/russel/apply/yonhab/apply.asp?app_cd=184" class="btn-gray-s ml_10">온라인 원서접수 바로가기</a>
                    </p>
                    <div class="box">
                        <p>※ 원서접수 방법 [온라인]</p>
                        <ul class="list-03">
                        ...
                        <p class="mt10">※ 합격자 발표 [입학 절차 포함 문자 안내]</p>
                    </div>
                </div>
                <div class="step-wrap">
                    <p class="tit"><span>STEP 2</span>단과 수업 선택 및 등록</p>
                    <div class="box">
                        <p>※ 등록 방법 [온라인 또는 학원 방문]</p>
                        <ul class="list-03">

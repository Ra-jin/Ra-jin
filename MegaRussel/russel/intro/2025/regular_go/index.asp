...
<head>
    ...
    <meta property="og:title" content="2026 재학생 정규반">
	<meta property="og:description" content="2026 재학생 정규반, 재학생 정규반" />
	...
	<div class="container <%=campusName%>">
		...
		<nav class="fix-menu">
			<div class="menu">
				...
				<a href="javascript:void(0);">재학생 맞춤 시스템</a>
				<a href="javascript:void(0);">러셀 실전 콘텐츠</a>
				<a href="javascript:void(0);">모집안내</a>
				<% Else %>
				<a class="on" href="javascript:void(0);">모집안내</a>
				<a href="javascript:void(0);"><%=fix_02%></a>
				<a href="javascript:void(0);"><%=fix_03%></a>
				<a href="javascript:void(0);">러셀 실전 콘텐츠</a>
				<% End If %>
			</div>
		</nav>
		...
		<!-- 최상위권 집결-->
		<!--#include virtual="/intro/2025/regular_go/con01_top_rank.asp"-->
		<!-- //최상위권 집결, 러셀 -->

		<!-- 정규반 시스템 -->
		<!--#include virtual="/intro/2025/regular_go/con02_system.asp"-->
		<!-- //정규반 시스템 -->

		<!-- 실전 콘텐츠 라인업 -->
		<!--#include virtual="/intro/2025/regular_go/con03_contents.asp"-->
		<!-- //실전 콘텐츠 라인업 -->
			...
			<div class="cont10">
				<div class="inner">
					<div data-aos="fade-down">
						<h3>
							2026 러셀 <strong>재학생 정규반</strong> 모집안내
						</h3>
...
<script>
	...
	// 학원 문자수신 알리미 nonLogin
	function fncAlarmPop02(){
        var url = "/russel/entinfo/popup_notice_service_nonlogin.asp";
		window.open(url,'popup_smsalarm','scrollbars=yes,width=794,height=800,top=0,left='+ popupX);
	}
    //aos fadeup 효과
    AOS.init({

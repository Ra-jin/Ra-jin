    ...
    <div class="cont00">
        <div class="inner">
            ...
            <div class="step-box type02">
                <div class="step-wrap">
                    <p class="tit"><span>STEP 1</span>온라인 원서접수 <a href="https://corecw.megastudy.net/russel/apply/yonhab/apply.asp?app_cd=184" class="btn-gray-s ml_10">원서접수 바로가기</a>
                    </p>
                </div>
                <div class="step-wrap">
                    <p class="tit"><span>STEP 2</span>성적표 제출/사전예약금 납부

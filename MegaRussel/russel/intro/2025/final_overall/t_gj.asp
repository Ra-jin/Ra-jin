...
<div class="cont js-cont">
    ...
    <div class="cont00">
        <div class="inner">            
            <h3 class="tit">러셀CORE 광주 파이널 종합반 <strong>모집 개요</strong></h3>
            ...
            <h3 class="tit mt100">러셀CORE 광주 파이널 종합반 <strong>입학 절차 안내</strong></h3>
            ...
            <!-- 모집요강 및 지원 혜택 -->
            <h3 class="tit mt100">러셀CORE 광주 파이널 종합반 <strong>모집 요강 & 지원 혜택</strong></h3>
            <div class="tbl-box type02">
                 <!-- 모집요강 자동화 시스템 영역 -->
                <%
                    '관리자 코드 입력부 (관리자 > 학사정보관리 > 모집요강 의 idx 값)

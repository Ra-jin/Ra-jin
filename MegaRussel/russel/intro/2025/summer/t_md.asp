...
<div class="cont js-cont russel_md">
    ...
    <div class="cont00">
        <div class="inner">
            <div style="margin-top: -58px;"><img src="<%=Application("img_path_russel")%>/russel_mokdong/2025/summer/event_md.png" alt="" /></div>
            <!-- 입학절차 -->
            <h3 class="tit mt100">러셀 목동 썸머스쿨 <strong>입학 절차 안내</strong></h3>
            <ul class="a-process ">
                <li>
                    <div class="flag">STEP 1</div>
                    <p>온라인 원서 접수 및 성적표 제출
                    </p>
                </li>
                <li>
                    <div class="flag">STEP 2</div>
                    <p>강의 선택 및 학원 방문 실등록 (6월 예정)<br>
                        <span class="red_txt" style="font-weight:500">[전형에 따라 모집 인원은 상이할 수 있습니다.]</span>
                    </p>
                </li>
            </ul>
            <!-- //입학절차 -->
            ...
            <div class="step-box type02">
                <div class="step-wrap">
                    ...
                    <div class="box">
                        <ul class="list-04">
                            <li>
                                반드시 학생 ID로 로그인 하신 후 온라인 원서 접수 진행 바랍니다.
                            </li>
                            <li class="red_txt">온라인 원서 접수 시, 성적표 사진 파일 등록은 필수입니다.</li>
                            <li class="red_txt">성적표 재제출로 인한 전형 변경은 썸머스쿨 개강일 전까지만 가능합니다. (썸머스쿨 시작일 이후 변경 불가능)</li>
                ...
                <div class="step-wrap">
                    ...
                    <div class="box">
                        <ul class="list-04">
                            <li>썸머스쿨 실등록은 <span class="red_txt">‘현장’</span>에서만 가능합니다.
                            </li>
                            <li class="red_txt">원서 접수를 완료한 학생, 학부모 대상으로 순차적으로 유선 연락 또는 문자를 통해 입학 절차 안내가 이뤄집니다.</li>
                            <li class="red_txt">온라인 전형 접수 우선 등록을 하였더라도 전형별 인원에 따라 등록이 불가할 수 있습니다.</li>
                        ...
                        <ul class="list-04 mt0">
                            ...
                            <li class="red_txt">2학기부터는 [재학생 정규반] 지원 정책으로 변경 적용됩니다. [의무 시수 0T]
                            </li>
                            <li>자습관 출석 일수 저조 시 강제 퇴원 조치가 진행되며 특이사항 발생 시, 담임 선생님과 상담 후 결정해야 합니다.
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            <!-- 모집요강 -->
            <h3 class="tit mt100">러셀 목동 썸머스쿨 <strong>모집 요강 및 지원 혜택</strong></h3>

...
<div class="cont js-cont russel_gn">
    ...
    <div class="cont00">
        <div class="inner">
            ...
            <table class="tbl-plan type02 p0">
                ...
                <thead>
                    <tr>
                        ...
                        <th>2월</th>
                        <th>3~6월</th>
                        <th class="on">7~8월<span>현재 모집중</span></th>
                        <th>9~11월</th>
                        <th>11~12월</th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
                        ...
                        <td>재학생 최상위권반</td>
                        <td>썸머스쿨<br>
                            <a href="https://russelgn.megastudy.net/russel/apply/yonhab/apply.asp?app_cd=189">원서접수</a>
                        </td>
                        <td>[고3] 파이널 정규반<br>
                            [고2] 재학생 최상위권반
                        </td>
            ...
            <div class="step-box type02">
                <div class="step-wrap">
                    <p class="tit"><span>STEP 1</span>원서 접수 
                        <a href="https://russelgn.megastudy.net/russel/apply/yonhab/apply.asp?app_cd=189" class="btn-gray-s ml_10">원서접수 바로가기</a>
                    </p>
                    <div class="box">
                        <ul class="list-02">
                            <li>원서 접수를 완료한 학생, 학부모 대상으로 문자를 통해 입학 절차가 안내됩니다.</li>
                            <li>7/16(수)부터 원서 접수 후 사전예약금 납부 없이 단과 및 바자관 실등록 진행합니다.</li>
                            <li>원서 접수 확인 후 개별 연락으로 등록 절차 안내할 예정입니다.</li>
                        </ul>
                    </div>
                </div>
                <div class="step-wrap">
                    <p class="tit"><span>STEP 2</span>성적표 제출 
                        <a href="http://pf.kakao.com/_hKnRb" class="btn-gray-s ml_10">성적표 제출하기</a>
                    </p>
                    <div class="box">
                        <ul class="list-02">
                            <li>제출 방법 : 성적표 제출하기 버튼 클릭 > 카톡 채널 "러셀강남학원 입학처" 추가 > 상담원 채팅 > 성적표 이미지 파일 전송
                            </li>
                ...
                <div class="step-wrap">
                    ...
                    <div class="box">
                        <ul class="list-02">
                            <li>반별 필수 수강 시수에 맞춰 수강 희망하는 강의를 등록합니다.
                            </li>
                        </ul>
                    </div>
                </div>
                <div class="step-wrap">
                    ...
                    <div class="box">
                        <ul class="list-02">
                            <li>강의 등록이 완료되면 마이페이지에서 바자관 등록이 가능합니다.
                            </li>
                            <li>바자관 등록 확인 후 사전 예약금은 순차적으로 환불해 드립니다. (요청 불필요)</li>
            ...
            <!-- 모집요강 -->
            <h3 class="tit mt100">러셀 강남 썸머스쿨 <strong>모집 요강 및 지원 혜택</strong></h3>

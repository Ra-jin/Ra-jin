...
<div class="cont js-cont russel_pc">
    <!-- cont00 -->
    <div class="cont00">
        <div class="inner">
            <!-- 입학절차 -->
            <h3 class="tit">러셀 평촌 썸머스쿨 <strong>입학 절차 안내</strong></h3>
            <ul class="a-process">
                <li>
            ...
            <div class="step-box type02">
                <div class="step-wrap">
                    <p class="tit"><span>STEP 1</span>성적표 제출 및 원서 접수

                        <!-- <a href="javascript:alert('추후 오픈 예정입니다.');" class="btn-gray-s ml_10">원서접수 바로가기</a> -->
                    </p>
                    <div class="box">
                        <ul class="list-02">
                            <li>전형에 맞는 성적표 제출을 통해 입학 절차 안내가 이뤄집니다.
                ...
                <div class="step-wrap">
                    <p class="tit"><span>STEP 2</span>전형 확인 및 강의 선택
                    </p>
                    <div class="box">
                        <ul class="list-04">
            ...
            <!-- 모집요강 -->
            <h3 class="tit mt100">러셀 평촌 썸머스쿨 <strong>모집 요강 및 지원 혜택</strong></h3>

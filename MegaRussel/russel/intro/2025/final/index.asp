...
<head>
	<meta name="title" content="2026 러셀 파이널 정규반" />
...
<div class="final-wrap">
	...
	<!-- 컨텐츠 -->
	<!-- #include virtual="/intro/2025/final/cont01.asp"-->
	<!-- //컨텐츠-->
    ...
    <div class="cont js-cont final-info">
        <div class="inner">
			<h3><img src="<%=Application("img_path_russel")%>/intro/2025/final/intro_final_info.png" alt="2024 러셀 파이널 정규반 모집안내" /></h3>

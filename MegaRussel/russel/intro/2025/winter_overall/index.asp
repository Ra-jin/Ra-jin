	...
	<div class="container <%=campusName%>">
		...
		<nav class="fix-menu">
			<div class="menu">
				...
				<a href="javascript:void(0);">러셀 종합반 시스템</a>
				...
				<div class="mozip" style='left:61px;'>
					...
					<span>
						<img src="<%=Application("img_path_russel")%>/intro/2025/winter_overall/bubble.png" alt="7월 사전 접수 시작" />
						<img src="<%=Application("img_path_russel")%>/intro/2025/winter_overall/bubble_off.png" alt="7월 사전 접수 시작" />
					</span>
					<span>
						<img src="<%=Application("img_path_russel")%>/intro/2025/winter_overall/bubble02.png" alt="7월 사전 접수 시작" />
						<img src="<%=Application("img_path_russel")%>/intro/2025/winter_overall/bubble02_off.png" alt="7월 사전 접수 시작" />
					</span>
					<% ElseIf sCampusCode = "CD0340" or sCampusCode = "CD0249" or sCampusCode = "CD0342" Then '코어광주/영통/대구 %>
					<span>
						<img src="<%=Application("img_path_russel")%>/intro/2025/winter_overall/bubble03.png" alt="8월 사전 접수 시작" />
						<img src="<%=Application("img_path_russel")%>/intro/2025/winter_overall/bubble03_off.png" alt="8월 사전 접수 시작" />
					</span>
					<span>
						<img src="<%=Application("img_path_russel")%>/intro/2025/winter_overall/bubble04.png" alt="8월 사전 접수 시작" />
						<img src="<%=Application("img_path_russel")%>/intro/2025/winter_overall/bubble04_off.png" alt="8월 사전 접수 시작" />
					</span>
					<% End If %>
				</div>
			</div>
		...
		<!-- 최상위권 집결, 러셀-->
		<!--#include virtual="/intro/2025/winter_overall/tab01_rank.asp"-->
		<!-- //최소 시간 수준별 맞춤 단과-->

		<!-- 여름 방학, 최상위권 도약의 기회 -->
		<!--#include virtual="/intro/2025/winter_overall/tab02_opportunity.asp"-->
		<!-- //정규반 시스템 -->

		<!-- 윈터스쿨 프로그램 -->
		<!--#include virtual="/intro/2025/winter_overall/tab03_program.asp"-->
		<!-- //실전 콘텐츠 라인업 -->

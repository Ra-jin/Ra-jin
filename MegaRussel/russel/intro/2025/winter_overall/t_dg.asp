...
<div class="cont js-cont russel_dg">
    ...
    <div class="cont00">
        <div class="inner">
            <!-- 모집 개요 -->
            <h3 class="tit">러셀 대구 윈터스쿨 종합반 <strong>모집 개요</strong></h3>
            ...
            <!-- 입학절차 -->
            <h3 class="tit mt100">러셀 대구 윈터스쿨 종합반 <strong>입학 절차 안내</strong></h3>
            ...
            <!-- 모집요강 -->
            <h3 class="tit mt100">러셀 대구 윈터스쿨 종합반 <strong>입학 기준 및 지원 혜택</strong></h3>

...
<div class="half-wrap">
	...
	<div class="container <%=campusName%>">
		...
		<!-- 최소 시간 수준별 맞춤 단과-->
		<!--#include virtual="/intro/2025/half_overall/con01_top_rank.asp"-->
		<!-- //최소 시간 수준별 맞춤 단과-->

		<!-- 정규반 시스템 -->
		<!--#include virtual="/intro/2025/half_overall/con02_system.asp"-->
		<!-- //정규반 시스템 -->

		<!-- 실전 콘텐츠 라인업 -->
		<!--#include virtual="/intro/2025/half_overall/con03_lineup.asp"-->
		<!-- //실전 콘텐츠 라인업 -->

        ...
        <div class="inner">
            ...
            <ul class="a-process step-over full-step">
                <li>
                    ...
                    <a class='bt-apply ml0' href='https://russelus.megastudy.net/russel/apply/jaejung/apply.asp?app_cd=181'>원서접수 바로가기</a>
                </li>
                <li>
            ...
            <!-- 모집요강 -->
            <h3 class="tit mt100"><strong>입학 기준 및 장학혜택</strong></h3>

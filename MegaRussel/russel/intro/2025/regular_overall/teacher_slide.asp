        ...
        <ul class="swiper-wrapper">
            ...
            <li class="swiper-slide">
                <div class="info-box">
                    ...
                    <span class="t-explain">성균관대 교육학 졸업</span>
                </div>
            ...
            <li class="swiper-slide">
                <div class="info-box">
                    <span class="cate">현장강의</span>
                    <span class="t-sub">수학</span>
                    <span class="t-info"><strong>최봉서</strong> 선생님</span>
                    <span class="t-explain">감각을 흔들어주는 수업</span>
                </div>
                <p class="pic"><img src="<%=Application("img_path_russel")%>/teacher/slide/math_cbs.png" alt="" /></p>
                <div class="ico-box">
            ...
            <li class="swiper-slide">
                <div class="info-box">
                    ...
                    <span class="t-info"><strong>김민경</strong> 선생님</span>
                    <span class="t-explain">한국외대 <br>TESOL대학원 석사</span>
                </div>
                <p class="pic"><img src="<%=Application("img_path_russel")%>/teacher/slide/eng_kmk.png" alt="" /></p>
                <div class="ico-box">
                    <p><span>러셀<br>중계</span></p>
            ...
            <li class="swiper-slide">
                <div class="info-box">
                    ...
                    <span class="t-explain">기본부터 완벽한 Framing</span>
                </div>
...
<style>
    .teacher-wrap.fullPage .teacher-sub-list .info-box{height: 110px !important;}
</style>
<div class="teacher-wrap fullPage">
    <div class="teacher-sub-list swiper-container">
        <ul class="swiper-wrapper">

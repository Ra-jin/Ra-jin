<div class="cont js-cont <%=campusName%>">
    <div class="cont11">
        <h3 data-aos="fade-down" class="mb80"><img src="<%=Application("img_path_russel")%>/<%=campusName%>/2025/regular_overall/cont11_tit.png" alt="러셀에서 최상위권 대입성공이 가능한 이유 러셀에는 실전 수능에 완벽하게 대비할 수 있는 최상위권 맞춤 실전 콘텐츠가 있습니다."></h3>
        <div class="inner">
                ...
                <div class="program-slide swiper-container">
                    <div class="swiper-wrapper">
                        ...
                        <% If sCampusCode = "CD0250" Then '부천 %>
                            <img src="<%=Application("img_path_russel")%>/<%=campusName%>/2025/regular_overall/program_slide02.png" alt="">
                        ...
                        <% Else %>
                            <img src="<%=Application("img_path_russel")%>/intro/2025/regular_overall/program_slide02_v2.png" alt="">
                        ...
                        <div class="swiper-slide">
                            <img src="<%=Application("img_path_russel")%>/intro/2025/regular_overall/program_slide01_v2.png" alt="성적 향상을 위한 핵심 발판, ‘나의 위치 파악’">
                        ...
                        <div class="swiper-slide">
                            <img src="<%=Application("img_path_russel")%>/intro/2025/regular_overall/program_slide03_v2.png" alt="">
                            <a href="/event/2025/alpha/index.asp" style="z-index:2;position:absolute;left:540px;top:360px;width:121px;height:35px;"></a>
                        </div>
                        <div class="swiper-slide">
                            <img src="<%=Application("img_path_russel")%>/intro/2025/regular_overall/program_slide04_v2.png" alt="">
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="cont12">
        <div class="inner">
            <% If sCampusCode = "CD0250" Then '부천 %>
            <p class="mb80" data-aos="fade-down"><img src="<%=Application("img_path_russel")%>/<%=campusName%>/2025/regular_overall/cont12_tit.png" alt="최상위권 맞춤 실전 콘텐츠 과목별 시행 일정" /></p>
            <% Else %>
            <p class="mb80" data-aos="fade-down"><img src="<%=Application("img_path_russel")%>/intro/2025/regular_overall/cont12_tit.png" alt="최상위권 맞춤 실전 콘텐츠 과목별 시행 일정" /></p>
            <% End If %>
            <% If sCampusCode = "CD0250" Then '부천 %>
            <div class="tbl-box">
            ...
            <p class="mt80"><img src="<%=Application("img_path_russel")%>/intro/2025/regular_overall/cont12_img.png" alt=""></p>
        </div>
    </div>
    <div class="bottom-bar">
        <p data-aos="fade-down" data-aos-offset="100">
            <%=txtCampus%> 재수종합반에서<br>

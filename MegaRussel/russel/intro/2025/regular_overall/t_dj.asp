...
<div class="cont js-cont">
    <div class="s-page">
        ...
        <div>
            <img src="<%=Application("img_path_russel")%>/core_dj/2025/regular_overall/event_promo.png" alt="" />
        </div>
    </div>
    <!-- cont00 -->
    <div class="cont00">
        <div class="inner">
            ...
            <ul class="a-process step-over full-step">
                <li>
                    ...
                    <a href="https://coredj.megastudy.net/russel/apply/jaejung/apply.asp?app_cd=181" class="btn-gray-s mt15">원서접수 바로가기</a>
                </li>
                <li>
...
<script>
    // tab 버튼 공통
    tabMenu('.bt-tab','.cont-box')  // 탭버튼 부모(a태그 부모), 탭컨텐츠 CLASS추가
</script>
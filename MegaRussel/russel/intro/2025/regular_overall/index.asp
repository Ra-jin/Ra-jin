...
<head>
    <meta name="title" content="2026 재수 종합반" />
    <meta name="keywords" content="2026 재수 종합반, 재수 종합반, 러셀 2026 재수 종합반, 메가스터디 러셀 재수 종합반" />
	<meta name="description" content="바른공부 자습전용관 2026 재수 종합반" />
	<meta property="og:type" content="website">
    <meta property="og:title" content="2026 재수 종합반">
	<meta property="og:description" content="2026 재수 종합반, 재수 종합반" />
...
<div class="regular-wrap">
	...
	<!-- Visual -->
	<!--#include virtual="/intro/2025/regular_overall/visual.asp"-->
	<!-- Visual -->
	...
	<div class="container <%=campusName%>">
		...
		<nav class="fix-menu">
			<div class="menu">
				...
				<a href="javascript:void(0);">종합반 시스템</a>
		...
		<%
			...
			dirFile = "/intro/2025/regular_overall/"&campusName02&".asp"
		...
		<!-- 최상위권 집결-->
		<!--#include virtual="/intro/2025/regular_overall/con01_top_rank.asp"-->
		<!-- //최상위권 집결, 러셀 -->

		<!-- 정규반 시스템 -->
		<!--#include virtual="/intro/2025/regular_overall/con02_system.asp"-->
		<!-- //정규반 시스템 -->

		<!-- 실전 콘텐츠 라인업 -->
		<!--#include virtual="/intro/2025/regular_overall/con03_lineup.asp"-->
		<!-- //실전 콘텐츠 라인업 -->

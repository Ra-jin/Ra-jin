        ...
        <div class="inner">
            ...
            <ul class="a-process step-over">
                <li>
                    ...
                    <a href="https://corecw.megastudy.net/russel/apply/jaejung/apply.asp?app_cd=180" class="btn-gray-s ml_10 mt10">원서접수 바로가기</a>
                </li>
                <li>
                    ...
                    <p class="fz12">* 성적표 제출 시 반편성 및 사전예약금 납부 안내</p>
                </li>
                <li>

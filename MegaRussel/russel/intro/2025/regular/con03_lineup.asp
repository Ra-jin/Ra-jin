<div class="cont js-cont <%=campusName%>">
    <div class="cont08">
        ...
        <h3 data-aos="fade-down"><img src="<%=Application("img_path_russel")%>/intro/2025/regular/cont08_tit.png" alt="러셀에서 최상위권 대입성공이 가능한 이유 러셀에는 실전 수능에 완벽하게 대비할 수 있는 최상위권 맞춤 실전 콘텐츠가 있습니다."></h3>
        <% Else %>
        <h3 data-aos="fade-down"><img src="<%=Application("img_path_russel")%>/<%=campusName%>/2025/regular/cont08_tit.png" alt="러셀에서 최상위권 대입성공이 가능한 이유 러셀에는 실전 수능에 완벽하게 대비할 수 있는 최상위권 맞춤 실전 콘텐츠가 있습니다."></h3>
        <% End If %>
        <div class="inner">
                ...
                <div class="program-slide swiper-container">
                    <div class="swiper-wrapper">
                        ...
                        <% If sCampusCode = "CD0250" OR sCampusCode = "CD0257" Then '부천/중계 %>
                            <img src="<%=Application("img_path_russel")%>/<%=campusName%>/2025/regular/program_slide02.png" alt="">
                        ...
                        <div class="swiper-slide">
                            <img src="<%=Application("img_path_russel")%>/intro/2025/regular/program_slide01_v2.png" alt="성적 향상을 위한 핵심 발판, ‘나의 위치 파악’">
                        ...
                        <% End If %>
                        <div class="swiper-slide">
                            <img src="<%=Application("img_path_russel")%>/intro/2025/regular/program_slide04_v2.png" alt="">
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="cont09">
        <div class="inner">
            ...
            <p class="mb80" data-aos="fade-down" data-aos-offset="10"><img src="<%=Application("img_path_russel")%>/<%=campusName%>/2025/regular/cont09_tit.png" alt="재학생 맞춤 실전 콘텐츠 과목별 시행 일정" /></p>
            <% Else %>
            <p class="mb80" data-aos="fade-down" data-aos-offset="10"><img src="<%=Application("img_path_russel")%>/intro/2025/regular/cont09_tit.png" alt="최상위권 맞춤 실전 콘텐츠 과목별 시행 일정" /></p>
            <% End If %>
            <% If sCampusCode = "CD0257" Then '중계 %>
            <div class="tbl-box">
            ...
            <% End If %>
            <p class="mt80">
                <% If sCampusCode = "CD0346" Then '청주 %>
                <img src="<%=Application("img_path_russel")%>/<%=campusName%>/2025/regular/cont09_img.png" alt="">
                <% Else %>
                <img src="<%=Application("img_path_russel")%>/intro/2025/regular/cont09_img.png" alt="">
                <% End If %>
            </p>
        </div>
    </div>
    <div class="bottom-bar">
        ...
        <p data-aos="fade-down" data-aos-offset="10">
            ...
            <strong>최상위권 대입성공을 위한 경쟁력이 높아집니다.</strong>
        </p>
        <% ElseIf sCampusCode = "CD0257" Then '중계 %>
        <p data-aos="fade-down" data-aos-offset="10">
            <%=txtCampus%> N수 정규반에서<br>
            <strong>성적 향상 및 목표 대학 합격을 위한 경쟁력이 높아집니다.</strong>
        </p>
        <% Else %>
        <p data-aos="fade-down" data-aos-offset="10">
            <%=txtCampus%> N수 정규반에서<br>

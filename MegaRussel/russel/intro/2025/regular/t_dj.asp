...
<div class="cont js-cont core_dj">
    ...
    <div class="cont00">
        <div class="inner">
            <h3 class="tit"><strong>러셀 대전 N수 정규반 프로모션</strong></h3>
            <div>
                <img src="<%=Application("img_path_russel")%>/intro/2025/regular/banner_promotion.jpg" alt="" />
            </div>
            ...
            <ul class="a-process step-over">
                <li>
                    ...
                    <a href="https://coredj.megastudy.net/russel/apply/jaejung/apply.asp?app_cd=180" class="btn-gray-s mt15">원서접수 바로가기</a>
                </li>
                <li>

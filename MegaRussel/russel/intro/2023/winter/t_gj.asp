...
<div class="cont js-cont">
    ...
    <div class="cont00">
        <div class="inner02">
            <!-- 입학절차 -->
            <p class="mb90"><img src="<%=Application("img_path_russel")%>/core_gj/2023/winter/cont00_tit.png" alt="입학절차"></p>
            <div class="step-wrap">
                <div class="step-info-wrap core" style="border-radius: 20px;border-bottom:1px solid #dbdbdb;">
                    <div class="step-list pl10 pr10">
                        ...
                        <a href="https://coregj.megastudy.net/russel/apply/yonhab/apply.asp?app_cd=158" class="btn-gray-s">원서접수 바로가기</a>
                    </div>
                    <div class="step-list">
            ...
            <!-- 모집요강 및 지원혜택 -->
            <p class="mt100 mb90"><img src="<%=Application("img_path_russel")%>/core_gj/2023/winter/cont00_tit01.png" alt="모집요강 및 지원혜택"></p>
            <div class="tbl-box">
                <!-- 모집요강 자동화 시스템 영역 -->
                <%

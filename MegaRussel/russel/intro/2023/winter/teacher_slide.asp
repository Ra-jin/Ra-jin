...
<div class="teacher-swiper js-teacher-swiper swiper-container">
    <div class="swiper-wrapper">
        ...
        <div class="swiper-slide">
            <dl class="t-name">
                <dt>국어</dt>
                <dd><strong>권미경</strong> 선생님</dd>
            </dl>
            <span class="t-img"><img src="<%=Application("img_path_russel")%>/teacher/slide/ko_kmk.png" alt=""></span>
        </div>
        <div class="swiper-slide">
            <dl class="t-name">
                <dt>국어</dt>
        ...
        <!-- <div class="swiper-slide">
            <dl class="t-name">
                <dt>국어</dt>
                <dd><strong>박담</strong> 선생님</dd>
            </dl>
            <span class="t-img"><img src="<%=Application("img_path_russel")%>/teacher/slide/ko_pd.png" alt=""></span>
        </div> -->
        <div class="swiper-slide">
            <dl class="t-name">
                <dt>국어</dt>
        ...
        <div class="swiper-slide">
            <dl class="t-name">
                <dt>국어</dt>
                <dd><strong>서영우</strong> 선생님</dd>
            </dl>
            <span class="t-img"><img src="<%=Application("img_path_russel")%>/teacher/slide/ko_syw.png" alt=""></span>
        </div>
        <div class="swiper-slide">
            <dl class="t-name">
                <dt>국어</dt>
        ...
        <div class="swiper-slide">
            <dl class="t-name">
                <dt>수학</dt>
                <dd><strong>김재은</strong> 선생님</dd>
            </dl>
            <span class="t-img"><img src="<%=Application("img_path_russel")%>/teacher/slide/math_kje.png" alt=""></span>
        </div>
        <div class="swiper-slide">
            <dl class="t-name">
                <dt>수학</dt>
        ...
        <!-- <div class="swiper-slide">
            ...
            <span class="t-img"><img src="<%=Application("img_path_russel")%>/teacher/slide/eng_ljy2.png" alt=""></span>
        </div> -->
        <div class="swiper-slide">
            <dl class="t-name">
                <dt>영어</dt>
        ...
        <!-- <div class="swiper-slide">
            <dl class="t-name">
                <dt>지구과학2</dt>
                <dd><strong>정낙훈</strong> 선생님</dd>
            </dl>
            <span class="t-img"><img src="<%=Application("img_path_russel")%>/teacher/slide/sci_jnh.png" alt=""></span>
        </div> -->
        <!-- 논술 -->
        <div class="swiper-slide">
            <dl class="t-name">
...
<!-- 부천 -->
<div class="teacher-swiper js-teacher-swiper swiper-container bc">
    <div class="swiper-wrapper">
        <!-- 국어 -->
        <div class="swiper-slide">
            <dl class="t-name">
        ...
        <div class="swiper-slide">
            ...
            <span class="t-img"><img src="<%=Application("img_path_russel")%>/teacher/slide/ko_lhh.png" alt="이현호"></span>
        </div>
        <div class="swiper-slide">
            <dl class="t-name">
                <dt>국어</dt>
        ...
        <div class="swiper-slide">
            ...
            <span class="t-img"><img src="<%=Application("img_path_russel")%>/teacher/slide/ko_jis02.png" alt=""></span>
        </div>
        <div class="swiper-slide">
            <dl class="t-name">
                <dt>국어(고1&middot;고2)</dt>
        ...
        <div class="swiper-slide">
            <dl class="t-name">
                <dt>수학(고1&middot;고2)</dt>
                <dd><strong>감동길</strong> 선생님</dd>
            </dl>
            <span class="t-img"><img src="<%=Application("img_path_russel")%>/teacher/slide/math_kdk.png" alt=""></span>
        </div>
        <div class="swiper-slide">
            <dl class="t-name">
                <dt>수학(고1&middot;고2)</dt>
        ...
        <div class="swiper-slide">
            ...
            <span class="t-img"><img src="<%=Application("img_path_russel")%>/teacher/slide/math_khc02.png" alt=""></span>
        </div>
        <!-- <div class="swiper-slide">
            <dl class="t-name">
                <dt>수학(고1&middot;고2)</dt>
                <dd><strong>오지이</strong> 선생님</dd>
            </dl>
            <span class="t-img"><img src="<%=Application("img_path_russel")%>/teacher/slide/math_oje.png" alt=""></span>
        </div> -->
        <div class="swiper-slide">
            <dl class="t-name">
                <dt>수학(고1&middot;고2)</dt>
        ...
        <!-- <div class="swiper-slide">
            <dl class="t-name">
                <dt>영어(고1&middot;고2)</dt>
                <dd><strong>박정민</strong> 선생님</dd>
            </dl>
        ...
        <div class="swiper-slide">
            ...
            <span class="t-img"><img src="<%=Application("img_path_russel")%>/teacher/slide/soc_lyw02.png" alt=""></span>
        </div>
        <!-- 과학 -->
        <div class="swiper-slide">
            <dl class="t-name">
        ...
        <div class="swiper-slide">
            ...
            <span class="t-img"><img src="<%=Application("img_path_russel")%>/teacher/slide/sci_ksy03.png" alt=""></span>
        </div>
        <div class="swiper-slide">
            <dl class="t-name">
                <dt>화학 I</dt>
        ...
        <!-- <div class="swiper-slide">
            <dl class="t-name">
                <dt>물리학 I</dt>
                <dd><strong>손지호</strong> 선생님</dd>
            </dl>
            <span class="t-img"><img src="<%=Application("img_path_russel")%>/teacher/slide/sci_sjh.png" alt=""></span>
        </div> -->
        <!-- <div class="swiper-slide">
            <dl class="t-name">
                <dt>화학 I</dt>
        ...
        <!-- <div class="swiper-slide">
            <dl class="t-name">
                <dt>화학 I (고2)</dt>
                <dd><strong>차병건</strong> 선생님</dd>
            </dl>
            <span class="t-img"><img src="<%=Application("img_path_russel")%>/teacher/slide/sci_cbg.png" alt=""></span>
        </div> -->
        <div class="swiper-slide">
            <dl class="t-name">
                <dt>물리학 I(고2)</dt>
        ...
        <div class="swiper-slide">
            <dl class="t-name">
                <dt>통합과학/생명과학 I<br>(고1&middot;고2)</dt>
                <dd><strong>유한승</strong> 선생님</dd>
            </dl>
            <span class="t-img"><img src="<%=Application("img_path_russel")%>/teacher/slide/sci_yhs02.png" alt=""></span>
        </div>
    </div>
</div>
...
<div class="teacher-swiper js-teacher-swiper swiper-container">
    <div class="swiper-wrapper">
        ...
        <div class="swiper-slide">
            ...
            <span class="t-img"><img src="<%=Application("img_path_russel")%>/teacher/slide/ko_khs2.png" alt=""></span>
        </div>
        <div class="swiper-slide">
            <dl class="t-name">
                <dt>국어</dt>
...
<div class="teacher-swiper js-teacher-swiper swiper-container">
    <div class="swiper-wrapper">
        ...
        <!-- <div class="swiper-slide">
            <dl class="t-name">
                <dt>국어</dt>
                <dd><strong>박영호</strong> 선생님</dd>
            </dl>
            <span class="t-img"><img src="<%=Application("img_path_russel")%>/teacher/slide/ko_pyh.png" alt=""></span>
        </div> -->
        <div class="swiper-slide">
            <dl class="t-name">
                <dt>국어</dt>
        ...
        <div class="swiper-slide">
            ...
            <span class="t-img"><img src="<%=Application("img_path_russel")%>/teacher/slide/non_kjh02.png" alt=""></span>
        </div>
        <div class="swiper-slide">
            <dl class="t-name">
                <dt>인문논술</dt>
        ...
        <div class="swiper-slide">
            ...
            <span class="t-img"><img src="<%=Application("img_path_russel")%>/teacher/slide/non_hth02.png" alt=""></span>
        </div>
    </div>
</div>
...
<div class="teacher-swiper js-teacher-swiper swiper-container">
    <div class="swiper-wrapper">
        ...
        <div class="swiper-slide">
            <dl class="t-name">
                <dt>국어</dt>
                <dd><strong>강상우</strong> 선생님</dd>
            </dl>
            <span class="t-img"><img src="<%=Application("img_path_russel")%>/teacher/slide/ko_ksw.png" alt=""></span>
        </div>
        <div class="swiper-slide">
            <dl class="t-name">
                <dt>국어</dt>
        ...
        <div class="swiper-slide">
            <dl class="t-name">
                <dt>국어</dt>
                <dd><strong>이민옥</strong> 선생님</dd>
            </dl>
            <span class="t-img"><img src="<%=Application("img_path_russel")%>/teacher/slide/ko_lmo.png" alt=""></span>
        </div>
        <div class="swiper-slide">
            <dl class="t-name">
                <dt>국어</dt>
        ...
        <div class="swiper-slide">
            <dl class="t-name">
                <dt>영어</dt>
                <dd><strong>김혜지</strong> 선생님</dd>
            </dl>
            <span class="t-img"><img src="<%=Application("img_path_russel")%>/teacher/slide/eng_khj.png" alt=""></span>
        </div>
        <div class="swiper-slide">
            <dl class="t-name">
                <dt>영어</dt>
        ...
        <div class="swiper-slide">
            <dl class="t-name">
                <dt>영어</dt>
                <dd><strong>지소희</strong> 선생님</dd>
            </dl>
            <span class="t-img"><img src="<%=Application("img_path_russel")%>/teacher/slide/eng_jsh.png" alt=""></span>
        </div>
        <div class="swiper-slide">
            <dl class="t-name">
                <dt>영어</dt>
        ...
        <div class="swiper-slide">
            <dl class="t-name">
                <dt>영어</dt>
                <dd><strong>최진실</strong> 선생님</dd>
            </dl>
            <span class="t-img"><img src="<%=Application("img_path_russel")%>/teacher/slide/eng_cjs.png" alt=""></span>
        </div>
        <!-- 사회 -->
        <div class="swiper-slide">
            <dl class="t-name">
        ...
        <div class="swiper-slide">
            ...
            <span class="t-img"><img src="<%=Application("img_path_russel")%>/teacher/slide/sci_cbg02.png" alt=""></span>
        </div>
        <div class="swiper-slide">
            <dl class="t-name">
                <dt>생명과학Ⅰ</dt>
...
<div class="teacher-swiper js-teacher-swiper swiper-container">
    <div class="swiper-wrapper">
        ...
        <div class="swiper-slide">
            ...
            <span class="t-img"><img src="<%=Application("img_path_russel")%>/teacher/slide/ko_kse.png" alt=""></span>
        </div>
        <div class="swiper-slide">
            <dl class="t-name">
                <dt>국어</dt>
        ...
        <div class="swiper-slide">
            <dl class="t-name">
                <dt>국어(내신)</dt>
                <dd><strong>강유진</strong> 선생님</dd>
            </dl>
            <span class="t-img"><img src="<%=Application("img_path_russel")%>/teacher/slide/ko_kyj.png" alt=""></span>
        </div>
        <div class="swiper-slide">
            <dl class="t-name">
                <dt>국어(내신)</dt>
                <dd><strong>권문수</strong> 선생님</dd>
            </dl>
            <span class="t-img"><img src="<%=Application("img_path_russel")%>/teacher/slide/ko_kms.png" alt=""></span>
        </div>
        <div class="swiper-slide">
            <dl class="t-name">
                <dt>국어(내신)</dt>
        ...
        <div class="swiper-slide">
            <dl class="t-name">
                <dt>수학(내신)</dt>
                <dd><strong>강도하</strong> 선생님</dd>
            </dl>
            <span class="t-img"><img src="<%=Application("img_path_russel")%>/teacher/slide/math_kdh02.png" alt=""></span>
        </div>
        <div class="swiper-slide">
            <dl class="t-name">
                <dt>수학(내신)</dt>
        ...
        <div class="swiper-slide">
            <dl class="t-name">
                <dt>수학(내신)</dt>
                <dd><strong>서민국</strong> 선생님</dd>
            </dl>
            <span class="t-img"><img src="<%=Application("img_path_russel")%>/teacher/slide/math_smk.png" alt=""></span>
        </div>
        <div class="swiper-slide">
            <dl class="t-name">
                <dt>수학(내신)</dt>
        ...
        <div class="swiper-slide">
            <dl class="t-name">
                <dt>수학(내신)</dt>
                <dd><strong>이승주</strong> 선생님</dd>
            </dl>
            <span class="t-img"><img src="<%=Application("img_path_russel")%>/teacher/slide/math_lsj.png" alt=""></span>
        </div>
        <!-- 영어 -->
        <div class="swiper-slide">
            <dl class="t-name">
        ...
        <div class="swiper-slide">
            ...
            <span class="t-img"><img src="<%=Application("img_path_russel")%>/teacher/slide/eng_ib.png" alt=""></span>
        </div>
        <div class="swiper-slide">
            <dl class="t-name">
                <dt>영어</dt>
        ...
        <div class="swiper-slide">
            <dl class="t-name">
                <dt>영어(내신)</dt>
                <dd><strong>이효진</strong> 선생님</dd>
            </dl>
            <span class="t-img"><img src="<%=Application("img_path_russel")%>/teacher/slide/eng_lhj.png" alt=""></span>
        </div>
        <div class="swiper-slide">
            <dl class="t-name">
                <dt>영어(내신)</dt>
        ...
        <div class="swiper-slide">
            ...
            <span class="t-img"><img src="<%=Application("img_path_russel")%>/teacher/slide/soc_krh.png" alt=""></span>
        </div>
        <div class="swiper-slide">
            <dl class="t-name">
                <dt>동아시아/세계사/한국사</dt>
        ...
        <div class="swiper-slide">
            <dl class="t-name">
                <dt>생명과학/통합과학(내신)</dt>
                <dd><strong>이호재</strong> 선생님</dd>
            </dl>
            <span class="t-img"><img src="<%=Application("img_path_russel")%>/teacher/slide/sci_lhj.png" alt=""></span>
        </div>
        <div class="swiper-slide">
            <dl class="t-name">
                <dt>생명과학/통합과학(내신)</dt>
        ...
        <div class="swiper-slide">
            <dl class="t-name">
                <dt>일본어</dt>
                <dd><strong>이선옥</strong> 선생님</dd>
            </dl>
            <span class="t-img"><img src="<%=Application("img_path_russel")%>/teacher/slide/sl_lso.png" alt=""></span>
        </div>
        <div class="swiper-slide">
            <dl class="t-name">
                <dt>스페인어</dt>
                <dd><strong>천예솔</strong> 선생님</dd>
            </dl>
            <span class="t-img"><img src="<%=Application("img_path_russel")%>/teacher/slide/sl_cys.png" alt=""></span>
        </div>
        <div class="swiper-slide">
            <dl class="t-name">
                <dt>러시아어</dt>
                <dd><strong>빠샤</strong> 선생님</dd>
            </dl>
            <span class="t-img"><img src="<%=Application("img_path_russel")%>/teacher/slide/sl_ps.png" alt=""></span>
        </div>
        <div class="swiper-slide">
            <dl class="t-name">
                <dt>독일어</dt>
                <dd><strong>민병필</strong> 선생님</dd>
            </dl>
            <span class="t-img"><img src="<%=Application("img_path_russel")%>/teacher/slide/sl_mbp.png" alt=""></span>
        </div>
    </div>
</div>
...
<!-- 대구 -->
<!-- 강사진 -->
<!-- #include virtual="/common/inc/t_list/t_list_full_dg.asp" -->
<% ElseIf sCampusCode = "CD0349" Then '울산 %>
<!-- 울산 -->
<!-- 강사진 -->
<!-- #include virtual="/common/inc/t_list/t_list_full_us_03.asp" -->
...
<!-- 코어대전 -->
<!-- 강사진 -->
<!-- #include virtual="/common/inc/t_list/t_list_full_dj.asp" -->
...
<!-- 코어전주 -->
<!-- 강사진 -->
<!-- #include virtual="/common/inc/t_list/t_list_full_jj.asp" -->
...
<div class="inner02 mb80">
    <p class="r-txt math30 mb50">※ 학원 홈페이지에서 학원별 출강 선생님을 확인할 수 있으며, 학원 운영에 따라 출강 선생님은 변경될 수 있습니다.</p>
</div>
<% ElseIf sCampusCode = "CD0244" Then '분당 %>
<div class="inner02 mb80">
    <p class="r-txt math30 mb50">* 2023년 기준 수능 강사진이며, 2024년 강사진은 추후 공개 예정입니다. </p>
</div>
<% ElseIf sCampusCode = "CD0257" Then '중계 %>
<div class="inner02 mb80">
    <p class="r-txt math30 mb50">※ 2023년 출강 강사진 기준<br>※ 강사진 순서는 가나다 순입니다.</p>
</div>
<% ElseIf sCampusCode <> "CD0342" Then '대구  %>
<div class="inner02 mb80">
    <p class="r-txt math30 mb50">* 출강 강사진은 학원 운영에 따라 변경될 수 있습니다.</p>
</div>
<% End If %>
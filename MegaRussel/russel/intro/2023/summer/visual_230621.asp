...
Select Case GetCampusVarsSiteMGC("_CAMPUS_CODE_")	' method.asp 인클루드 안한 페이지에서 오류날 수 있지만, 안쓰는 페이지가 없을거라 가정
    ...
    Case "CD0247": txtCampus = "러셀 강남"  '강남
					tit01 = "모집 현황"
					txt01 = "<p class='tal'>고3 마감 (대기 접수  중) <span class='red_txt fz18'>고2 접수 마감 (대기 불가)</span></p>"
					tit02 = "운영 기간"
					txt02 = "7/17(월) ~ 8/15(화)"
	...
	Case "CD0246": txtCampus = "러셀 센텀"   '센텀
					...
					txt02 = "7/15(토) 개강"
					txt03 = "현장 또는 온라인 접수ㅣ대기 접수 중 <a href='http://russelct.megastudy.net/russel/apply/yonhab/apply.asp?app_cd=154' class='bt-apply'>원서접수 바로가기</a>"
	...
	Case "CD0343": txtCampus = "러셀CORE 원주"  '코어원주
					...
					txt01 = "고3&middot;고2&middot;고1"
					txt02 = "7월 17일 (월)"
					txt03 = "현장 또는 온라인 접수 | 현재 모집 중 <a href='https://corewj.megastudy.net/russel/apply/yonhab/apply.asp?app_cd=154' class='bt-apply'>원서접수 바로가기</a>"

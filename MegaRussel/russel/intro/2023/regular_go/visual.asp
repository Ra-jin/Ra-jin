...
Select Case GetCampusVarsSiteMGC("_CAMPUS_CODE_")	' method.asp 인클루드 안한 페이지에서 오류날 수 있지만, 안쓰는 페이지가 없을거라 가정
    ...
    Case "CD0245": txtCampus = "러셀 목동"   '목동
					...
					tit02 = "개강일"
					txt02 = "9/1(금) 개강"
					txt03 = "<strong>온라인 접수 중</strong><a href='https://russelmd.megastudy.net/russel/info/notice/notice_view.asp?Code=28842&sGubun=&sGCode=CD0023&keyfield=&keyword=&curPage=1' class='bt-apply'>대기자 접수 바로가기</a><br /><span class='fz14'>※온라인 대기 접수를 완료하면 여석 발생 시 접수 순서대로 유선 안내 혹은 문자 드리겠습니다.</span>"
	...
	Case "CD0244": txtCampus = "러셀 분당"   '분당
					...
					tit03 = "접수 방법"
					txt03 = "<strong>온라인 대기 접수 후 성적표 제출</strong><a href='https://russelbd.megastudy.net/russel/apply/yonhab/apply.asp?app_cd=152' class='bt-apply'>대기 접수 바로가기</a><br /><span class='fz14'>*온라인 대기 접수를 완료하면 이후 대기 순서에 따라 입학 절차를 개별적으로 안내해드립니다</span>"
...
%>
    ...
    <div class="visual-area">
		...
		<div class="ico-end" style="top:450px;left:50%;"><div><%=end_txt%></div></div>
		<% ElseIf sCampusCode = "CD0001" OR sCampusCode = "CD0257" OR sCampusCode = "CD0346"  Then '대치/중계/청주 %>
		...
		<div class="quick">
			...
			<div class="go-wrap">
				<a href="https://russeldg.megastudy.net/russel/campus_common/russel_danka/russel_danka_new.asp?idx=1321" class="go-con">고3</a>
				<a href="https://russeldg.megastudy.net/russel/campus_common/russel_danka/russel_danka_new.asp?idx=1322" class="go-con">고2</a>
			</div>

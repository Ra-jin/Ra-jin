...
Select Case GetCampusVarsSiteMGC("_CAMPUS_CODE_")
	...
	Case "CD0244": txtCampus = "러셀 분당"   '분당
					...
					tit01 = "접수 기간"
					txt01 = "현재 접수 中<span class='c-txt'>*모집요강 지원자격 해당자 순 접수</span>"
					txt02 = "온라인 원서 접수 후 성적표 제출 <a href='https://russelbd.megastudy.net/russel/apply/jaejung/apply.asp?app_cd=155' class='bt-apply'>온라인 원서 접수하기</a>"
					comment = "*온라인 원서 접수를 완료하면 이후 입학 절차를 개별적으로 안내해드립니다."
...
%>
    ...
    <div class="visual-area">
		...
		<div class="visual">
			...
			<!-- 마감 딱지 -->
			<% If sCampusCode = "CD0001" OR sCampusCode = "CD0257" Then '대치/중계 %>

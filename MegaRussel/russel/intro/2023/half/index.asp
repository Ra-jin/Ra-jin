...
<head>
    <meta name="title" content="2024 러셀 반수반" />
    <meta name="keywords" content="2024 러셀 반수반, 러셀 반수반, 2024 러셀반수반, 러셀반수반" />
	<meta name="description" content="바른공부 자습전용관 2024 러셀 반수반" />
	<meta property="og:type" content="website">
    <meta property="og:title" content="2024 러셀 반수반">
	<meta property="og:description" content="2024 러셀 반수반, 반수 정규반" />
...
<div class="half-wrap <%=campusName%>">
    ...
    <div class="final-cont">
        ...
        <%
            If campusName02 <> "" Then
                dirFile = "/intro/2023/half/"&campusName02&".asp"
	...
	<!-- 결과로 증명하는 반수반 -->
	<!--#include virtual="/intro/2023/half/tab_01.asp"-->
	<!-- //결과로 증명하는 반수반 -->

	<!-- 반수생 맞춤 시스템 -->
	<!--#include virtual="/intro/2023/half/tab_02.asp"-->
	<!-- //반수생 맞춤 시스템 -->
    ...
    <div class="cont js-cont">
        ...
        <div class="cont08">
            <div class="inner">
                <p class="mb50"><img src="<%=Application("img_path_russel")%>/intro/2023/half/cont08_tit.png" alt="2024 러셀 반수반 모집 안내" /></p>

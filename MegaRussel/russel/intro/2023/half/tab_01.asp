                ...
                <div class="graph-list">
                    ...
                    <div class="graph03">
                        ...
                        <div>
                            ...
                            <p class="txt" style="padding-top: 210px;"><img src="<%=Application("img_path_russel")%>/russel_dg/2023/half_overall/rise_03_01.png" alt=""></p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="cont02">
        ...
        <div class="card-swiper swiper-container">
            <div class="swiper-wrapper">
                ...
                <!-- 강남/대치/목동/부천/분당/영통/중계/평촌/센텀 학원 -->
                <% Elseif sCampusCode  = "CD0247" OR sCampusCode  = "CD0001" OR sCampusCode  = "CD0245" OR sCampusCode  = "CD0250" OR sCampusCode  = "CD0244" OR sCampusCode  = "CD0246" OR sCampusCode  = "CD0249" OR sCampusCode  = "CD0257" OR sCampusCode  = "CD0248" Then '러셀강남/러셀대치/러셀목동/러셀부천/러셀분당/러셀센텀/러셀영통/러셀중계/러셀평촌 %>
                <div class="swiper-slide double">
                    <p>
                        <% If sCampusCode  = "CD0244" Then '러셀분당 %>
                        <img src="<%=Application("img_path_russel")%>/intro/2023/half/card_01_bd.jpg" alt="러셀분당 이현승" />
                        <% Else %>
                        <img src="<%=Application("img_path_russel")%>/intro/2023/half/card_01.jpg" alt="러셀 이현승" />
                        <% End If %>
                ...
                <div class="swiper-slide">
                    <p>
                        <% If sCampusCode  = "CD0245" Then '러셀목동 %>
                        <img src="<%=Application("img_path_russel")%>/intro/2023/half/card_02_md.jpg" alt="러셀목동 류재용" />
                        <% Else %>
                        <img src="<%=Application("img_path_russel")%>/intro/2023/half/card_02.jpg" alt="러셀 류재용" />
                        <% End If %>
                ...
                <div class="swiper-slide">
                    <p>
                        <% If sCampusCode  = "CD0001" Then '러셀대치 %>
                        <img src="<%=Application("img_path_russel")%>/intro/2023/half/card_06_dc.jpg" alt="러셀대치 정재훈" />
                        <% Else %>
                        <img src="<%=Application("img_path_russel")%>/intro/2023/half/card_06.jpg" alt="러셀 정재훈" />
                        <% End If %>
                ...
                <div class="swiper-slide">
                    <p>
                        <% If sCampusCode  = "CD0257" Then '러셀중계 %>
                        ...
                        <% End if %>
                        <span class="cover-play" onclick="viewPlay('35058678')"></span>
                        
                    </p>
                </div>
                <div class="swiper-slide">
                    <p>
                        <% If sCampusCode  = "CD0246" Then '러셀센텀 %>
                        ...
                        <% End If %>
                        <span class="cover-play" onclick="viewPlay('33008685')"></span>
                        
                    </p>
                </div>
                <div class="swiper-slide">
                    <p>
                        <% If sCampusCode  = "CD0248" Then '러셀평촌 %>
                        <img src="<%=Application("img_path_russel")%>/intro/2023/half/card_08_pc.jpg" alt="러셀평촌 박찬미">
                        <% Else %>
                        <img src="<%=Application("img_path_russel")%>/intro/2023/half/card_08.jpg" alt="러셀 박찬미">
                        <% End If %>
                ...
                <div class="swiper-slide">
                    <p>
                        ...
                        <% End If %>
                        <span class="cover-play" onclick="viewPlay('35702670')"></span>
                        
                    </p>
                </div>
                <div class="swiper-slide">
                    <p>
                        <img src="<%=Application("img_path_russel")%>/intro/2023/half/card_13.jpg" alt="러셀 최재원">
                        <span class="cover-play" onclick="viewPlay('34866696')"></span>
        ...
        <div class="roll-swiper swiper-container">
            <div class="swiper-wrapper">
                <div class="swiper-slide">
                    <div class="name-tag">고려대학교 의과대학</div>
                    <div class="cont-tag">
                ...
                <div class="swiper-slide">
                    <div class="name-tag">한양대학교 의예과</div>
                    <div class="cont-tag">
                ...
                <div class="swiper-slide">
                    <div class="name-tag">중앙대학교 의학부</div>
                    <div class="cont-tag">
                ...
                <div class="swiper-slide">
                    <div class="name-tag">단국대학교 의예과</div>
                    <div class="cont-tag">
                ...
                <div class="swiper-slide">
                    <div class="name-tag">전남대학교 의예과</div>
                    <div class="cont-tag">
                ...
                <div class="swiper-slide">
                    ...
                    <div class="cont-tag">
                        <img src="<%=Application("img_path_russel")%>/intro/2023/uni_logo/logo_josun.jpg" alt="조선대학교 로고" />
                        <% If sCampusCode  = "INTRO" Then '인트로 %>
                ...
                <div class="swiper-slide">
                    <div class="name-tag">건양대학교 의학과</div>
                    <div class="cont-tag">
                ...
                <div class="swiper-slide">
                    <div class="name-tag">동아대학교 의예과 </div>
                    <div class="cont-tag">

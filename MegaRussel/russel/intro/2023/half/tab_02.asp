...
<div class="cont js-cont">
                    ...
                    <div class="swiper-container baja-slide">
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide">
                                ...
                                <div class="st-review">
                                    ...
                                    <div class="right-con">
                                        <div>
                                            <p>
                                                <strong>바자관과 강의실이 한 건물에 있어서 이동시간에 대한 부담이 없었고,시간을 효율적으로 관리</strong>할 수<br>있었습니다.
                                                또한, 단과 수업이 다양해서 저에게 맞는 수업을 선택하여 수강할 수 있었다는 점이<br>
                                                만족스러웠습니다.
                                            </p>
                                            <p style="margin-right: 0px;"><strong>원광대학교 치의예과 합격</strong> 러셀 분당 최영서</p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="swiper-slide">
                                ...
                                <div class="st-review">
                                    ...
                                    <div class="right-con">
                                        <div>
                                            <p>
                                                러셀 분당 바자관의 좋은 점은 무엇보다 <strong>아무런 방해를 받지 않고 공부에 몰입할 수 있도록 해준다<br>는 것입니다.</strong> 바자관 내의 온도, 습도, 밝기 등
                                                모든 조건이 공부하기 딱 맞게 쾌적하여 비가 오는 날<br>씨이든, 무더운 여름이든, 어떤 날씨, 계절에도 한결 같은 공부 패턴을 유지할 수 있었습니다.<br>
                                                또한, <strong>담임선생님들께서 면학분위기를 철저히 관리해주셨고, 주변 학생들이 공부하는 모습을 보며<br>집중력을 바로잡아 무한의 동기부여를 받기</strong>도 하였습니다.
                                            </p>
                                            <p style="margin-right:0;"><strong>한양대학교 의예과 합격</strong> 러셀 분당 이종은</p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="schedule-box swiper-slide">
                                ...
                                <div class="st-review">
                                    ...
                                    <div class="right-con">
                                        <div>
                                            <p>
                                                매 교시 후 주어지는 20분의 쉬는시간 동안 바람도 쐬고, 화장실도 갔다오는 등 적절한 휴식을 취한<br>
                                                덕분에 공부시간에 더욱 집중할 수 있었습니다. 또한 <strong>파이널에는 수능 시간표로 바뀌어서 실제 수능<br>
                                                장에서 응시할 과목에 맞게 공부할 수 있었습니다.</strong> 
                                            </p>
                                            <p class="mt30" style="margin-right: 0px;"><strong>고려대학교 경영학과 합격</strong> 러셀 분당 김준범</p>
                                        </div>
                                    </div>
                                </div>
                                <% ElseIf sCampusCode = "CD0257" Then '중계 %>
                            ...
                            <div class="swiper-slide">
                                ...
                                <div class="st-review">
                                    <div class="left-con">
                                        <img src="<%=Application("img_path_russel")%>/russel_bundang/2023/half/stu_img04.jpg" alt="" />
                                    </div>
                                    <div class="right-con">
                                        <div>
                                            <p>
                                                우선 공간이 넓어서 답답하지 않았습니다. 앉아있는 공간도 넉넉했고, <strong>책상이 커서 공부하던 책을<br>
                                                옆에 잠시 두거나 모의고사를 볼 때에도 불편함이 없었습니다.</strong>책상 바로 옆에 위치한 책장도 공간<br>
                                                이 충분해 공부할 자료들이나 교재들을 넣어두고 등하원할 때에는 편하게 다닐 수 있었습니다. 
                                            </p>
                                            <p class="mt30" style="margin-right: 0px;"><strong>충남대학교 의예과 합격</strong> 러셀 분당 이선우</p>
                                        </div>
                                    </div>
                                </div>
                                <% Else %>
                ...
                <div class="swiper-container manage-slide">
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide">
                            ...
                            <div class="st-review">
                                ...
                                <div class="right-con">
                                    <div>
                                        <p> 
                                            담임선생님 부스가 바자관 바로 앞에 있었기 때문에 학습 계획과 관련된 고민이 있을 때 언제든<br>상담을 하며 도움을 얻을 수 있었습니다.
                                            또한 <strong>수시와 정시 상담 때에도 담임선생님께서 같이 고민해<br>주시며 원서 조합을 추천해주신 덕분에 최종적으로 좋은 결과를 가져올 수 있었던 것 같습니다.</strong> 
                                        </p>
                                        <p style="margin-right: 0px;"><strong>경희대학교 치의예과 합격</strong> 러셀 분당 정수혁</p>
                                    </div>
                                </div>
                            </div>
                            <% Else %>
                        ...
                        <div class="swiper-slide">
                            ...
                            <div class="st-review">
                                <div class="left-con">
                                    <img src="<%=Application("img_path_russel")%>/russel_bundang/2023/half/manage_stu_img02.jpg" alt="" />
                                </div>
                                <div class="right-con">
                                    <div>
                                        <p>
                                            담임선생님께서 <strong>1달에 한 번씩 정기적인 상담을 통해 저 스스로 균형 잡힌 학습 전략을 세울 수 있도록<br>관리</strong>해주셔서 좋았습니다.
                                            공부를 하다 보면 꼭 한 과목 정도를 빼놓고 공부하는 시기가 있는데<br>적절한 때에 조언해주셔서 놓치지 않을 수 있었습니다.
                                        </p>
                                        <p style="margin-right: 0px;"><strong>인제대학교 의예과 합격</strong> 러셀 분당 주정민</p>
                                    </div>
                                </div>
                            </div>
                            <% Else %>
                        ...
                        <div class="swiper-slide">
                            ...
                            <div class="st-review">
                                ...
                                <div class="right-con">
                                    <div>
                                        <p>
                                            수험생활 중 지금 하고 있는 <strong>공부에 대한 회의감이 생길 때마다 담임선생님께 편안하게 상담을 신청<br>하여 더 나은 공부방법을 설계하는데 큰 도움을 받을 수</strong> 있었습니다.<br>
                                            또한, <strong>학생들의 표정을 세심하게 살피시며 멘탈 관리</strong>도 해주시고, 성적 상담을 할 때에도 과목 당<br>문제 유형 별로 좀 더 필요한 부분들을 세심하게 피드백 해주셨습니다.
                                        </p>
                                        <p style="margin-right: 0;"><strong>서울대학교 치의학학석사통합과정 합격</strong> 러셀 분당 심승연</p>
                                    </div>
                                </div>
                            </div>
                            <% ElseIf sCampusCode = "CD0257" Then '중계 %>
    ...
    <!-- cont05 -->
    <div class="cont05 js-box js-menu-con <%=campusName%>">
        ...
        <div class="inner04">
            <ul class="subject-list">
                ...
                <% If sCampusCode <> "CD0340" and sCampusCode <> "CD0341" Then '코어광주/대전 제외 %>
                <li>

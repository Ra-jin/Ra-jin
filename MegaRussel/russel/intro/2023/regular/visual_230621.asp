...
Select Case GetCampusVarsSiteMGC("_CAMPUS_CODE_")
    ...
    Case "CD0247": txtCampus = "러셀 강남"  '강남
					...
					tit01 = "접수 현황"
					txt01 = "현재 모집 중"
					txt02 = "온라인 접수 <a href='https://russelgn.megastudy.net/russel/apply/jaejung/apply.asp?app_cd=148' class='bt-apply'>대기자 원서접수 바로가기</a><br><span class='c-txt'>* 원서 접수 확인 후 개별 안내 예정</span>"
					txt03 = "현재 모집 중"
    ...
    Case "CD0250": txtCampus = "러셀 부천"   '부천
					...
					amUrl = "https://russelbc.megastudy.net/russel/campus_common/russel_danka/russel_danka_new.asp?idx=1392"

	Case "CD0244": txtCampus = "러셀 분당"   '분당
                    campusName = "russel_bundang"
					txt01 = "1차 : 2/20(월), 2차 : 2/27(월), 3차 : 3/2(목)"
					tit02 = "접수 기간"
					txt02 = "현재 접수 中 (*모집요강 지원자격 해당자 순 접수)"
...
%>
    ...
    <div class="visual-area">
		...
		<div class="inner">
			...
			<div class="v-tit-wrap">
				<div class="visual-info">
					...
					<dl>
						<dt>접수 방법</dt>
						<dd>
							온라인 원서 접수 후 성적표 제출 <a href='https://russelbd.megastudy.net//russel/apply/jaejung/apply.asp?app_cd=148' class='bt-apply'>원서접수 바로가기</a><br>
							<span class="fz12">*온라인 원서 접수를 완료하면 이후 입학 절차를 개별적으로 안내해드립니다. </span>
						</dd>
					</dl>
					...
					<dl>
						...
						<dd>
							...
							<a <%if curYmdhmin >= 202301200900 then%> href='https://russeldc.megastudy.net//russel/apply/jaejung/apply.asp?app_cd=148' <%else%> onclick="alert('원서접수는 1/20(금) 9시 이후 가능합니다.')" <%end if%> class='bt-apply'>대기자 원서접수 바로가기</a>
							<% end if %>
			...
			<div class="ico-end" style="top: 440px;left: 9%;margin-left: 375px;"><div>전반 마감<br>대기자 접수 중</div></div>
			<% end if %>
		</div>

<div class="cont js-cont">
    ...
    <div class="cont00">
        <div class="inner02">
            ...
            <!-- 입학절차안내 -->
            <p class="mb90"><img src="<%=Application("img_path_russel")%>/russel/2023/regular/cont01_tit.png" alt="러셀 대치 N수 정규반 입학 등록 절차"></p>
            <div class="step-wrap">
                ...
                <div class="step-box">
                    ...
                    <div class="box">
                        : ‘학생ID’ 로 로그인 - 2024 정규반 원서 접수 <a href="https://russeldc.megastudy.net//russel/apply/jaejung/apply.asp?app_cd=148" class="btn-gray-s">원서접수 바로가기</a>
                        <ul class="shape-list">
                            <li>유의사항 : 학생이름으로 반드시 원서접수 해야합니다 학부모님 이름으로 원서접수 시 누락됩니다.
                            </li>
                            <li>합격자발표<br>:접수된 서류 심사 후 합격자에 한해 등록 안내 (문자 발송)
                            </li>
                        </ul>
                    </div>
            ...
            <!-- 모집요강 -->
            <p class="mb90 mt90"><img src="<%=Application("img_path_russel")%>/russel/2023/regular/cont00_tit.png" alt="러셀 대치 N수 정규반 모집요강 및 장학혜택"></p>
            <div class="tbl-box">
                <!-- 모집요강 자동화 시스템 영역 -->
                <%

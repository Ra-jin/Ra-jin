...
<div class="gate-wrap">
    ...
    <div class="visual-area">
		...
		<!--quick 플로팅배너-->
		<div class="quick russel_yj">
            <!-- <a style="margin-bottom: 10px;display: block;" href="https://russel.megastudy.net/event/2025/gisuk_pre/index.asp" target="_blank"><img src="<%=Application("img_path_russel")%>/intro/2023/gate/v_m_banner04.png" alt="배너" /></a> -->
        ...
        <div class="inner">
            ...
            <div class="tab-wrap js-tab">
                ...
                <div class="tab-cont">
                    ...
                    <div class="in">
                        <p><img src="<%=Application("img_path_russel")%>/intro/2023/gate/gisuk_box03_2.jpg" /></p>						
                    </div>
                </div>
            </div>
    ...
    <div class="cont04">
        <div class="inner">
            ...
            <ul>
                <li>
                    <a href="https://russelcampus.megastudy.net/russel_yj/2024/regular/index.asp">
                        <dl>
                    ...
                    <div>
                        <a href="https://russelcampus.megastudy.net/russel_yj/2024/regular/index.asp">바로가기</a>
                    </div>
                </li>
                <li>
                    <a href="https://russelw.megastudy.net/russel_yj/2024/regular/index.asp">
                        <dl>
                    ...
                    <div>
                        <a href="https://russelw.megastudy.net/russel_yj/2024/regular/index.asp">바로가기</a>
                    </div>
                </li>
                <li>
                    <a href="https://russelsm.megastudy.net/russel_yj/2024/regular/index.asp">
                        <dl>
                    ...
                    <div>
                        <a href="https://russelsm.megastudy.net/russel_yj/2024/regular/index.asp">바로가기</a>
                    </div>
                </li>
            </ul>
        </div>

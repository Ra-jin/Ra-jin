...
<head>
    ...
    <meta name="keywords" content="2025 러셀 반수반, 러셀 반수반, 2025 러셀반수반, 러셀반수반" />
	<meta name="description" content="바른공부 자습전용관 2025 러셀 반수반" />
	<meta property="og:type" content="website">
    <meta property="og:title" content="2025 러셀 반수반">
	<meta property="og:description" content="2025 러셀 반수반, 반수 정규반" />
...
<div class="half-wrap">
	...
	<!-- 최상위권 집결, 러셀 -->
	<!--#include virtual="/intro/2024/half/cont01.asp"-->
	<!-- //최상위권 집결, 러셀 -->

	<!-- 반수생 특화 시스템-->
	<!--#include virtual="/intro/2024/half/cont02.asp"-->
	<!-- //반수생 특화 시스템-->
	<!-- //Contents -->
    ...
    <div class="cont js-cont">
        <div class="cont07">
			<h3><img src="<%=Application("img_path_russel")%>/intro/2024/half/cont07_tit.png" alt="2025 재학생 정규반 모집안내" /></h3>

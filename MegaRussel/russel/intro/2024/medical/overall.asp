<div class="cont01">
    <div class="inner">
        ...
        <h3><%=txtCampus%> 메디컬 종합반은<br>
            <strong>
                바른공부 자습전용관에서 입시 전문 담임선생님의 관리를 받으며<br>
            최상위권 전용 맞춤 단과를 수강하는 형태의 종합반을 의미합니다.
            </strong>
        </h3>
        <% If sCampusCode = "CD0346" Then '코어청주 %>
        <table class="tbl-01 txt_left mb80">
            <colgroup>
                <col style="width:20%;">
            ...
            <tbody>
                ...
                <tr>
                    <th class="bg-gray">접수 방법
                    </th>
                    <td>
                        &middot; 현장 및 온라인 접수 <a href="<%=apply_url%>" class="btn-gray-r">원서접수 바로가기</a>
                    </td>
                </tr>
                <tr>
                    <th class="bg-gray">수강료
                    </th>
                    <td>
                ...
                <tr>
                    <th class="bg-gray">상담 문의
                    </th>
                    <td>
                        &middot; 전화 상담 : 오전 10시~저녁 8시
                        <a href="/russel/info/qna/qna.asp" class="btn-gray-r">온라인 상담 바로가기</a>
        ...
        <ul class="step-process mb0 mt60">
            <li>
...
<div class="cont02" id="teachInfo">
    <div class="inner">
        <h2>
            오직 메디컬 종합반을 위한 <strong>최상위권 전용 맞춤 단과</strong>
        </h2>
        <h3><%=txtCampus%> 메디컬 종합반 단과 수업은<br>
            최상위권 배출로 검증된 러셀 강남, 대치, 기숙 강사진 수업으로 진행됩니다.
        </h3>
        <div class="m-tab-wrap">
            ...
            <div class="cont-box on">
                <div>
                    <div class="pic">
                        <img src="<%=Application("img_path_russel")%>/intro/2024/medical/ko_psj.jpg" alt="박석준" />
                    </div>
                    <div class="cont">
                        <h4>
                        ...
                        <p class="sub">
                            야구하던 전교 300등 열등생에서 연세대학교 입학한 명쾌한 공부법 제시
                        </p>
                        <div class="detail">
                            <dl>
                                <dt>강좌명</dt>
                        ...
                        <a href="https://<%=camUrl%>.megastudy.net/russel/teacher/teacher_home.asp?code=1203" class="btn-black">OT &amp; 커리큘럼 영상 보기</a>
                    </div>
                </div>
            </div>
            <!-- 손우혁 -->
            <div class="cont-box">
                <div>
                    <div class="pic">
                        <img src="<%=Application("img_path_russel")%>/intro/2024/medical/math_swh.jpg" alt="손우혁" />
                    </div>
                    <div class="cont">
                        <h4>
                            상위권의 가장 확실한 선택<br>
                        ...
                        <a href="https://<%=camUrl%>.megastudy.net/russel/teacher/teacher_home.asp?code=963" class="btn-black">OT &amp; 커리큘럼 영상 보기</a>
                    </div>
                </div>
            </div>
            <!-- 강신영 -->
            <div class="cont-box">
                <div>
                    <div class="pic">
                        <img src="<%=Application("img_path_russel")%>/intro/2024/medical/si_ksy.jpg" alt="강신영" />
                    </div>
                    <div class="cont">
                        <h4>
                            열정 보존의 법칙<br>
                        ...
                        <a href="https://<%=camUrl%>.megastudy.net/russel/teacher/teacher_home.asp?code=1265" class="btn-black">OT &amp; 커리큘럼 영상 보기</a>
                    </div>
                </div>
            </div>
            <!-- 정우정 -->
            <div class="cont-box">
                <div>
                    <div class="pic">
                        <img src="<%=Application("img_path_russel")%>/intro/2024/medical/si_jwj.jpg" alt="정우정" />
                    </div>
                    <div class="cont">
                        <h4>깊이 있는 수능 화학
                            <br>
                        ...
                        <a href="https://<%=camUrl%>.megastudy.net/russel/teacher/teacher_home.asp?code=1018" class="btn-black">OT &amp; 커리큘럼 영상 보기</a>
                    </div>
                </div>
            </div>
            <!-- 이석준 -->
            <div class="cont-box">
                <div>
                    <div class="pic">
                        <img src="<%=Application("img_path_russel")%>/intro/2024/medical/si_lsj.jpg" alt="이석준" />
                    </div>
                    <div class="cont">
                        <h4>
                            수능 생명과학, 고득점의 시작<br>
                        ...
                        <a href="https://<%=camUrl%>.megastudy.net/russel/teacher/teacher_home.asp?code=1164" class="btn-black">OT &amp; 커리큘럼 영상 보기</a>
                    </div>
                </div>
            </div>
            <!-- 함석진 -->
            <div class="cont-box">
                <div>
                    <div class="pic">
                        <img src="<%=Application("img_path_russel")%>/intro/2024/medical/si_hsj.jpg" alt="함석진" />
                    </div>
                    <div class="cont">
                        <h4>
                        ...
                        <a href="https://<%=camUrl%>.megastudy.net/russel/teacher/teacher_home.asp?code=1253" class="btn-black">OT &amp; 커리큘럼 영상 보기</a>
                    </div>
                </div>
            </div>
        </div>
...
<div class="cont03">
    <div class="inner">
        <h2>
            결과로 증명하는 <strong><%=txtCampus%></strong>
        </h2>
        <div class="result-list">
            <div class="cont-bay">
                <p>
                    <strong>러셀 전체</strong><br>
                    <span>
                        2024학년도<br>
                        대입 결과	
                    </span>
                ...
                <div class="data-wrap">
                    <a href="javascript:void(0)">데이터 산출 기준  <i><img src="<%=Application("img_path_russel")%>/intro/2024/medical/ico_info.png" alt="i" /></i></a>
                    <div class="data-view">
            ...
            <div class="cont-bay" style="width:183px">
                <p>
            ...
            <% End If %>
            <!-- //학원별 입결 -->
            <div class="ico-trophy"><img src="<%=Application("img_path_russel")%>/intro/2024/medical/ico_trophy.png" alt="" /></div>
        </div>
        <!-- 학원별 합격생 현황 -->
        <% If sCampusCode = "CD0346" Then '코어청주 %>
        <div class="result-current">
            <h4>
                ...
                바른공부 자습전용관 재원생 기준 2024학년도 합격생 현황
            </h4>
            ...
            <p class="r-txt">
                ※ 2023년 러셀CORE 청주 바른공부 자습전용관 재원 이력이 있는 학생 (복수 대학 합격자 포함, 단과 수강생 제외)<br>
        ...
        <div class="result-stu">
            <div class="s-profile">
                <span><img src="<%=Application("img_path_russel")%>/intro/2024/medical/logo_korea.png" alt="" /></span>
                <div><img src="<%=Application("img_path_russel")%>/intro/2024/medical/corejj_stu01.png" alt="" /></div>
                <a href="javascript:CastPopup('https://tv.naver.com/v/48138912')"><img src="<%=Application("img_path_russel")%>/intro/2024/medical/ico_play.png" alt="" /></a>
            </div>
            <div class="s-review">
                <dl>
                ...
                <p>
                    개인적인 면학분위기에선 수능 날 시간표대로 공부를 해야 하는 강제성도 없으며,<br>
                    집중력을 잃을 때 바로잡을 만한 요소도 마련하기 힘듭니다. 그러나 러셀에서 수능 시간표대로 공부하고,<br>
                    그를 토대로 목요일마다 위클리 모의고사를 실시하여 수능 리듬에 최적화되게끔 반복 연습했던 부분은<br>
                    실제로 수능을 더욱 더 익숙하게 느끼는데 큰 도움을 주었습니다.
                </p>
            </div>
        </div>
        <!-- //합격생 후기 -->

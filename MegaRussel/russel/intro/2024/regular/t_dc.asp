...
<div class="cont js-cont">
    ...
    <div class="cont00" style="background:#f8f8f8;">
        <div class="inner">
            <!-- 연간 운영 계획 -->
            <p class="mb70"><img src="<%=Application("img_path_russel")%>/russel/2024/regular/cont00_tit00.png" alt="연간 운영 계획"></p>
            <table class="tbl-plan">
                ...
                <thead>
                    <tr>
                        ...
                        <th>1월</th>
                        <th>2월</th>
                        <th class="on"><span>현재 모집 중 </span>3~6월</th>
                        <th>7~8월</th>
                        <th>9~11월</th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
                        ...
                        <td>우선선발반</td>
                        <td colspan="3">정규반 <br>
                            <!-- <a href="https://russeldc.megastudy.net/russel/apply/jaejung/apply.asp?app_cd=164" class="btn-gray-s" style="padding: 0 25px;">원서접수 바로가기 </a> -->
                        </td>
                    </tr>
                    <tr>
                        <td>반수</td>
                        <td colspan="2">-</td>
                        <td colspan="3">반수반 <br>
                            <!-- <a href="https://russeldc.megastudy.net/russel/apply/jaejung/apply.asp?app_cd=170" class="btn-gray-s" style="padding: 0 25px;">원서접수 바로가기 </a> -->
                        </td>
                    </tr>
                </tbody>
            </table>
            ...
            <p class="mt120 mb70"><img src="<%=Application("img_path_russel")%>/russel/2024/regular/cont00_tit01.png" alt="입학 절차 안내"></p>            
            <div class="step-wrap">
            ...
            <p class="mt120 mb70"><img src="<%=Application("img_path_russel")%>/russel/2024/regular/cont00_tit02.png" alt="모집요강 및 장학혜택"></p>

...
<div class="regular-wrap">
	...
	<!-- 최상위권 집결, 러셀 -->
	<!--#include virtual="/intro/2024/regular/con01_top_rank.asp"-->
	<!-- //최상위권 집결, 러셀 -->

	<!-- 재수생 맞춤 시스템 -->
	<!--#include virtual="/intro/2024/regular/con02_system.asp"-->
	<!-- //재수생 맞춤 시스템 -->
    ...
    <div class="cont js-cont">
        <div class="cont07" style="background-color:#F1F1F1">
            <div class="inner">
                <p class="tit mb70"><img src="<%=Application("img_path_russel")%>/intro/2024/regular/cont07_tit.png" alt="2025 러셀 재수생 N수 정규반 모집안내" /></p>

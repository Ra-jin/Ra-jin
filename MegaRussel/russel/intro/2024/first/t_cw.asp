...
<div class="cont js-cont">
    ...
    <div class="cont00">
        <div class="inner">
            <!-- 입학절차 -->
            <p class="mb90"><img src="<%=Application("img_path_russel")%>/core_cw/2024/first/cont00_tit01.png" alt="입학 절차 안내"></p>
            <div class="step-wrap">
                <div class="step-info-wrap core" style="border-radius: 20px;border-bottom:1px solid #dbdbdb;">
                    <div class="step-list pl10 pr10">
                        ...
                        <a href="https://corecw.megastudy.net/russel/apply/jaejung/apply.asp?app_cd=163" class="btn-gray-s">원서접수 바로가기</a>
                    </div>
                    <div class="step-list">
            ...
            <!-- 모집요강 및 지원혜택 -->
            <p class="mt120 mb90"><img src="<%=Application("img_path_russel")%>/core_cw/2024/first/cont00_tit02.png" alt="모집요강 및 지원혜택"></p>

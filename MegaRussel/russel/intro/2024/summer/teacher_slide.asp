...
<div class="teacher-swiper js-teacher-swiper swiper-container">
    <div class="swiper-wrapper">
        ...
        <div class="swiper-slide">
            ...
            <span class="t-img"><img src="<%=Application("img_path_russel")%>/teacher/slide/ko_ktj02.png" alt=""></span>
        </div>
        <div class="swiper-slide">
            <dl class="t-name">
                <dt>국어</dt>
        ...
        <div class="swiper-slide">
            ...
            <span class="t-img"><img src="<%=Application("img_path_russel")%>/teacher/slide/math_uhk02.png" alt=""></span>
        </div>
        <div class="swiper-slide">
            <dl class="t-name">
                <dt>수학</dt>
        ...
        <div class="swiper-slide">
            ...
            <span class="t-img"><img src="<%=Application("img_path_russel")%>/teacher/slide/eng_mhs02.png" alt=""></span>
        </div>
        <div class="swiper-slide">
            <dl class="t-name">
                <dt>영어</dt>

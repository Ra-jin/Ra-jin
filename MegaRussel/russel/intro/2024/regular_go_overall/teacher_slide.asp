<div class="teacher-swiper js-teacher-swiper swiper-container <%=campusName%>">
    ...
    <!-- #include virtual="/common/inc/t_list/t_list_full_dg_02.asp" -->
    ...
    <!-- #include virtual="/common/inc/t_list/t_list_full_us_02.asp" -->
    <% ElseIf sCampusCode = "CD0343" Then '코어원주 %>
    <!-- #include virtual="/common/inc/t_list/t_list_full_wj.asp" -->

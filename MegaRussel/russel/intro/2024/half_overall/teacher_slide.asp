        ...
        <ul class="swiper-wrapper">
            ...
            <li class="swiper-slide">
                <div class="info-box">
                    ...
                    <span class="t-explain">2022년 수능 국어<br>
                    만점자 배출
                    </span>
                </div>
            ...
            <li class="swiper-slide">
                <div class="info-box">
                    ...
                    <span class="t-explain">내신부터 수능까지<br>
                        완벽 학습
                    </span>
                </div>
            ...
            <li class="swiper-slide">
                ...
                <p class="pic"><img src="<%=Application("img_path_russel")%>/teacher/slide/math_ysw.png" alt="" /></p>
                <div class="ico-box">
                    <p><span>러셀<br>기숙</span></p>
                </div>
            </li>   
            ...
            <li class="swiper-slide ml_40">
                <div class="info-box">
                    <!-- <span class="cate"></span> -->
                    <span class="t-sub">영어</span>
                    <span class="t-info"><strong>위대영</strong> 선생님</span>
                    <!-- <span class="t-explain"></span> -->
                </div>
                <p class="pic"><img src="<%=Application("img_path_russel")%>/teacher/slide/eng_wdy.png" alt="" /></p>
                <!-- <div class="ico-box">
                    <p><span>러셀<br>부천</span></p>
                </div> -->
            </li>
            ...
            <li class="swiper-slide">
                ...
                <p class="pic"><img src="<%=Application("img_path_russel")%>/teacher/slide/ko_lbr02.png" alt="" /></p>
                <div class="ico-box">
                    <p><span>러셀<br>부천</span></p>
            ...
            <li class="swiper-slide">
                ...
                <p class="pic"><img src="<%=Application("img_path_russel")%>/teacher/slide/soc_jj.png" alt="" /></p>
                <div class="ico-box">
                    <p><span>러셀<br>목동</span></p>
                </div>
            </li>
            <li class="swiper-slide">
                ...
                <p class="pic"><img src="<%=Application("img_path_russel")%>/teacher/slide/soc_chh.png" alt="" /></p>
                <div class="ico-box">
                    <p><span>러셀<br>중계</span></p>
                </div>
            </li>
...
<p class="r-txt">※ 2024년 출강 기준<br>
    ※ 학원 사정에 의해 변경 될 수 있습니다.</p>
<% Else %>

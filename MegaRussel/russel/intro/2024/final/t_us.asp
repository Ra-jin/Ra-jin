...
<div class="cont js-cont">
    ...
    <div class="cont00">
        <div class="inner">
            ...
            <div class="step-wrap">
                <div class="step-info-wrap core" style="border-radius: 20px;border-bottom:1px solid #dbdbdb;">
                    <div class="step-list pl10 pr10">
                        ...
                        <a href="https://russelus.megastudy.net/russel/apply/yonhab/apply.asp?app_cd=175" class="btn-gray-s">원서접수 바로가기</a>
                        <br>
                    </div>
                    <div class="step-list">
                    ...
                    <div class="step-list">
                        <p class="tit"><span>4</span>파이널 정규반<br>최종 등록 확인</p>
                    </div>
                </div>
            </div>
            <!-- //입학 절차 안내 -->
            ...
            <!-- 모집요강 및 지원혜택 -->
            <h3 class="tit mt100">러셀 울산 파이널 정규반 <strong>모집요강 및 장학혜택</strong></h3>

    ...
    <div class="cont00">
        <div class="inner">            
            ...
            <div class="step-wrap">
                ...
                <div class="step-box">
                    <p class="tit">1) 원서접수 <a href="https://russelgn.megastudy.net/russel/apply/yonhab/apply.asp?app_cd=175" class="btn-gray-s ml_10">원서접수 바로가기</a></p>
                    <div class="box">
            ...
            <!-- 모집요강 및 지원혜택 -->
            <h3 class="tit mt100">러셀 강남 파이널 정규반 <strong>모집요강 및 지원혜택</strong></h3>

...
<div class="cont js-cont">
    ...
    <div class="cont00">
        <div class="inner">
            <!-- 입학 절차 안내 -->
            <h3 class="tit">러셀 센텀 파이널 정규반  <strong>입학 절차 안내</strong></h3>
            <div class="step-wrap">
                ...
                <div class="step-box">
                    <p class="tit">1) 원서접수 <a href="https://russelct.megastudy.net/russel/apply/yonhab/apply.asp?app_cd=175" class="btn-gray-s ml_10">원서접수 바로가기</a></p>
                    <div class="box">
                    ...
                    <div class="box">
                        <p class="fz16 fw400">2025 N수 파이널 정규반 등록 완료</p>
                        <ul class="list-02 mt5">
            ...
            <!-- 모집요강 및 지원혜택 -->
            <h3 class="tit mt100">러셀 센텀 파이널 정규반 <strong>모집요강 및 지원혜택</strong></h3>
            <div class="tbl-box">
                <!-- 모집요강 자동화 시스템 영역 -->
                <%

<div class="cont js-cont">
    <!-- cont03 -->
    <div class="cont03" id="plan02">
        <div class="inner">
            <h2 data-aos="fade-up"><img src="<%=Application("img_path_russel")%>/<%=campusName%>/2024/regular_go/cont03_tit.png" alt="러셀 재학생 정규반에는 최상위권 재학생에게 최적화된 시스템이 있습니다." /></h2>
            <p>
                <img usemap="#popOpen" src="<%=Application("img_path_russel")%>/<%=campusName%>/2024/regular_go/cont02_img.jpg" alt="컨텐츠" />
            ...
            <!-- popup -->
            <div class="zoom-pop">
                <div><img src="<%=Application("img_path_russel")%>/<%=campusName%>/2024/regular_go/zoom_img.jpg" alt="" /></div>
            </div>
            <!-- popup -->
    ...
    <div class="cont05">
        <div class="inner">
            <h2 class="mb30" data-aos="fade-up"><img src="<%=Application("img_path_russel")%>/<%=campusName%>/2024/regular_go/cont05_tit.png" alt="최상위권 전문 입시 담임선생님의 재학생 맞춤 관리" /></h2>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                &middot; 개인별 <strong>학습 현황 파악 및 학습 밸런스 점검</strong> <br>
                                &middot; 3월 모의고사, 메가X대성 더 프리미엄 모의고사 응시에 따른 <strong>1:1 성적 분석 피드백</strong> 진행 (취약 부분 점검)
                            </td>
                        </tr>
                    </tbody>
                </table>
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <th>정시</th>
                            <td>
                                &middot; 서울시 교육청 및 메가X대성 더 프리미엄 모의고사 응시에 따른 성적 분석<br>
                ...
                <table>
                    ...
                    <tbody>
                        <tr>
                            <th>수시</th>
                            <td>
                                <% If sCampusCode <> "CD0249" Then '영통 제외 %>&middot; 메가X대성 더 프리미엄 모의고사 응시<br><% end if %>
                        ...
                        <tr>
                            <th>정시</th>
                            <td>
                                &middot; 메가X대성 더 프리미엄 모의고사 응시에 따른 성적 분석<br>
                                &middot; 담임선생님과 <strong>취약과목(파트) 점검 후 학습전략 수립</strong>
                            </td>
                        </tr>
                    </tbody>
            ...
            <div class="cont-month">
                <table>
                    ...
                    <tbody>
                        <tr>
                            <th>수시</th>
                            <% If sCampusCode = "INTRO" OR sCampusCode = "CD0247" OR sCampusCode = "CD0001" OR sCampusCode = "CD0245" OR sCampusCode = "CD0244" OR sCampusCode = "CD0249" OR sCampusCode = "CD0248" OR sCampusCode = "CD0342" OR sCampusCode = "CD0349" OR sCampusCode = "CD0340" OR sCampusCode = "CD0345" OR sCampusCode = "CD0344" OR sCampusCode = "CD0346" Then '인트로/강남/대치/목동/분당/영통/평촌/대구/울산/코어광주/코어창원/코어전주/코어청주 %>
                            <td>
                                &middot; 9월 평가원 및 메가X대성 더 프리미엄 모의고사 응시<br>
                        ...
                        <tr>
                            ...
                            <% If sCampusCode = "INTRO" OR sCampusCode = "CD0247" OR sCampusCode = "CD0001" OR sCampusCode = "CD0245" OR sCampusCode = "CD0244" OR sCampusCode = "CD0249" OR sCampusCode = "CD0248" OR sCampusCode = "CD0342" OR sCampusCode = "CD0349" OR sCampusCode = "CD0340" OR sCampusCode = "CD0345" OR sCampusCode = "CD0344" OR sCampusCode = "CD0346" Then '인트로/강남/대치/목동/분당/영통/평촌/대구/울산/코어광주/코어창원/코어전주/코어청주 %>
                            <td>
                                &middot; 9월 평가원 및 메가X대성 더 프리미엄 모의고사 응시에 따른 성적 분석 <br>
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <th>정시</th>
                            <td>
                                <% If sCampusCode <> "CD0249" Then '영통 제외 %>&middot; 메가X대성 더 프리미엄 모의고사 응시에 따른 성적 분석<br><% end if %>
    ...
    <div class="cont06">
        <div class="inner">
            <h2 class="mb30" data-aos="fade-up"><img src="<%=Application("img_path_russel")%>/<%=campusName%>/2024/regular_go/cont06_tit.png" alt="최상위권 대학 합격 선배들이 추천하는 러셀 실전 콘텐츠" /></h2>
            ...
            <div class="contents-list mt70">
                ...
                <div>
                    ...
                    <div>
                        <p class="c-tit">메가X대성 <br>더 프리미엄 모의고사</p>
                        <div class="c-txt-box">
            ...
            <div class="stu-review">
                <div class="top-con">
                    ...
                    <div class="review-con">
                        메가X대성 더 프리미엄 모의고사와 퀄 모의고사와 같이 <strong>다양한 모의고사를 경험할 수 있어 좋았습니다.
    ...
    <div class="bottom-bar">
        <p>
            <% If sCampusCode = "CD0250" Then '부천 %>고3에<% Else %>재학생에<% End If %> 최적화된 <%=txtCampus%><% If sCampusCode = "CD0244" Then '분당 %> 재학생(고3) 정규반<% ElseIf sCampusCode = "CD0247" Then '강남 %> 재학생 최상위권반<% ElseIf sCampusCode = "CD0250" Then '부천 %> 고3 정규반<% ElseIf sCampusCode = "CD0245" Then '목동 %> 파이널 재학생 정규반<% Else %> 재학생 정규반<% End If %>에서 <br>

...
<head>
    <meta name="title" content="2025 러셀 재학생 정규반" />
    <meta name="keywords" content="2025 재학생 정규반, 러셀 재학생 정규반, 2025 재학생 정규반, 재학생 정규반" />
	<meta name="description" content="바른공부 자습전용관 2025 재학생 정규반" />
	<meta property="og:type" content="website">
    <meta property="og:title" content="2025 재학생 정규반">
	<meta property="og:description" content="2025 러셀 재학생 정규반, 러셀 재학생 정규반" />
...
<div class="regular-go-wrap">
	...
	<!-- 최상위권 집결, 러셀 -->
	<!--#include virtual="/intro/2024/regular_go/con01_top_rank.asp"-->
	<!-- //최상위권 집결, 러셀 -->

	<!-- 재학생에 최적화된 시스템 -->
	<!--#include virtual="/intro/2024/regular_go/con02_system.asp"-->
	<!-- //재학생에 최적화된 시스템 -->
	<!-- //Contents -->
    ...
    <div class="cont js-cont">
        <div class="cont07">
			<p class="tit"><img src="<%=Application("img_path_russel")%>/intro/2024/regular_go/cont07_tit.png" alt="2025 재학생 정규반 모집안내" /></p>

<div class="cont js-cont <%=campusName%>">
    ...
    <div class="cont01-2">
        <div class="inner">
            <h2 data-aos="fade-up"><img src="<%=Application("img_path_russel")%>/intro/2024/first_overall/cont01_tit.png" alt="최상위권이 선택하고 만족하는 러셀, 매해 더 나은 입결과 후기가 입증하고 있습니다." /></h2>
            <div class="graph-wrap">
                ...
                <ul>
                    <li>
                        <div><img src="<%=Application("img_path_russel")%>/intro/2024/first_overall/cont01_graph01.jpg" alt="HS반 유입률" /></div>
                        <span class="arrow01"><img src="<%=Application("img_path_russel")%>/intro/2024/first_overall/ico_arrow01.png" alt="" /></span>
                    </li>
                    <li>
                        <div><img src="<%=Application("img_path_russel")%>/intro/2024/first_overall/cont01_graph02.jpg" alt="서울대, 의치대반 유입률" /></div>
                        <span class="arrow01"><img src="<%=Application("img_path_russel")%>/intro/2024/first_overall/ico_arrow01.png" alt="" /></span>
                    </li>
                </ul>
                <p class="l-list">
                ...
                <ul>
                    <li class="doughnut">
                        ...
                        <div class="chart-area">
                            ...
                            <div class="chart-img"><img src="<%=Application("img_path_russel")%>/intro/2024/first_overall/cont01_graph03.png" alt="" /></div>
                        </div>
                    </li>
                    <li>
                        <div><img src="<%=Application("img_path_russel")%>/intro/2024/first_overall/cont01_graph04.jpg" alt="2022 vs 2023 수능 백분위 성적 향상 점수" /></div>
                        <span class="bubble"><img src="<%=Application("img_path_russel")%>/intro/2024/first_overall/cont01_bubble.png" alt="" /></span>
                        <span class="arrow02"><img src="<%=Application("img_path_russel")%>/intro/2024/first_overall/ico_arrow02.png" alt="" /></span>
                    </li>
                </ul>
                ...
                <li data-aos="zoom-in-up">
                    <div class="p-info">
                        ...
                        <div>
                            ...
                            향상</p>
                            <div><img src="<%=Application("img_path_russel")%>/intro/2024/first_overall/cont02_graph01.jpg" alt="" /></div>
                        </div>
                    </div>
                    <div class="p-review">
                ...
                <li data-aos="zoom-in-up">
                    <div class="p-info">
                        ...
                        <div>
                            ...
                            향상</p>
                            <div><img src="<%=Application("img_path_russel")%>/intro/2024/first_overall/cont02_graph02.jpg" alt="" /></div>
                        </div>
                    </div>
                    <div class="p-review">
    ...
    <div class="cont01-1">
        ...
        <div class="inner">
            <h2 data-aos="fade-up"><img src="<%=Application("img_path_russel")%>/<%=campusName%>/2024/first_overall/cont01-1_tit.png" alt="최상위권이 선택하고 만족하는 러셀, 매해 더 나은 입결과 후기가 입증하고 있습니다." /></h2>
            <div class="result-box bg-type02">
                <div class="confetti"><img src="<%=Application("img_path_russel")%>/intro/2024/first_overall/confetti.png" alt="" /></div>
                <p><img src="<%=Application("img_path_russel")%>/<%=campusName%>/2024/first_overall/cont01-1_stit.png" alt="결과로 증명하는 러셀 목동 러셀 목동 2023학년도 대입 합격 현황" /></p>
        ...
        <div class="inner">
            ...
            <div class="result-box">
                <div class="confetti" style="top:140px"><img src="<%=Application("img_path_russel")%>/intro/2024/first_overall/confetti02.png" alt="" /></div>
                <p><img src="<%=Application("img_path_russel")%>/<%=campusName%>/2024/first_overall/cont01-1_stit.png" alt="" /></p>
    ...
    <!-- //cont01-1 -->
    <div class="cont03">
        <h2><img src="<%=Application("img_path_russel")%>/<%=campusName%>/2024/first_overall/cont03_tit.png" alt="러셀에서 한발 더 빠르게 시작한 선배들은 최상위권 대입성공을 쟁취하였습니다." /></h2>
            ...
            <ul class="review-list">
                <li data-aos="zoom-in-up">
                    <div class="p-info">
                        ...
                        <div class="video-link">
                            <span><img src="<%=Application("img_path_russel")%>/intro/2024/first_overall/cont02_stu_jyj.jpg" alt="조윤주" /></span>
                            <a href="javascript:CastPopup('https://tv.naver.com/v/34827669');"><img src="<%=Application("img_path_russel")%>/intro/2024/first_overall/ico_play.png" alt="" /></a>
                        </div>
                    </div>
                    <div class="p-review">
                ...
                <li data-aos="zoom-in-up">
                    <div class="p-info">
                        ...
                        <div class="video-link">
                            <span><img src="<%=Application("img_path_russel")%>/intro/2024/first_overall/cont02_stu_jij.jpg" alt="정인지" /></span>
                            <a href="javascript:CastPopup('https://tv.naver.com/v/34827583');"><img src="<%=Application("img_path_russel")%>/intro/2024/first_overall/ico_play.png" alt="" /></a>
                        </div>
                    </div>
                    <div class="p-review">
            ...
            <ul class="review-list">
                <li data-aos="zoom-in-up">
                    ...
                    <div class="p-review">
                        ...
                        <p class="txt">바른공부 자습전용관에서 공부를 하면 주변에 앉은 학생들이 우수하여, <strong>공부를 하기 싫을 때도 주변을 보면서 동기부여</strong>가 되었고,<br>
                         시간표가 수능 일정과 동일하게 구성되어
                ...
                <li data-aos="zoom-in-up">
                    ...
                    <div class="p-review">
                        ...
                        <p class="txt">담임선생님의 격려의 말씀이 항상 저에게 위로가 되었고,<br>

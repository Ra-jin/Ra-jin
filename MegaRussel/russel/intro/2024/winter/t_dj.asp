...
<div class="cont js-cont">
    ...
    <div class="cont00">
        <div class="inner">
                ...
                <div class="step-info-wrap">
                    <div class="step-list">
                        <p class="tit mb0"><span>1</span> 온라인 원서접수 후<br>
                            사전예약금 납부
                            <a href="https://coredj.megastudy.net/russel/apply/yonhab/apply.asp?app_cd=173" class="btn-gray-s">원서접수 바로가기 </a>
                        </p>
                    </div>
                    <div class="step-list">
            ...
            <!-- 모집요강 -->
            <h3 class="tit mt100">2025 윈터스쿨 <strong>모집요강</strong></h3>
            <!-- 모집요강 자동화 시스템 영역 -->
            <%

...
<%
	...
	if gLoginMemId = "haming52" or gLoginMemId = "sjw1831111" or gLoginMemId = "ksmallie77" or gLoginMemId = "sophie1217" or gLoginMemId = "jwpak11" or gLoginMemId = "minwoo1456" or gLoginMemId = "yeonwoo0224" then '학원 오프라인 추가자 접근 가능하게
		exam_cnt = 1
	end if
		...
		<div class="cont06">
			...
			<div class="tab-wrap">
				<div class="tab-content on">
					<div class="cont-wrap">
						<p class="tit"><img src="<%=Application("img_path_russel")%>/intro/2024/csat/cont06_tab03_tit.png" alt="성적 분석" /></p>
						<div class="top-con">

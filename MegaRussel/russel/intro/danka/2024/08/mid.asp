                ...
                <div class="normal_sub_con">
                    ...
                    <div class="danka mid">
                        ...
                        <div class="visual">
                            ...
                            <p class="tit tit01"><img alt="2차 중간고사" src="<%=Application("img_path_russel")%>/intro/danka/2024/08/mid_visual_tit02.jpg"/></p>
                            <p class="tit tit02"><img alt="대비 강좌" src="<%=Application("img_path_russel")%>/intro/danka/2024/03/mid_visual_tit03.png"/></p>
                            <p class="stxt">
                        ...
                        <div class="cont cont02">
                            ...
                            <div class="goto-wrap">
                                ...
                                <!-- <div class="goto-box box03">
                                    <div>
                                        <p>
                                            재학생 여름방학 맞춤 시스템 <br>
                                            <strong>바른공부 자습전용관 2024 썸머스쿨</strong>
                                        </p>
                                    </div>
                                    <div>
                                        <a href="/intro/2024/summer/index.asp">자세히 보기></a>
                                    </div>
                                </div> -->
                            </div>
                        </div>
                            ...
                            <div class="campus-list">
                                <dl>
                                    ...
                                    <dd>
                                        ...
                                        032) 265-1010
                                        <a href="https://russelbc.megastudy.net/russel/campus_common/russel_danka/russel_naesin.asp?idx=322" target="_blank">시간표 바로가기</a>
                                    </dd>
                                    <dd>
                                        <p>러셀 <strong>영통</strong></p>
                                        031) 251-1010
                                        <a href="https://russelyt.megastudy.net/russel/campus_common/russel_danka/russel_naesin.asp?idx=323" target="_blank">시간표 바로가기</a>
                                    </dd>                                    
                                    <dd>
                                        <p>러셀 <strong>중계</strong></p>
                                        02) 6316-1010
                                        <a href="https://russeljg.megastudy.net/russel/campus_common/russel_danka/russel_naesin.asp?idx=324" target="_blank">시간표 바로가기</a>
                                    </dd>
                                    <dd>
                                        <p>러셀 <strong>평촌</strong></p>
                                        031) 341-6500
                                        <a href="https://russelpc.megastudy.net/russel/campus_common/russel_danka/russel_naesin.asp?idx=325" target="_blank">시간표 바로가기</a>
                                    </dd>
                                    <dd>
                                    ...
                                    <dd>
                                        ...
                                        051) 715-1010
                                        <a href="https://russelct.megastudy.net/russel/campus_common/russel_danka/russel_naesin.asp?idx=326" target="_blank">시간표 바로가기</a>
                                    </dd>
                                    <dd>
                                        <p>러셀 <strong>울산</strong> <img src="<%=Application("img_path_russel")%>/intro/2023/first/ic_new.gif" alt="new" class="va_m" /></p>
                                        052) 913-1010
                                        <a href="https://russelus.megastudy.net/russel/campus_common/russel_danka/russel_naesin.asp?idx=327" target="_blank">시간표 바로가기</a>
                                    </dd>
                                </dl>
                                <dl>
                                    ...
                                    <dd>
                                        ...
                                        033) 901-2020
                                        <a href="https://corewj.megastudy.net/russel/campus_common/russel_danka/russel_naesin.asp?idx=328" target="_blank">시간표 바로가기</a>
                                    </dd>
                                    <dd>
                                        <p>러셀CORE <strong>청주</strong> <img src="<%=Application("img_path_russel")%>/intro/2023/first/ic_new.gif" alt="new" class="va_m" /></p>
                                        043) 908-1010
                                        <a href="https://corecj.megastudy.net/russel/campus_common/russel_danka/russel_naesin.asp?idx=329" target="_blank">시간표 바로가기</a>
                                    </dd>
                                </dl>
                            </div>
                            <!-- //campus-list -->

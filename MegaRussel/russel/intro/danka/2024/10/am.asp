                    ...
                    <div class="danka intro am" style="width: 777px; position: relative;text-align:center;">
                        ...
                        <div class="danka-img-wrap">
                            ...
                            <div class="v-wrap">
                                ...
                                <p class="v-tit00" style="left:275px;"><img src="<%=Application("img_path_russel")%>/intro/danka/2024/02/v-tit01.png" alt="N수에 최적화된 수업&관리" /></p>
                                <p class="v-tit01" style="left:275px;"><img src="<%=Application("img_path_russel")%>/intro/danka/2024/10/am_v-tit02.png" alt="10~11월"/></p>
                            ...
                            <div class="cont01">
                                ...
                                <div class="tab-cont-wrap">
                                    ...
                                    <div class="cont-box on">
                                        ...
                                        <img alt="러셀AM단과" src="<%=Application("img_path_russel")%>/intro/danka/2024/04/cont01_tab01_img.jpg"/>
                                    ...
                                    <div class="cont-box">
                                        ...
                                        <img alt="N수 맞춤 강사진" src="<%=Application("img_path_russel")%>/intro/danka/2024/04/cont01_tab02_img.jpg" />
                                    </div>
                                    ...
                                    <div class="cont-box">
                                        ...
                                        <div>
                                            <img alt="학습 동선 최소화" src="<%=Application("img_path_russel")%>/intro/danka/2024/05/cont01_tab03_img.jpg" />
                                        </div>
                                        <!-- 배너 -->
                                        <div class="mt50" style="position:relative">
                                            <img alt="학습 동선 최소화" src="<%=Application("img_path_russel")%>/intro/danka/2024/09/am_cont01_tab03_banner.jpg" />
                                            <a href="/intro/2024/half/index.asp" style="position:absolute;width:138px;height:62px;right:217px;bottom:20px;"></a>
                                            <a href="/intro/2024/final/index.asp" style="position:absolute;width:138px;height:62px;right:71px;bottom:20px;"></a>
                                        </div>
                                        <!-- //배너 -->
                                        <p class="r-txt mt20">※ AM단과는 바른공부 자습전용관을 이용하지 않아도 수강 가능합니다.<br>
                            ...
                            <div class="cont02">
                                ...
                                <div><img alt="" src="<%=Application("img_path_russel")%>/intro/danka/2024/04/cont02_img.jpg"/></div>
                            </div>
                                ...
                                <div class="campus-list">
                                    <dl>
                                        ...
                                        <dd>
                                            ...
                                            02) 6954-1010
                                            <a href="https://russelgn.megastudy.net/russel/campus_common/russel_danka/russel_danka_new.asp?idx=1766" target="_blank">시간표 바로가기</a>
                                        </dd>
                                        <dd>
                                            <p>러셀 <strong>대치</strong></p>
                                            02) 2138-1010
                                            <a href="https://russeldc.megastudy.net/russel/campus_common/russel_danka/russel_danka_new.asp?idx=1767" target="_blank">시간표 바로가기</a>
                                        </dd>
                                        <dd>
                                            <p>러셀 <strong>목동</strong></p>
                                            02) 6932-1010
                                            <a href="https://russelmd.megastudy.net/russel/campus_common/russel_danka/russel_danka_new.asp?idx=1768" target="_blank">시간표 바로가기</a>
                                        </dd>
                                        <dd>
                                            <p>러셀 <strong>부천</strong></p>
                                            032) 265-1010
                                            <a href="https://russelbc.megastudy.net/russel/campus_common/russel_danka/russel_danka_new.asp?idx=1769" target="_blank">시간표 바로가기</a>
                                        </dd>
                                        <dd>
                                            <p>러셀 <strong>분당</strong></p>
                                            031) 629-1010
                                            <a href="https://russelbd.megastudy.net/russel/campus_common/russel_danka/russel_danka_new.asp?idx=1770" target="_blank">시간표 바로가기</a>
                                        </dd>
                                        <dd>
                                            <p>러셀 <strong>영통</strong></p>
                                            031) 251-1010
                                            <a href="https://russelyt.megastudy.net/russel/campus_common/russel_danka/russel_danka_new.asp?idx=1771" target="_blank">시간표 바로가기</a>
                                        </dd>                                    
                                        <dd>
                                            <p>러셀 <strong>중계</strong></p>
                                            02) 6316-1010
                                            <a href="https://russeljg.megastudy.net/russel/campus_common/russel_danka/russel_danka_new.asp?idx=1772" target="_blank">시간표 바로가기</a>
                                        </dd>
                                        <dd>
                                            <p>러셀 <strong>평촌</strong></p>
                                            031) 341-6500
                                            <a href="https://russelpc.megastudy.net/russel/campus_common/russel_danka/russel_danka_new.asp?idx=1773" target="_blank">시간표 바로가기</a>
                                        </dd>
                                        <dd>
                                            <p>러셀 <strong>대구</strong> <img src="<%=Application("img_path_russel")%>/intro/2023/first/ic_new.gif" alt="new" class="va_m" /></p>
                                            053) 291-1010
                                            <a href="https://russeldg.megastudy.net/russel/campus_common/russel_danka/russel_danka_new.asp?idx=1774" target="_blank">시간표 바로가기</a>
                                        </dd>
                                        <dd>
                                            <p>러셀 <strong>센텀</strong></p>
                                            051) 715-1010
                                            <a href="https://russelct.megastudy.net/russel/campus_common/russel_danka/russel_danka_new.asp?idx=1775" target="_blank">시간표 바로가기</a>
                                        </dd>
                                        <dd>
                                            <p>러셀 <strong>울산</strong> <img src="<%=Application("img_path_russel")%>/intro/2023/first/ic_new.gif" alt="new" class="va_m" /></p>
                                            052) 913-1010
                                            <a href="https://russelus.megastudy.net/russel/campus_common/russel_danka/russel_danka_new.asp?idx=1776" target="_blank">시간표 바로가기</a>
                                        </dd>
                                    </dl>
                                    <dl>
                                        ...
                                        <dd>
                                            ...
                                            062) 462-1010
                                            <a href="https://coregj.megastudy.net/russel/campus_common/russel_danka/russel_danka_new.asp?idx=1777" target="_blank">시간표 바로가기</a>
                                        </dd>                                    
                                        <dd>
                                            <p>러셀CORE <strong>대전</strong> <img src="<%=Application("img_path_russel")%>/intro/2023/first/ic_new.gif" alt="new" class="va_m" /></p>
                                            042) 381-2020
                                            <a href="https://coredj.megastudy.net/russel/campus_common/russel_danka/russel_danka_new.asp?idx=1778" target="_blank">시간표 바로가기</a>
                                        </dd> 
                                        <dd>
                                            <p>러셀CORE <strong>원주</strong> <img src="<%=Application("img_path_russel")%>/intro/2023/first/ic_new.gif" alt="new" class="va_m" /></p>
                                            033) 901-2020
                                            <a href="https://corewj.megastudy.net/russel/campus_common/russel_danka/russel_danka_new.asp?idx=1779" target="_blank">시간표 바로가기</a>
                                        </dd>
                                        <dd>
                                            <p>러셀CORE <strong>전주</strong> <img src="<%=Application("img_path_russel")%>/intro/2023/first/ic_new.gif" alt="new" class="va_m" /></p>
                                            063) 905-3030
                                            <a href="https://corejj.megastudy.net/russel/campus_common/russel_danka/russel_danka_new.asp?idx=1780" target="_blank">시간표 바로가기</a>
                                        </dd>
                                        <dd class="bbn">
                                            <p>러셀CORE <strong>창원</strong> <img src="<%=Application("img_path_russel")%>/intro/2023/first/ic_new.gif" alt="new" class="va_m" /></p>
                                            055) 605-1010
                                            <a href="https://corecw.megastudy.net/russel/campus_common/russel_danka/russel_danka_new.asp?idx=1781" target="_blank">시간표 바로가기</a>
                                        </dd>
                                        <dd>
                                            <p>러셀CORE <strong>청주</strong> <img src="<%=Application("img_path_russel")%>/intro/2023/first/ic_new.gif" alt="new" class="va_m" /></p>
                                            043) 908-1010
                                            <a href="https://corecj.megastudy.net/russel/campus_common/russel_danka/russel_danka_new.asp?idx=1782" target="_blank">시간표 바로가기</a>
                                        </dd>                                                           
                                    </dl>
                                </div>
                                <!-- //campus-list -->

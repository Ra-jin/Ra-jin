...
<div class="pay-pop">
    <p class="tit"><strong>2025 러셀 수능 실전 모의체험 신청하기</strong></p>
				...
				<li>
					...
					<span>
						<select name="SH_EXAM_ADDR" id="SH_EXAM_ADDR" style="width:67%">
							...
							<option value="러셀분당">러셀 분당</option>
...
<script type="text/javascript">
	...
	function showMap(){
		...
		window.open('/intro/2024/csat/pop_map.asp?sel='+text+'','_blank','scrollbars=yes,width=680,height=560');
	}

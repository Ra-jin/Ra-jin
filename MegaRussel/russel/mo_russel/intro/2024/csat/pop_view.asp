    ...
    <div class="pay-pop-in">
		<div class="pop-info">		
			...
			<ul class="pt-list">
				<li>
					...
					<p class="s-txt-info">※ 신청 정보 수정 및 취소는 11월 13일(수) 오후 2시까지 가능합니다.</p>
				</li>
			</ul>
		</div>
		<!-- //pop-info -->	
		...
		<% If curYmdhmin < 202411131400 then %>
			<p class="bt-box-02 bt-sev" style="margin:0 4%;background:#fff">
				<a href="javascript:;" onclick="window.open('/intro/2024/csat/pop_modify.asp','popup_mock','width=680,height=560,left=100,top=200,scrollbars=yes')" class="bt-b ml0 ">수정하기</a>

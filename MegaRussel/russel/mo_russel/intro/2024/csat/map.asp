...
<div class="map-wrapper">
	<p class="tac"><img src="<%=Application("img_path_russel")%>/m_russel/intro/2024/csat/cont01_map.jpg" alt="" /></p>
	<!-- 지도 시계방향 순 -->
	<!-- 강남 -->
	<div class="campus-info c-gn <%=box_gn%>">
		...
		<div class="info-inner">
			...
			<span class="bt-close"><img src="<%=img_path_russel%>/m_russel/common/btn_layer_close.jpg" /></span>
		</div>
	</div>
	<!-- //강남 -->
	<!-- 대치 -->
	...
	<!-- //센텀 -->
	<!-- 울산 -->
	<div class="campus-info c-us <%=box_us%>">
	...
	<div class="campus-info c-dj <%=box_dj%>">
		<p class="tit">23-24 2년 연속 대전 지역<br>최상위권 입결 1위<sup>*</sup> <strong>러셀CORE 대전</strong></p>
		<div class="info-inner">
			<p class="tit">23-24 2년 연속 대전 지역<br>최상위권 입결 1위<sup>*</sup> <strong>러셀CORE 대전</strong></p>
			<ul class="txt">
    ...
    <p class="r-txt">
		*부천&middot;인천 지역/분당 지역/영통&middot;수원 지역/강북 지역/평촌&middot;안양 지역/대구&middot; <br>
		경북 지역/부산 지역/광주&middot;전남 지역/대전 지역/원주 지역/<br>
        전주&middot;전북 지역/창원 지역/청주 지역 학원_2020~2024학년도 홈페이지 <br>
        의치한수약+서연고 최종 합격자 노출 수 비교 기준 (2024.02.29 기준)
	</p>
</div>

...
<div class="recruit-wrap">
    <!-- 입학 절차 안내 -->
    <p class="recruit-tit">러셀 대치 썸머스쿨<br><strong>입학 절차 안내</strong></p>
    ...
    <div class="step-txt-wrap">
        <div class="step-txt">
            <p class="step-tit" style="display: inline-block;margin-right: 5px;"> 1) 원서접수 / 성적표 제출</p>
            <ul class="info-txt mt0 ml0">
        ...
        <div class="step-txt">
            <p class="step-tit" style="display: inline-block;margin-right: 5px;">2) 합격자 발표 : 6월 중순(별도 안내 문자) </p>
            <ul class="info-txt mt0 ml0">
    ...
    <!-- 모집요강 및 지원혜택 -->
    <p class="recruit-tit">러셀 대치 썸머스쿨<br><strong>모집요강 및 지원혜택</strong></p>

<div class="teacher-rolling-inner">
            ...
            <ul class="swiper-wrapper">
                ...
                <li class="swiper-slide">
                    <div class="info-box">
                        ...
                        <span class="t-explain">성균관대학교 대학원<br>
                        수학교육 졸업
                        </span>
                    </div>
                ...
                <!-- <li class="swiper-slide">
                    <div class="info-box">
                        ...
                        <span class="t-explain">한국교원대학교<br>화학교육과 졸업</span>
                    </div>
        ...
        <div class="teacher-sub-list swiper-container russel_us">
            <ul class="swiper-wrapper">
                ...
                <li class="swiper-slide t-ldj">
                    <div class="info-box">
                        <span class="cate live">대치동 LIVE 단과</span>
                        <span class="t-sub">동사/세사/한국사</span>
                        <span class="t-info"><strong>이다지</strong> 선생님</span>
                    </div>
                    <p class="pic"><img src="<%=Application("img_path_russel")%>/teacher/slide/soc_ldj.png" alt="" /></p>
                    <div class="ico-box">
    ...
    <link href="/css/t_list.css" rel="stylesheet" type="text/css">
    <style>
        .teacher-wrap .teacher-sub-list .info-box {height:106px !important}
        ...
        <div class="teacher-sub-list swiper-container core_dj">
            <ul class="swiper-wrapper">
                ...
                <li class="swiper-slide">
                    ...
                    <p class="pic"><img class="mt20" src="<%=Application("img_path_russel")%>/teacher/slide/ko_sys.png" alt="" /></p>
                    <div class="ico-box">
                        <p><span>러셀<br>강남</span></p>
                        <p><span>러셀<br>대치</span></p>
                        <p><span>러셀<br>기숙</span></p>
                ...
                <li class="swiper-slide">
                    ...
                    <p class="pic"><img class="mt20" src="<%=Application("img_path_russel")%>/teacher/slide/ko_cih.png" alt="" /></p>
                    <div class="ico-box">
                        <p><span>러셀<br>강남</span></p>
                        <p><span>러셀<br>대치</span></p>
                        <p class="i-blue"><span><strong>메가스터디</strong>인강</span></p>
                ...
                <li class="swiper-slide">
                    ...
                    <p class="pic"><img class="mt20" src="<%=Application("img_path_russel")%>/teacher/slide/math_kgr.png" alt="" /></p>
                    <div class="ico-box">
                        <p><span>러셀<br>대치</span></p>
                        <p><span>러셀<br>중계</span></p>
                    </div>
                ...
                <li class="swiper-slide">
                    ...
                    <p class="pic"><img class="mt20" src="<%=Application("img_path_russel")%>/teacher/slide/math_khm.png" alt="" /></p>
                    <div class="ico-box">
                        <p><span>러셀<br>영통</span></p>
                    </div>
                </li>
                ...
                <li class="swiper-slide">
                    ...
                    <p class="pic"><img class="mt20" src="<%=Application("img_path_russel")%>/teacher/slide/math_ysj.png" alt="" /></p>
                    <div class="ico-box">
                        <p><span>러셀<br>대치</span></p>
                        <p><span>러셀<br>분당</span></p>
                        <p class="i-blue"><span><strong>메가스터디</strong>인강</span></p>
                ...
                <li class="swiper-slide">
                    ...
                    <p class="pic"><img class="pt20" src="<%=Application("img_path_russel")%>/teacher/slide/math_jyj.png" alt="" /></p>
                    <div class="ico-box">
                        <p><span>러셀<br>강남</span></p>
                        <p><span>러셀<br>대치</span></p>
                        <p class="i-blue"><span><strong>메가스터디</strong>인강</span></p>
                ...
                <li class="swiper-slide">
                    ...
                    <p class="pic"><img class="mt20" src="<%=Application("img_path_russel")%>/teacher/slide/eng_kkc.png" alt="" /></p>
                    <div class="ico-box">
                        <p><span>러셀<br>대치</span></p>
                        <p><span>러셀<br>목동</span></p>
                        <p class="i-blue"><span><strong>메가스터디</strong>인강</span></p>
                ...
                <li class="swiper-slide t-ijy">
                    ...
                    <p class="pic"><img class="mt20" src="<%=Application("img_path_russel")%>/teacher/slide/eng_ljy.png" alt="" /></p>
                    <div class="ico-box">
                        <p><span>러셀<br>강남</span></p>
                        <p><span>러셀<br>분당</span></p>
                ...
                <li class="swiper-slide">
                    ...
                    <p class="pic"><img class="mt20" src="<%=Application("img_path_russel")%>/teacher/slide/soc_lks.png" alt="" /></p>
                    <div class="ico-box">
                        <p><span>러셀<br>대치</span></p>
                        <p class="i-blue"><span><strong>메가스터디</strong>인강 1위</span></p>
                    </div>
                ...
                <li class="swiper-slide">
                    ...
                    <p class="pic"><img class="mt20" src="<%=Application("img_path_russel")%>/teacher/slide/soc_kji.png" alt="" /></p>
                    <div class="ico-box">
                        <p><span>러셀<br>강남</span></p>
                        <p><span>러셀<br>대치</span></p>
                        <p><span>러셀<br>기숙</span></p>
                ...
                <li class="swiper-slide">
                    ...
                    <p class="pic"><img class="mt20" src="<%=Application("img_path_russel")%>/teacher/slide/soc_kyt.png" alt="" /></p>
                    <div class="ico-box">
                        <p><span>러셀<br>강남</span></p>
                        <p><span>러셀<br>대치</span></p>
                        <p class="i-blue"><span><strong>메가스터디</strong>인강</span></p>
                ...
                <li class="swiper-slide">
                    ...
                    <p class="pic"><img class="mt20" src="<%=Application("img_path_russel")%>/teacher/slide/soc_wyh.png" alt="" /></p>
                    <div class="ico-box">
                        <p><span>러셀<br>대치</span></p>
                        <p><span>러셀<br>분당</span></p>
                        <p class="i-blue"><span><strong>메가스터디</strong>인강 1위</span></p>
                ...
                <li class="swiper-slide">
                    ...
                    <p class="pic"><img class="mt20" src="<%=Application("img_path_russel")%>/teacher/slide/sci_kjg.png" alt="" /></p>
                    <div class="ico-box">
                        <p><span>러셀<br>강남</span></p>
                        <p><span>러셀<br>기숙</span></p>
                    </div>
                ...
                <li class="swiper-slide">
                    ...
                    <p class="pic"><img class="mt20" src="<%=Application("img_path_russel")%>/teacher/slide/sci_jwj.png" alt="" /></p>
                    <div class="ico-box">
                        <p><span>러셀<br>강남</span></p>
                        <p><span>러셀<br>대치</span></p>
                        <p class="i-blue"><span><strong>메가스터디</strong>인강</span></p>
                ...
                <li class="swiper-slide">
                    ...
                    <p class="pic"><img class="mt20" src="<%=Application("img_path_russel")%>/teacher/slide/sci_khs.png" alt="" /></p>
                    <div class="ico-box">
                        <p><span>러셀<br>부천</span></p>
                        <p><span>러셀<br>영통</span></p>
                    </div>
                ...
                <li class="swiper-slide">
                    ...
                    <p class="pic"><img class="mt20" src="<%=Application("img_path_russel")%>/teacher/slide/sci_yes.png" alt="" /></p>
                    <div class="ico-box">
                        <p><span>러셀<br>부천</span></p>
                        <p><span>러셀<br>중계</span></p>
                    </div>
                ...
                <li class="swiper-slide">
                    ...
                    <p class="pic"><img class="mt20" src="<%=Application("img_path_russel")%>/teacher/slide/sci_uyd.png" alt="" /></p>
                    <div class="ico-box">
                        <p><span>러셀<br>대치</span></p>
                        <p><span>러셀<br>목동</span></p>
                        <p class="i-blue"><span><strong>메가스터디</strong>인강</span></p>
                ...
                <li class="swiper-slide">
                    ...
                    <p class="pic"><img class="mt20" src="<%=Application("img_path_russel")%>/teacher/slide/non_cih.png" alt="" /></p>
                    <div class="ico-box">
                        <p><span>러셀<br>강남</span></p>
                        <p><span>러셀<br>대치</span></p>
                        <p class="i-blue"><span><strong>메가스터디</strong>인강</span></p>
                ...
                <li class="swiper-slide">
                    ...
                    <p class="pic"><img class="mt20" src="<%=Application("img_path_russel")%>/teacher/slide/non_bke.png" alt="" /></p>
                    <div class="ico-box">
                        <p><span>러셀<br>강남</span></p>
                        <p><span>러셀<br>대치</span></p>
                        <p><span>러셀<br>기숙</span></p>
    ...
    <link href="/css/t_list.css" rel="stylesheet" type="text/css">
    <div class="teacher-wrap">
        <div class="teacher-sub-list swiper-container core_wj">
            <ul class="swiper-wrapper">
                <!-- 국어 -->
                <li class="swiper-slide">
                    <div class="info-box">
                ...
                <!-- <li class="swiper-slide">
                    <div class="info-box">
                        ...
                        <span class="cate new">신규</span>
                        <span class="t-sub">수학</span>
                        <span class="t-info"><strong>안영주</strong> 선생님</span>
                    </div>
                    <p class="pic"><img src="<%=Application("img_path_russel")%>/teacher/slide/math_ayj.png" alt="" /></p>
                    <div class="ico-box">
                    </div>
                </li>          -->
                <!-- //수학 -->
                ...
                <li class="swiper-slide">
                    <div class="info-box">
                        <span class="cate live">대치동 LIVE 단과</span>
                        <span class="t-sub">생활과윤리/<br>윤리와사상</span>
                        <span class="t-info"><strong>김종익</strong> 선생님</span>
                    </div>
                    <p class="pic"><img src="<%=Application("img_path_russel")%>/teacher/slide/soc_kji.png" alt="" /></p>
                    <div class="ico-box">
    ...
    <div class="teacher-rolling swiper-container">
        ...
        <div class="swiper-wrapper">
            ...
            <div class="swiper-slide">
                ...
                <span class="t-img"><img src="<%=Application("img_path_russel")%>/teacher/slide/eng_jjs02.png" alt=""></span>
            </div>
            <div class="swiper-slide">
                <dl class="t-name">
                    <dt>영어</dt>
        ...
        <div class="swiper-wrapper">
            ...
            <!-- <div class="swiper-slide">
                <dl class="t-name">
                    <dt>영어</dt>
                    <dd><strong>김동하</strong> 선생님</dd>
                </dl>
                <span class="t-img"><img src="<%=Application("img_path_russel")%>/teacher/slide/eng_kdh.png" alt=""></span>
            </div> -->
            <div class="swiper-slide">
                <dl class="t-name">
                    <dt>영어</dt>
        ...
        <div class="swiper-wrapper">
            ...
            <div class="swiper-slide">
                ...
                <span class="t-img"><img src="<%=Application("img_path_russel")%>/teacher/slide/eng_mjs02.png" alt=""></span>
            </div>
            <div class="swiper-slide">
                <dl class="t-name">
                    <dt>영어</dt>
            ...
            <div class="swiper-slide">
                ...
                <span class="t-img"><img src="<%=Application("img_path_russel")%>/teacher/slide/eng_yj02.png" alt=""></span>
            </div>
            <div class="swiper-slide">
                <dl class="t-name">
                    <dt>영어</dt>
                ...
                <span class="t-img"><img src="<%=Application("img_path_russel")%>/teacher/slide/eng_ijy02.png" alt=""></span>
            </div>
            <div class="swiper-slide">
                <dl class="t-name">
                    <dt>영어</dt>
        ...
        <div class="swiper-wrapper">
            ...
            <div class="swiper-slide">
                ...
                <span class="t-img"><img src="<%=Application("img_path_russel")%>/teacher/slide/math_gdg02.png" alt=""></span>
            </div>
            <div class="swiper-slide">
                <dl class="t-name">
                    <dt>수학(고1&middot;2)</dt>
        ...
        <div class="swiper-wrapper">
            ...
            <div class="swiper-slide">
                <dl class="t-name">
                    <dt>국어(내신)</dt>
                    <dd><strong>손유빈</strong> 선생님</dd>
                </dl>
                <span class="t-img"><img src="<%=Application("img_path_russel")%>/teacher/slide/ko_syb.png" alt=""></span>
            </div>
            <div class="swiper-slide">
                <dl class="t-name">
                    <dt>국어(내신)</dt>
            ...
            <div class="swiper-slide">
                ...
                <span class="t-img"><img src="<%=Application("img_path_russel")%>/teacher/slide/eng_pjm02.png" alt=""></span>
            </div>
            <div class="swiper-slide">
                <dl class="t-name">
                    <dt>영어(내신)</dt>
            ...
            <div class="swiper-slide">
                <dl class="t-name">
                    <dt>영어(내신)</dt>
                    <dd><strong>최지우</strong> 선생님</dd>
                </dl>
                <span class="t-img"><img src="<%=Application("img_path_russel")%>/teacher/slide/eng_cjw.png" alt=""></span>
            </div>
            <div class="swiper-slide">
                <dl class="t-name">
                    <dt>영어(내신)</dt>
            ...
            <div class="swiper-slide">
                ...
                <span class="t-img"><img src="<%=Application("img_path_russel")%>/teacher/slide/sci_ldh02.png" alt=""></span>
            </div>
            <div class="swiper-slide">
                <dl class="t-name">
                    <dt>통합과학(내신)</dt>
        ...
        <div class="swiper-wrapper">
            ...
            <div class="swiper-slide">
                <dl class="t-name">
                    <dt>수학</dt>
                    <dd><strong>독고영성</strong> 선생님</dd>
                </dl>
                <span class="t-img"><img src="<%=Application("img_path_russel")%>/teacher/slide/math_dgys.png" alt=""></span>
            </div>
            <div class="swiper-slide">
                <dl class="t-name">
                    <dt>수학</dt>
            ...
            <div class="swiper-slide">
                ...
                <span class="t-img"><img src="<%=Application("img_path_russel")%>/teacher/slide/non_hth.png" alt=""></span>
            </div>
            <div class="swiper-slide">
                <dl class="t-name">
                    <dt>인문논술</dt>
        ...
        <div class="swiper-wrapper">
            ...
            <div class="swiper-slide">
                ...
                <span class="t-img"><img src="<%=Application("img_path_russel")%>/teacher/slide/math_kyc02.png" alt=""></span>
            </div>
            <div class="swiper-slide">
                <dl class="t-name">
                    <dt>수학</dt>
            ...
            <div class="swiper-slide">
                <dl class="t-name">
                    <dt>수학</dt>
                    <dd><strong>김초록</strong> 선생님</dd>
                </dl>
                <span class="t-img"><img src="<%=Application("img_path_russel")%>/teacher/slide/math_kcr.png" alt=""></span>
            </div>
            <div class="swiper-slide">
                <dl class="t-name">
                    <dt>수학</dt>
                    <dd><strong>김하윤</strong> 선생님</dd>
                </dl>
                <span class="t-img"><img src="<%=Application("img_path_russel")%>/teacher/slide/math_khy.png" alt=""></span>
            </div>
            <div class="swiper-slide">
                <dl class="t-name">
                    <dt>수학</dt>
            ...
            <div class="swiper-slide">
                <dl class="t-name">
                    <dt>수학</dt>
                    <dd><strong>한만유</strong> 선생님</dd>
                </dl>
                <span class="t-img"><img src="<%=Application("img_path_russel")%>/teacher/slide/math_hmy.png" alt=""></span>
            </div>
            ...
            <div class="swiper-slide">
                <dl class="t-name">
                    <dt>통합과학/<br>생명과학Ⅰ</dt>
                    <dd><strong>이해인</strong> 선생님</dd>
                </dl>
                <span class="t-img"><img src="<%=Application("img_path_russel")%>/teacher/slide/sci_lhi.png" alt=""></span>
            </div>
            <div class="swiper-slide">
                <dl class="t-name">
                    <dt>통합과학/<br>생명과학Ⅰ</dt>
        ...
        <div class="swiper-wrapper">
            ...
            <div class="swiper-slide">
                ...
                <span class="t-img b-blue"><img src="<%=Application("img_path_russel")%>/teacher/slide/sci_ksj02.png" alt=""></span>
            </div>
            <div class="swiper-slide">
                <dl class="t-name">
                    <dt>화학</dt>
        ...
        <div class="swiper-wrapper">
            ...
            <div class="swiper-slide">
                ...
                <span class="t-img"><img src="<%=Application("img_path_russel")%>/teacher/slide/math_ksm02.png" alt=""></span>
            </div>
            <div class="swiper-slide">
                <dl class="t-name">
                    <dt>수학</dt>
                    <dd><strong>윤성길</strong> 선생님</dd>
                </dl>
                <span class="t-img"><img src="<%=Application("img_path_russel")%>/teacher/slide/math_ysg.png" alt=""></span>
            </div>
            <!-- 영어 -->
            <div class="swiper-slide">
                <dl class="t-name">

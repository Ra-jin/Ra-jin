...
Select Case GetCampusVarsSiteMGC("_CAMPUS_CODE_")	
	...
	Case "CD0345": txtCampus = "러셀CORE 창원"  '코어창원
					...
					category = "special"
					camUrl = "mcorecw"
					am_url = "https://mcorecw.megastudy.net/common/russel_danka/russel_danka.asp?idx=1577"
					medical_txt = "전문반"
            ...
            <div class="layer-wrap">
                ...
                <div class="layer-in">
                    ...
                    <div>
                        글자입니다.<br>
                        이미지입니다.<br>
                        <img src="https://rms.megastudy.net/upload_file/SmartUpload/se2cpsM4lixdS1zDkKs8CL1_2.JPG" alt="">
                    </div>
                    <style>
                        .layer-wrap .layer-in {position:relative;width:90%;max-height:80%;overflow:auto; margin:0 5%;padding:10px 20px 20px;box-sizing:border-box;background:#fff;box-shadow:0 3px 3px rgba(95, 95, 95, .5);text-align:left;font-size:1.4rem;}
                        .layer-wrap div img {width:100%;}
                        .layer-wrap div img.on {width:auto;}
                        .layer-in .js-close-mask {position:fixed;right:8%;}
                    </style>
                    <script>
                        $('.layer-wrap div img').on('click', function() {
                            $(this).toggleClass('on')
                        });
                        $('.js-close-mask a').on('click',function(){
                            $('.layer-wrap div img').removeClass('on');
                        });
                    </script>
                </div>
            </div>

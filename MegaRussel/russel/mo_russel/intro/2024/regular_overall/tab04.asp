<div class="cont js-cont-wrap <%=campusName%>">
    ...
    <div class="cont06 <%=campusName%>">
        <% If campus_code = "CD0340" or campus_code = "CD0342" or campus_code = "CD0349" or campus_code = "CD0249" or campus_code = "CD0257" Then '코어광주/대구/울산/영통/중계 %>
        <div class="inner">
            ...
            <div><img src="<%=Application("img_path_russel")%>/m_russel/<%=campusName%>/2024/regular_overall/cont05_img.jpg" alt="" /></div>
            <% Else %>
        ...
        <div class="inner">
            ...
            <div class="box-con box1">
                ...
                <p class="s-tit">
                    ...
                    확보</b>할 수 있습니다.</p>
                <p class="txt-ss">
                    (*기존 종합반 30T~42T 대비 러셀 종합반 <%=time_txt02%>T 비교 시)
                </p>
            ...
            <div class="box-con box2">
                ...
                <p class="r-txt mb10">* 사회탐구는 대치동LIVE강의로 진행됩니다.
                </p>
                <% End If %>
            </div>
            <!-- //강사진 -->
        ...
        <div class="inner">
            ...
            <div class="box-con box3 <%=campusName%>">
                ...
                <p class="s-tit">
                    수능 리듬에 맞춘 종합반 수업 및<br>바른공부 자습전용관 표준 시간표구성으로<br><b>규칙적인 학습습관을 체화</b>할 수 있습니다.
                </p>
                <% If campus_code = "CD0340" Then '코어광주 %>
                <div class="tbl-scroll-x">
                    <table class="tbl-type01 tbl-center" style="width: 200%;">
                ...
                <p class="r-txt mt10 mb45">* 학원사정에 따라 운영시간이 변경될 수 있으니, 학원으로 확인 바랍니다.</p>
                ...
                <p class="r-txt mt10">* 학원사정에 따라 운영시간이 변경될 수 있으니,<br>
                학원으로 확인 바랍니다.
                </p>
                <% ElseIf campus_code = "CD0342" Then '대구 %>
                <div class="tbl-scroll-x">
            ...
            <div class="box-con box4 mt0">
                <p><img src="<%=Application("img_path_russel")%>/m_russel/<%=campusName%>/2024/regular_overall/cont05_tit05.png" alt="러셀 재수종합반 연간 커리큘럼" /></p>
                <div class="mt30"><img src="<%=Application("img_path_russel")%>/m_russel/<%=campusName%>/2024/regular_overall/cont05_img02.png" alt="" /></div>
                <% If campus_code = "CD0249" OR campus_code = "CD0342" OR campus_code = "CD0349" Then '영통/대구/울산 %>
                ...
                <% End If %>
                <p class="r-txt mt10">※ 학원 사정에 의해 연간 커리큘럼 내용은 변경될 수 있습니다.</p>
            </div>

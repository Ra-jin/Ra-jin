<div class="teacher-rolling-inner">
    ...
    <!-- #include virtual = "/inc/t_list/t_list_full_dg_02.asp" -->
    <% ElseIf campus_code = "CD0349" Then '울산 %>
    <!-- #include virtual = "/inc/t_list/t_list_full_us_02.asp" -->
    ...
    <div class="teacher-rolling swiper-container">
        ...
        <div class="swiper-wrapper">
            ...
            <div class="swiper-slide">
                ...
                <span class="t-img"><img class="pt20" src="<%=Application("img_path_russel")%>/teacher/slide/eng_jhj.png" alt=""></span>
            </div>
            <div class="swiper-slide">
                <dl class="t-name">
                    <dt>영어</dt>
...
<% If campus_code = "INTRO" Then '인트로 %>
<p class="r-txt">* 학원 홈페이지에서 학원별 출강 선생님을 확인할 수 있으며, 학원 운영에 <br> 따라 출강 선생님은 변경될 수 있습니다.</p>
<% ElseIf campus_code = "CD0257" Then '중계 %>

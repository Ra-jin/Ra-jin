...
<head>
    ...
    <meta name="title" content="2025 재학생 정규반" />
    <meta name="keywords" content="2025 재학생 정규반, 재학생 정규반, 정규반 재학생, 러셀 정규반, 정규반, 재학생, wjdrbqks" />
...
<h2 class="sub-tit">
    ...
    <strong class="tit">2024 재학생 최상위권반</strong>
    ...
    <% Else %>
    <strong class="tit">2025 재학생 정규반</strong>
    <% End If %>
</h2>
<section class="sub-wrap">
    ...
    <div class="regular-go-wrap">
        ...
        <!--visual-->
        <!-- #include virtual = "/intro/2024/regular_go/visual.asp" -->
        <!--//visual-->
        ...
        <div class="container <%=campusName%>">
            ...
            <div class="cont00 js-cont-wrap js-cont">
                <div class="inner">
                    <p class="recruit-tit">
                        <% If campus_code = "CD0247" or campus_code = "CD0244" or campus_code = "CD0250" or campus_code = "CD0245" Then '강남/분당/부천/목동 %>
                        <%=txtCampus%>&nbsp;<%=mjinfo_tit%><br><strong>모집안내</strong>
                        <% Else %>
                        <%=txtCampus%> 재학생 정규반<br><strong>모집안내</strong>
                        <% End If %>
                    </p>
                    <div class="tbl-box type01">
                        ...
                        <div class="ico-end" style="top: -11vw;right: 0vw;"><p style="font-size: 1.4rem;"><%=endText%></p></div>
                        <% End If %>  
                        <!--//마감딱지-->
                    </div>
                    ...
                    <!--//마감딱지-->
                    <!-- 원서접수 버튼 -->
                    <% If campus_code <> "CD0001" and campus_code <> "CD0340" Then '대치/코어광주 제외 %>
                    <% If campus_code = "CD0247" OR campus_code = "CD0341" OR campus_code = "CD0344" OR campus_code = "CD0346" OR campus_code = "CD0345" OR campus_code = "CD0343" OR campus_code = "CD0349" OR campus_code = "CD0245" Then '강남/대치/코어대전/전주/청주/창원/원주/울산/목동 %>
                    <a href="<%=apply_url%>" onclick="alert('원서접수는 PC 페이지에서 이용 가능합니다.')" class="btn-link mt20" target="_blank"><%=apply_txt%></a>
                    <% ElseIf campus_code = "CD0244" Then '분당 %>
                    <a href="<%=apply_url%>" onclick="alert('대기접수는 PC 페이지에서 이용 가능합니다.')" class="btn-link mt20" target="_blank"><%=apply_txt%></a>
                    ...
                    <%  
                        ...
                        dirFile = "/intro/2024/regular_go/"&campusName02&".asp"
            ...
            <!-- tab -->
            <!-- #include virtual = "/intro/2024/regular_go/tab01.asp" -->
            <!-- #include virtual = "/intro/2024/regular_go/tab02.asp" -->

            <!-- 인트로 -->
            <% If campus_code = "INTRO" Then '인트로 %>
            <div class="recruit-tit js-cont-wrap "><span>2025 러셀 재학생 정규반</span><br>모집안내</div>
            <p class="recruit-txt">학원별 모집요강, 장학 혜택  및 상세 등록 방법은 <br>각 학원으로 문의바랍니다.</p>
            <!--학원별 모집안내-->

...
<div class="recruit-wrap">
    <p class="recruit-tit">러셀 센텀 재학생 정규반<br><strong>연간 운영 계획</strong></p>
    ...
    <!-- 입학 절차 안내 -->
    <p class="recruit-tit">러셀 센텀 재학생 정규반<br><strong>입학 절차 안내</strong></p>
    ...
    <div class="step-txt-wrap">
        <div class="step-txt">
            ...
            <ul class="list-bullet">
                ...
                <li>원서접수를 완료한 학생, 학부모 대상으로 문자를 통해 정규반 입학 절차가 안내됩니다.
                </li>
            </ul>
        </div>
        <div class="step-txt">
        ...
        <div class="step-txt">
            ...
            <p class="f14">2025 재학생 정규반 등록 완료</p>
            <ul class="list-bullet m0 f14">
    ...
    <!-- 모집요강 및 지원혜택 -->
    <p class="recruit-tit">러셀 센텀 재학생 정규반<br><strong>모집요강 및 장학혜택</strong></p>
    <div>
        <!-- 모집요강 자동화 시스템 영역 -->
        <%

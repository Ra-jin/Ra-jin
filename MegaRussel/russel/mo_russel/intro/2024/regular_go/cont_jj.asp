...
<div class="recruit-wrap">
    <p class="recruit-tit">러셀CORE 전주 재학생 정규반<br><strong>연간 운영 계획</strong></p>
    ...
    <!-- 입학 절차 안내 -->
    <p class="recruit-tit">러셀CORE 전주 재학생 정규반<br><strong>입학 절차 안내</strong></p>
    ...
    <div class="step-txt-wrap">
        <div class="step-txt">
            ...
            <a href="https://corejj.megastudy.net/russel/apply/yonhab/apply.asp?app_cd=168" onclick="alert('원서접수는 PC 페이지에서 이용 가능합니다.')" class="bt-gray-s ml10 mt10">원서접수 바로가기</a>
        </div>
        <div class="step-txt">
    ...
    <!-- 모집요강 및 지원혜택 -->
    <p class="recruit-tit">러셀CORE 전주 재학생 정규반<br><strong>모집요강 및 장학혜택</strong></p>
    <div>
        <!-- 모집요강 자동화 시스템 영역 -->
        <%

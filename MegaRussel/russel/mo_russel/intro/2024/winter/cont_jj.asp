...
<div class="recruit-wrap">
    ...
    <div class="step-txt-wrap">
        <div class="step-txt">
            <p class="step-tit" style="display: inline-block;margin-right: 5px;">1) 온라인 원서접수 후 사전예약금 납부 <a onclick="alert('원서접수는 PC 페이지에서 이용 가능합니다.')" href="https://corejj.megastudy.net/russel/apply/yonhab/apply.asp?app_cd=173" class="bt-gray-s ml10">원서접수 바로가기</a></p>
        </div>
        <div class="step-txt">
        ...
        <div class="step-txt">
            ...
            <!-- <ul class="list-bullet m0 mt0">
                <li>1월 강의 시간표가 확정되면 필수 수강 시수에 따른 강의 등록 안내 드립니다.</li>
            </ul> -->
        </div>

...
<div class="recruit-wrap">
    ...
    <div class="step-txt-wrap">
        <div class="step-txt">
            <p class="step-tit" style="display: inline-block;margin-right: 5px;">1) 온라인 원서접수 후 사전예약금 납부 <a href="javascript:alert('대기접수는 PC 페이지에서 이용 가능합니다.'); location.href='https://corecw.megastudy.net/russel/apply/yonhab/apply.asp?app_cd=173';"  class="bt-gray-s ml10">대기접수 바로가기</a></p>
            <ul class="list-bullet m0 mt0">
                <li>사전예약금까지 결제하셔야 윈터스쿨 사전예약이 완료됩니다.</li>
            </ul>
        </div>
        <div class="step-txt">

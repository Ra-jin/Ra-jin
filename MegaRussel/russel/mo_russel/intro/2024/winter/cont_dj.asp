...
<div class="recruit-wrap">
    ...
    <ul class="setp-diagram">
        <li>
            ...
            <span>온라인 원서접수 후<br>
                사전예약금 납부</span>
            <a href="javascript:void(0)" onclick="alert('원서접수는 PC 페이지에서 이용 가능합니다.'); location.href='https://coredj.megastudy.net/russel/apply/yonhab/apply.asp?app_cd=173'" class="bt-gray-s">원서접수 바로가기</a>
        </li>
        <li>
    ...
    <!-- 모집요강 및 장학혜택 -->
    <p class="recruit-tit">2025 윈터스쿨<br><strong>모집요강</strong></p>

...
<h2 class="sub-tit">
    ...
    <strong class="tit">2025 재수 정규반</strong>
    <% Else %>
...
<section class="sub-wrap">
    ...
    <div class="regular-wrap">
        ...
        <a href="https://mrusselgn.megastudy.net/board/notice_view.asp?code=30768">
            <img src="<%=Application("img_path_russel")%>/m_russel/intro/2024/regular/img_recruit_gn.jpg" alt="" />
        </a>
        <% End If %> -->
        ...
        <div class="container <%=campusName%>">
            ...
            <ul class="fix-menu js-fix-menu">
                ...
                <li> 학원별<br>모집안내</li>
                <% ElseIf  campus_code = "CD0349" OR campus_code = "CD0343" OR campus_code = "CD0344" OR campus_code = "CD0345" OR campus_code = "CD0346" Then '울산/코어원주/코어전주/코어창원/코어청주 %>
            ...
            <div class="cont00 js-cont-wrap js-cont">
                <div class="inner">
                    <p class="recruit-tit">
                        <% If campus_code = "CD0249" Then '영통 %>
                        <%=txtCampus%> 재수 정규반<br><strong>모집안내</strong>
                        <% ElseIf campus_code = "CD0245" Then '목동 %>
                        <%=txtCampus%> 파이널 N수 정규반<br><strong>모집안내</strong>
                        <% Else %>
                        <%=txtCampus%> N수 정규반<br><strong>모집안내</strong>
                        <% End If %>
                    </p>
                    <div class="tbl-box type01" style="position: relative;">
                        <table class="tbl-type01">
                            ...
                            <tbody>
                                <% If campus_code <> "CD0244" and campus_code <> "CD0246" Then '분당/센텀 제외 %>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td class="text-align-left"><%=txt_02_02%></td>
                                </tr>
                        ...
                        <div class="ico-end" style="top: -10vw;right: 0vw;"><p style="font-size: 1.4rem;"><%=endText%></p></div>
                        <% ElseIf campus_code = "CD0342" Then '대구 %>
                        <div class="ico-end" style="top:-9vw;right: 0vw;"><p><%=endText%></p></div>
                        <% End If %>
                        <!--//마감딱지-->
                    </div>
                    ...
                    <% If campus_code = "CD0342" OR campus_code = "CD0247" OR campus_code = "CD0245" OR campus_code = "CD0246" OR campus_code = "CD0349" OR campus_code = "CD0340" OR campus_code = "CD0346" OR campus_code = "CD0343" OR campus_code = "CD0345" OR campus_code = "CD0341" OR campus_code = "CD0244" OR campus_code = "CD0344" Then '대구/강남/목동/센텀/울산/코어광주/코어청주/코어원주/코어창원/코어대전/분당/코어전주 %>
                    <a href="<%=apply_url%>" onclick="alert('<%=apply_alert%>')" class="btn-link mt20" target="_blank"><%=apply_txt%></a>
                    <% ElseIf campus_code = "CD0001" OR campus_code = "CD0248" OR campus_code = "CD0249" OR campus_code = "CD0257" Then '대치/평촌/영통/중계 %>
                    <% Else %>
                    <a href="javascript:void(0)" onclick="javascript:alert('추후 오픈 예정입니다.');" class="btn-link mt20"><%=apply_txt%></a>
                    <% End If %>
                    <% End If %>
                    <!-- //원서접수 버튼 -->

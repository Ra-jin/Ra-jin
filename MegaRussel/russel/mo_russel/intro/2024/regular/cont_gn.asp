...
<div class="recruit-wrap">
    ...
    <div class="step-txt-wrap">
        <div class="step-txt">
            ...
            <a href="https://russelgn.megastudy.net/russel/apply/jaejung/apply.asp?app_cd=164" onclick="alert('원서접수는 PC 페이지에서 이용 가능합니다.')" class="bt-gray-s ml10">원서접수 바로가기</a>
        ...
        <div class="step-txt">
            ...
            <ul class="list-bullet m0 f14">
                ...
                <li class="color-red"> 개강 전 입학 취소 시 바자관 및 단과 결제 비용은 전액 환불됩니다.
                </li>
            </ul>
        </div>
    </div>

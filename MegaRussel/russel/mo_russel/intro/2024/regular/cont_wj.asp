...
<div class="recruit-wrap">
    ...
    <div class="step-txt-wrap">
        <div class="step-txt">
            ...
            <a href="javascript:void(0)" onclick="alert('원서접수는 PC 페이지에서 이용 가능합니다.'); location.href='https://corewj.megastudy.net/russel/apply/jaejung/apply.asp?app_cd=164';" class="bt-gray-s ml10">원서접수 바로가기</a>
        </div>
        <div class="step-txt">
    ...
    <!-- <div class="tbl-box sns">
        ...
        <p class="tit">러셀CORE 원주 [N수 정규반]<br>

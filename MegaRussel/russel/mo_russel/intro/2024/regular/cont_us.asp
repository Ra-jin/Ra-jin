...
<div class="recruit-wrap">
    <!-- 입학 절차 안내 -->
    <p class="recruit-tit">러셀 울산 N수 정규반<br><strong>입학 절차 안내</strong></p>
    ...
    <ul class="setp-diagram">
        ...
        <li>
            ...
            <span>N수 정규반 <br>최종 등록 확인</span>
        </li>
    </ul>
    <div class="step-txt-wrap">
        <div class="step-txt">
            <p class="step-tit" style="display: inline-block;margin-right: 5px;"> 1) 입학상담/원서접수</p>
            <a href="https://russelus.megastudy.net/russel/apply/jaejung/apply.asp?app_cd=164" onclick="alert('원서접수는 PC 페이지에서 이용 가능합니다.')" class="bt-gray-s ml10">원서접수 바로가기</a>
            <ul class="list-dot">
                <li>방문/전화/온라인 상담</li>
                <li>온라인 원서 접수</li>
            </ul>
    ...
    <!-- 모집요강 및 지원혜택 -->
    <p class="recruit-tit">러셀 울산 N수 정규반<br><strong>모집요강 및 지원혜택</strong></p>
        <div class="tbl-box">

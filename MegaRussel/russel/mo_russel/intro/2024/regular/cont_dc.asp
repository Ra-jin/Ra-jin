...
<div class="recruit-wrap">
    <!-- 연간 운영 계획 -->
    <p class="recruit-tit">러셀 대치 N수 정규반<br><strong>연간 운영 계획</strong></p>
    ...
    <!-- 입학 절차 안내 -->
    <p class="recruit-tit">러셀 대치 N수 정규반<br><strong>입학 절차 안내</strong></p>
    
    <ul class="setp-diagram">
        <li>
            <div><strong>1</strong></div>
            <span>학원으로 문의 <br>(02-2138-1010)</span>
        </li>
        <!-- <li>
    ...
    <div class="step-txt-wrap">
        ...
        <div class="step-txt">
            ...
            <ul class="list-bullet ml0">
                <li>개인별 단과 등록 총 합산 시수(T)에 따라 바자관 이용료 지원 혜택 적용</li>
                <li>최저 입학 기준 미달 시, 바자관 등록 및 정규반 이용 불가</li>
            ...
            <p class="f14">■ OT 안내(추후 안내)</p>
        </div>
    </div>
    <!-- 모집요강 및 지원혜택 -->
    <p class="recruit-tit">러셀 대치 N수 정규반<br><strong>모집요강 및 지원혜택</strong></p>

...
<div class="recruit-wrap">
    <!-- 입학 절차 안내 -->
    <p class="recruit-tit">러셀CORE 청주 N수 정규반<br><strong>입학 절차 안내</strong></p>
    ...
    <div class="step-txt-wrap">
        <div class="step-txt">
            ...
            <a href="https://corecj.megastudy.net/russel/apply/jaejung/apply.asp?app_cd=164" onclick="alert('원서접수는 PC 페이지에서 이용 가능합니다.')" class="bt-gray-s ml10">원서접수 바로가기</a>
        </div>
        <div class="step-txt">
    ...
    <!-- 모집요강 및 지원혜택 -->
    <p class="recruit-tit">러셀CORE 청주 N수 정규반<br><strong>모집요강 및 지원혜택</strong></p>
    <div class="tbl-box">

...
<div class="recruit-wrap">
    ...
    <!-- 입학 절차 안내 -->
    <p class="recruit-tit">러셀 강남 파이널 정규반<br><strong>입학 절차 안내</strong></p>
    ...
    <div class="step-txt-wrap">
        <div class="step-txt">
            ...
            <a href="https://russelgn.megastudy.net/russel/apply/yonhab/apply.asp?app_cd=175" onclick="alert('원서접수는 PC 페이지에서 이용 가능합니다.')" class="bt-gray-s ml10">원서접수 바로가기</a>
    ...
    <!-- 모집요강 및 지원혜택 -->
    <p class="recruit-tit">러셀 강남 파이널 정규반<br><strong>모집요강 및 지원혜택</strong></p>

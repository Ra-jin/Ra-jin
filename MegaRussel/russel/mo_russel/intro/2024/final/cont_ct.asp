...
<div class="recruit-wrap">
    <p class="recruit-tit">러셀 센텀 파이널 정규반<br><strong>입학 절차 안내</strong></p>
    ...
    <div class="step-txt-wrap">
        <div class="step-txt">
            ...
            <a href="https://russelct.megastudy.net/russel/apply/yonhab/apply.asp?app_cd=175" onclick="alert('원서접수는 PC 페이지에서 이용 가능합니다.')" class="bt-gray-s">원서접수 바로가기</a>
            <ol>
                <li>① 온라인 원서접수</li>
                <li>② 사전 예약금 납부</li>
            </ol>
        ...
        <div class="step-txt">
            ...
            <p class="step-notice">2025 N수 파이널 정규반 등록 완료</p>
            <ul class="list-bullet m0 f14">
    ...
    <!-- 모집요강 및 지원혜택 -->
    <p class="recruit-tit">러셀 센텀 파이널 정규반<br><strong>모집요강 및 지원혜택</strong></p>
    <div class="tbl-box">
        <!-- 모집요강 자동화 시스템 영역 -->
        <%

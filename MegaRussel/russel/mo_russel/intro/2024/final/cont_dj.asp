...
<div class="recruit-wrap">
    <!-- 입학 절차 안내 -->
    <p class="recruit-tit">러셀CORE 대전 파이널 정규반<br><strong>입학 절차 안내</strong></p>
    ...
    <div class="step-txt-wrap">
        <div class="step-txt">
            ...
            <a href="https://coredj.megastudy.net/russel/apply/yonhab/apply.asp?app_cd=175" onclick="alert('원서접수는 PC 페이지에서 이용 가능합니다.')" class="bt-gray-s ml10 mt5">온라인 원서접수</a>
        </div>
        <div class="step-txt">
        ...
        <div class="step-txt">
            ...
            <p class="step-notice">* 단과 강의 8월 중순 결제 가능</p>
        </div>
        <div class="step-txt">
    ...
    <!-- 모집요강 및 지원혜택 -->
    <p class="recruit-tit">러셀CORE 대전 파이널 정규반<br><strong>모집요강 및 지원혜택</strong></p>

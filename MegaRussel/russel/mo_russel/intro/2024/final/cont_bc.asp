...
<div class="recruit-wrap">
    <!-- 입학 절차 안내 -->
    <p class="recruit-tit">러셀 부천 파이널 정규반<br><strong>입학 절차 안내</strong></p>
    ...
    <div class="step-txt-wrap">
        ...
        <div class="step-txt">
            ...
            <ul class="m0 f14">
                <li>모집요강 확인</li>
                <li>
                    ② 성적표 제출 <a href="https://pf.kakao.com/_sFgGxj" class="bt-gray-s ml10">성적표 제출하기</a> <br>
                    (현장 또는 상담 채널 통해 제출)
                </li>
    ...
    <ul class="list-bullet m0 mt10 f12">
        ※ 성적표 제출 방법 : 성적표 제출하기 버튼 클릭 > 러셀 부천학원 채널 추가 > 상담원 채팅 > 성적표 이미지 파일 전송
    </ul>


    <!-- 모집요강 및 지원혜택 -->
    <p class="recruit-tit">러셀 부천 파이널 정규반<br><strong>모집요강 및 지원혜택</strong></p>
    
    <div class="tbl-box pt10">
        <!-- 모집요강 자동화 시스템 영역 -->
        <%

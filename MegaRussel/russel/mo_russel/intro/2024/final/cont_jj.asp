...
<div class="recruit-wrap">
    <p class="recruit-tit">러셀CORE 전주 파이널 정규반<br><strong>입학 절차 안내</strong></p>
    ...
    <div class="step-txt-wrap">
        <div class="step-txt">
            <p class="step-tit">1) 온라인 원서접수 후 사전예약금 납부 <br> <a href="javascript:void(0)" onclick="alert('원서접수는 PC 페이지에서 이용 가능합니다.'); location.href='https://corejj.megastudy.net/russel/apply/yonhab/apply.asp?app_cd=175';" class="bt-gray-s ml10">온라인 원서접수</a></p>
        </div>
        <div class="step-txt">
    ...
    <!-- 모집요강 및 지원혜택 -->
    <p class="recruit-tit">러셀CORE 전주 파이널 정규반<br><strong>모집요강 및 지원혜택</strong></p>
    <div class="tbl-box">
        <!-- 모집요강 자동화 시스템 영역 -->
        <%

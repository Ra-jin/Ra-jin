<div class="teacher-rolling-inner">
    ...
    <link href="/css/t_list.css" rel="stylesheet" type="text/css">
    <style>
        .teacher-wrap .teacher-sub-list .info-box {height: 75px;}
    </style>
    <div class="teacher-wrap">
        <div class="teacher-sub-list swiper-container">
            <ul class="swiper-wrapper">
                ...
                <li class="swiper-slide">
                    ...
                    <p class="pic"><img  class="pt20" src="<%=Application("img_path_russel")%>/teacher/slide/math_piy.png" alt="" /></p>
                    <div class="ico-box">
                        <p><span>러셀<br>중계</span></p>
                    </div>
                </li>
                ...
                <li class="swiper-slide">
                    ...
                    <p class="pic"><img  class="pt20" src="<%=Application("img_path_russel")%>/teacher/slide/soc_cj.png" alt="" /></p>
                    <div class="ico-box">
                        <p><span>러셀<br>중계</span></p>
                        <p><span>러셀<br>대치</span></p>
                        <p class="i-blue"><span><strong>메가스터디</strong> 인강</span></p>
                ...
                <li class="swiper-slide">
                    ...
                    <p class="pic"><img  class="pt20" src="<%=Application("img_path_russel")%>/teacher/slide/sci_kmw.png" alt="" /></p>
                    <div class="ico-box">
                        <p><span>러셀<br>중계</span></p>
                        <p><span>러셀<br>대치</span></p>
                        <p><span>러셀<br>강남</span></p>
                ...
                <li class="swiper-slide">
                    ...
                    <p class="pic"><img  class="pt20" src="<%=Application("img_path_russel")%>/teacher/slide/sci_hmj.png" alt="" /></p>
                    <div class="ico-box">
                        <p><span>러셀<br>중계</span></p>
                        <p><span>러셀<br>강남</span></p>
                        <p class="i-blue"><span><strong> 메가스터디</strong>인강</span></p>
    ...
    <link href="/css/t_list.css" rel="stylesheet" type="text/css">
    <style>
        .teacher-wrap .teacher-sub-list .info-box {height: 50px;}
    </style>
    <div class="teacher-wrap">
        <div class="teacher-sub-list swiper-container">
            <ul class="swiper-wrapper">
    ...
    <div class="teacher-wrap">
        ...
        <!-- <p class="r-txt" style="padding: 0 5%;">
            ※ 강사 순서 기준은 가나다 순입니다.
        </p> -->
    </div>
    <% Else %>

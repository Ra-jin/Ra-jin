...
<head>
    ...
    <meta name="title" content="2025 파이널 종합반" />
    <meta name="keywords" content="2025 파이널 종합반, 파이널 종합반, 파이널 종합반, 러셀 파이널, 파이널, 러셀종합반, vkdlsjf" />
	<meta name="description" content="바른공부 자습전용관 2025 파이널 종합반" />
...
<h2 class="sub-tit">
    ...
    <strong class="tit">2025 파이널 종합반</strong>
</h2>
<section class="sub-wrap">
	<!-- final-wrap -->
    <div class="final-wrap">
		<!-- #include virtual = "/intro/2024/final_overall/visual.asp" -->
		...
		<div class="container <%=campusName%>">
            ...
            <div class="cont00 js-cont-wrap js-cont">
                <div class="inner">
                    <p class="recruit-tit">
                        <%=txtCampus%> 파이널 종합반<br><strong>모집안내</strong>
                    </p>
                    ...
                    <!-- 원서접수 버튼 -->
                    <% If campus_code <> "CD0249" and campus_code <> "CD0257" and campus_code <> "CD0340" Then '영통/중계/코어광주 %>
                    ...
                    <!--학원별 컨텐츠 -->
                    <%
                        dirFile = "/intro/2024/final_overall/"&campusName02&".asp"
		...
		<!-- tab01 -->
		<!-- #include virtual = "/intro/2024/final_overall/tab01.asp" -->
		<!-- //tab01 -->
        ...
        <div class="recruit-wrap js-cont-wrap intro">
            <div class="recruit-tit">
                2025 <strong>러셀 파이널 종합반</strong> <br> 모집안내
            </div>
        ...
        <% End If %>
        <p><a href="<%=pc_url%>intro/2024/final_overall/index.asp" target="_blank" class="bt-pc telBtm">PC페이지로 이동</a></p>
    </div>
	<!-- //final-wrap -->

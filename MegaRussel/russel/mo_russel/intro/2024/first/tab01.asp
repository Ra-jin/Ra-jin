...
<div class="cont js-cont-wrap <%=graph_con%>">
    <!-- cont01 or cont01-1 -->
    <% If campus_code = "INTRO" or campus_code = "CD0345" or campus_code = "CD0346" or campus_code = "CD0342" or campus_code = "CD0344" or campus_code = "CD0343" or campus_code = "CD0349" Then '인트로/코어창원/코어청주/대구/코어전주/코어원주/울산 %>
    <div class="cont01">
        <p><img src="<%=Application("img_path_russel")%>/m_russel/intro/2024/first/cont01_tit.jpg" alt="앞서 경험한 선배들이 증명합니다"></p>
        <div class="inner">
            <div class="graph-wrap">
                ...
                <ul>
                    <li>
                        <div><img src="<%=Application("img_path_russel")%>/m_russel/intro/2024/first/cont01_graph01.jpg" alt="HS반 유입률" /></div>
                        <span class="arrow01">
                            <p>
                                <img src="<%=Application("img_path_russel")%>/m_russel/intro/2024/first/ico_arrow01.png" alt="" />
                            </p>
                        </span>
                    </li>
                    <li>
                        <div><img src="<%=Application("img_path_russel")%>/m_russel/intro/2024/first/cont01_graph02.jpg" alt="서울대, 의치대반 유입률" /></div>
                        <span class="arrow01">
                            <p>
                                <img src="<%=Application("img_path_russel")%>/m_russel/intro/2024/first/ico_arrow01.png" alt="" />
                            </p>
            ...
            <div class="graph-wrap mt80 d-start">
                ...
                <ul>
                    ...
                    <li>
                        <div><img src="<%=Application("img_path_russel")%>/m_russel/intro/2024/first/cont01_graph04.jpg" alt="2022 vs 2023 수능 백분위 성적 향상 점수" /></div>
                        <span class="arrow02">
                            <p>
                                <img src="<%=Application("img_path_russel")%>/intro/2024/first/ico_arrow02.png" alt="" />
                            </p>
                        </span>
                    </li>
                </ul>
    ...
    <div class="cont01-1 <%=campusName%>">
        <h2><img src="<%=Application("img_path_russel")%>/m_russel/<%=campusName%>/2024/first/cont01-1_tit.jpg" alt="최상위권이 선택하고 만족하는 러셀, 매해 더 나은 입결과 후기가 입증하고 있습니다." /></h2>
        <div class="inner">
            <div class="result-box">
                <div class="info-stxt">
                    <span>데이터 산출 기준 <img src="<%=Application("img_path_russel")%>/intro/2024/first/ico_info.png" alt="i" /></span>
                    <div class="data-view">
                        러셀 강남학원 자습전용관 합격 결과 기준 <br> (18~23학년도, 단과수강생 제외, 복수대학 합격자 포함)
                    </div>
                </div>
                <p class="tit"><img src="<%=Application("img_path_russel")%>/m_russel/<%=campusName%>/2024/first/cont01-1_stit.png" alt="러셀 2023학년도 최상위권 입시 결과" /></p>
                <ul class="list-wrap">
                    <li>
                        <div>
                            <p>최근 5개년 연속<br>
                        ...
                        <ul class="stu-list">
                            <li>
                                <div><img src="<%=Application("img_path_russel")%>/m_russel/intro/2024/first/cont01-1_stu_lys.jpg" alt="이윤서" /></div>
                                <p>2023학년도 <br> <strong>이윤서 학생</strong></p>
                            </li>
                            <li>
                                <div><img src="<%=Application("img_path_russel")%>/m_russel/intro/2024/first/cont01-1_stu_w.jpg" alt="김OO" /></div>
                                <p>2023학년도 <br><strong>김OO 학생</strong></p>
                            </li>
                            <li>
                                <div><img src="<%=Application("img_path_russel")%>/m_russel/intro/2024/first/cont01-1_stu_w.jpg" alt="서OO" /></div>
                                <p>2022학년도 <br><strong>서OO 학생</strong></p>
                            </li>
                            <li>
                                <div><img src="<%=Application("img_path_russel")%>/m_russel/intro/2024/first/cont01-1_stu_m.jpg" alt="김OO" /></div>
                                <p>2021학년도 <br><strong>김OO 학생</strong></p>
                            </li>
                            <li>
                                <div><img src="<%=Application("img_path_russel")%>/m_russel/intro/2024/first/cont01-1_stu_yjh.jpg" alt="양지헌" /></div>
                                <p>2020학년도 <br><strong>양지헌 학생</strong></p>
                            </li>
                            <li>
                                <div><img src="<%=Application("img_path_russel")%>/m_russel/intro/2024/first/cont01-1_stu_w.jpg" alt="이OO" /></div>
    ...
    <div class="cont01-1 <%=campusName%>">
        ...
        <div class="inner">
            <div class="result-box">
                ...
                <span class="r-txt">*2023학년도 러셀 부천 바른공부 자습전용관 재원생 기준 (복수 대학 합격자 및 정시/수시 합격자 중복 포함, <br>
    ...
    <div class="cont01-1 <%=campusName%>">
        ...
        <div class="inner">
            <div class="result-box">
                ...
                <p><img src="<%=Application("img_path_russel")%>/m_russel/<%=campusName%>/2024/first/cont01-1_stit.png" alt="러셀 2023학년도 최상위권 입시 결과" /></p>
                <ul class="list-wrap">
                    <li>
                        <div>
    ...
    <div class="cont01-1 <%=campusName%>">
        ...
        <div class="inner">
            <div class="result-box">
                <p><img src="<%=Application("img_path_russel")%>/m_russel/<%=campusName%>/2024/first/cont01-1_stit.png" alt="대입성공을 위한 최선의 선택! 러셀 평촌 2023학년도 대입 합격 현황" /></p>
                <ul class="num-list gold">
                    <li>
                        <p>
                            서울대<br>
    ...
    <div class="cont01-1 <%=campusName%>">
        ...
        <div class="inner">
            <div class="result-box">
                ...
                <p class="r-txt">2023학년도 의치한수약+서연고 최종 합격자 수 기준 <br>(홈페이지 대입 실적 기준/2023.02.28 기준)</p>
            </div>
        </div>
    </div>
    ...
    <div class="cont01-1 <%=campusName%>">
        ...
        <div class="inner">
            <div class="result-box">
                <p><img src="<%=Application("img_path_russel")%>/m_russel/<%=campusName%>/2024/first/cont01-1_stit.png" alt="결과로 증명하는 러셀 목동 러셀 목동 2023학년도 대입 합격 현황" /></p>
                <ul class="num-list gold">
                    <li>
                        <p>
    ...
    <!-- cont02 -->
    <div class="cont02">
        <% If campus_code <> "INTRO" and campus_code <> "CD0345" and campus_code <> "CD0346" and campus_code <> "CD0342" and campus_code <> "CD0344" and campus_code <> "CD0343" and campus_code <> "CD0349" Then '인트로/코어창원/코어청주/대구/코어전주/코어원주/울산 제외 %>
        <h2><img src="<%=Application("img_path_russel")%>/m_russel/<%=campusName%>/2024/first/cont02_tit.jpg" alt="러셀 ㅇㅇ에서 한발 더 빠르게 시작한 선배들은 최상위권 대입성공을 쟁취하였습니다." /></h2>
        <% end if %>
        <div class="inner <%=campusName%>">
            <% If campus_code = "CD0247" Then '강남 %>
            <p class="r-txt">※ 백분위 성적 기준:국어, 수학, 탐구(2) 평균 점수 합계</p>
            <% ElseIf campus_code = "INTRO" or campus_code = "CD0345" or campus_code = "CD0346" or campus_code = "CD0342" or campus_code = "CD0344" or campus_code = "CD0343" or campus_code = "CD0349" Then '인트로/코어창원/코어청주/대구/코어전주/코어원주/울산 %>
            <h3>
                            ...
                            <div class="swiper-slide">
                                <div class="p-info">
                                    ...
                                    <div>
                                        ...
                                        <div><img src="<%=Application("img_path_russel")%>/m_russel/intro/2024/first/cont02_graph01.jpg" alt="" /></div>
                                    </div>
                                </div>
                                <div class="p-review">
                        ...
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="p-info">
                                    ...
                                    <div>
                                        <p><strong>28점</strong><span>향상</span></p>
                                        <div><img src="<%=Application("img_path_russel")%>/m_russel/intro/2024/first/cont02_graph01.jpg" alt="" /></div>
                                    </div>
                                </div>
                                <div class="p-review">
                            ...
                            <div class="swiper-slide">
                                <div class="p-info">
                                    ...
                                    <div>
                                        <p><strong>63점</strong><span>향상</span></p>
                                        <div><img src="<%=Application("img_path_russel")%>/m_russel/intro/2024/first/cont02_graph01.jpg" alt="" /></div>
                                    </div>
                                </div>
                                <div class="p-review">
                                    <p class="tit">“입시에 훤한 강사 선생님들께서도<br>
                                        &nbsp;&nbsp;커리큘럼을 1년 단위로 괜히 짜는 게 아니라고 생각하기&nbsp;&nbsp;때문에 일찍 시작하게 되었습니다.”
                                    </p>
                            ...
                            <div class="swiper-slide">
                                <div class="p-info">
                                    ...
                                    <div>
                                        <p><strong>37점</strong><span>향상</span></p>
                                        <div><img src="<%=Application("img_path_russel")%>/m_russel/intro/2024/first/cont02_graph01.jpg" alt="" /></div>
                                    </div>
                                </div>
                                <div class="p-review">
                                    <p class="tit">“작년 수능장에서의 기억을 가진 채로 학습계획을 세울 수                                
                            ...
                            <div class="swiper-slide">
                                <div class="p-info">
                                    ...
                                    <div>
                                        <p><strong>43.1점</strong><span>향상</span></p>
                                        <div><img src="<%=Application("img_path_russel")%>/m_russel/intro/2024/first/cont02_graph01.jpg" alt="" /></div>
                                    </div>
                                </div>
                                <div class="p-review">
                        ...
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="p-info">
                                    ...
                                    <div>
                                        <span><img src="<%=Application("img_path_russel")%>/m_russel/russel_bc/2024/first/cont02_stu_yhb.png" alt="양한빈" /></span>
                                        <a href="javascript:CastPopup('https://www.youtube.com/embed/xRROqKKYvB0?si=-kYLDtWgpprMu9MI');"><img src="<%=Application("img_path_russel")%>/m_russel/intro/2024/first/ico_play.png" alt="" /></a>
                                    </div>
                                </div>
                                <div class="p-review">
                            ...
                            <div class="swiper-slide">
                                <div class="p-info">
                                    ...
                                    <div>
                                        <span><img src="<%=Application("img_path_russel")%>/m_russel/russel_bc/2024/first/cont02_stu_kyh.png" alt="김연호" /></span>
                                        <a href="javascript:CastPopup('https://www.youtube.com/embed/qAjoPs7S6co?si=zJSNoO77bwo09CIu');"><img src="<%=Application("img_path_russel")%>/m_russel/intro/2024/first/ico_play.png" alt="" /></a>
                                    </div>
                                </div>
                                <div class="p-review">
                            ...
                            <div class="swiper-slide">
                                <div class="p-info">
                                    ...
                                    <div>
                                        <span><img src="<%=Application("img_path_russel")%>/m_russel/russel_bc/2024/first/cont02_stu_kdh.png" alt="김도현" /></span>
                                        <a href="javascript:CastPopup('https://www.youtube.com/embed/4bRycVxxQE0?si=yQTWIsmOPDH3vNbY');"><img src="<%=Application("img_path_russel")%>/m_russel/intro/2024/first/ico_play.png" alt="" /></a>
                                    </div>
                                </div>
                                <div class="p-review">
                            ...
                            <div class="swiper-slide">
                                <div class="p-info">
                                    ...
                                    <div>
                                        ...
                                        <a href="javascript:CastPopup('https://tv.naver.com/v/34827669');"><img src="<%=Application("img_path_russel")%>/m_russel/intro/2024/first/ico_play.png" alt="" /></a>
                                    </div>
                                </div>
                                <div class="p-review">
                            ...
                            <div class="swiper-slide">
                                <div class="p-info">
                                    ...
                                    <div>
                                        ...
                                        <a href="javascript:CastPopup('https://tv.naver.com/v/34827583');"><img src="<%=Application("img_path_russel")%>/m_russel/intro/2024/first/ico_play.png" alt="" /></a>
                                    </div>
                                </div>
                                <div class="p-review">
                        ...
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="p-info">
                                    ...
                                    <div>
                                        <span><img src="<%=Application("img_path_russel")%>/m_russel/russel_bd/2024/first/cont02_stu_ksb.png" alt="김상범" /></span>
                                        <a href="javascript:CastPopup('https://www.youtube.com/embed/FL_BLfo7BEQ?si=81ULl68H-Z-_5YT6');"><img src="<%=Application("img_path_russel")%>/m_russel/intro/2024/first/ico_play.png" alt="" /></a>
                                    </div>
                                </div>
                                <div class="p-review">
                                    <p class="tit">“분당에서 가장 높은 성적대의 학생들이 모여 있는 곳이라 선택하게 되었고, 면학분위기가 좋아서 선택하였습니다.”
                                    </p>
                                    <p class="txt">
                                        탁 트인 책상 구조 덕분에 옆 자리 친구가 바로 보이는 점이 좋았습니다.  같은 반 친구가 열심히 공부하는 모습이 보여, 집중력이 흐트러지거나 졸릴 때 옆 자리 친구를 보며 자극을 받을 수 있었습니다.
                                    </p>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="p-info">
                                    ...
                                    <div>
                                        <span><img src="<%=Application("img_path_russel")%>/m_russel/russel_bd/2024/first/cont02_stu_pye.png" alt="박예은" /></span>
                                        <a href="javascript:CastPopup('https://www.youtube.com/embed/uZVcUWYXhGY?si=QlGrysRv52KKWj1w');"><img src="<%=Application("img_path_russel")%>/m_russel/intro/2024/first/ico_play.png" alt="" /></a>
                                    </div>
                                </div>
                                <div class="p-review">
                                    <p class="tit">“한 두 달도 낭비할 수 없다는 생각에 1월에 등록했습니다. 그 결과 1~2월에 상대적으로 여유롭게 전 과목의 개념을 다시 한 번 훑을 수 있었습니다.”
                                    </p>
                                    <p class="txt">
                                        담임선생님이 1년 동안 저의 조언가 역할을 해주셔서 재수생으로서 홀로 선 느낌이 아니라 항상 누군가의 든든한 지원을 받는다는 생각이 들었습니다. 바자관 바로 옆에 계셔서 평소에도 언제든 담임선생님과 상담을 할 수 있어서 정말 좋았습니다.
                                    </p>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="p-info">
                                    ...
                                    <div>
                                        <span><img src="<%=Application("img_path_russel")%>/m_russel/russel_bd/2024/first/cont02_stu_man.png" alt="실루엣" /></span>
                                    </div>
                                </div>
                                <div class="p-review">
                                    <p class="tit">
                                        “러셀은 제가 듣고 싶은 과목만 들어도 되어서 참 좋았던 것 같습니다.”
                                    </p>
                                    <p class="txt">
                                        거의 모든 과목의 단과가 개설되어 있고, 같은 과목이라도 자신의 취향과 실력에 맞는 선생님을 본인이 골라서 들을 수 있다는 점이 좋습니다. 자신에게 최적화된 수업 플랜을 직접, 또는 도움을 받아서 짤 수 있다는 점이 좋았습니다.
                                    </p>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                ...
                                <div class="p-review">
                                    <p class="tit">
                                        “같은 건물에 바자관과 강의실이 함께 있었기 때문에 시간을 절약할 수 있어서 매우 좋다고 느꼈습니다.”
                                    </p>
                                    <p class="txt">
                                        주변 환경에 예민한 편이지만 불편함을 느끼지 못했습니다. 항상 환기에 신경써주셔서 쾌적한 공기가 마음에 들었고, 특히 시간표가 수능 시간에 맞춰져 있기 때문에 과목별 계획을 세울 때도 시간을 고려해 학습하기 좋았습니다.
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="p-info">
                                    ...
                                    <div>
                                        <div><img src="<%=Application("img_path_russel")%>/intro/2023/uni_logo/logo_hy.png" alt="한양대" /></div>
                                    </div>
                                </div>
                                <div class="p-review">
                                    <p class="txt">
                                        공부 공백기간이 길다 보면 다시 책상에 앉았을 때
                                        적응하기 힘들었을 텐데, 겨울부터 일찍 시작하여 수험생활에
                                        금방 적응할 수 있었습니다.
                                    </p>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                ...
                                <div class="p-review">
                                    <p class="txt">
                                        겨울부터 빠르게 시작하니 마음의 여유가 조금 생겼고, 
                                        부족한 과목에 시간을 많이 투자하여 학습량에서도
                                        더 많은 성과를 낼 수 있었습니다.                                         
                                    </p>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="p-info">
                                    <dl>
                                        <dt><div>2022</div>
                                            <p><strong>고려대학교 보건정책관리학부 </strong> 합격</p>
                                        </dt>
                                        <dd>러셀 중계 이신성</dd>
                                    </dl>
                                    <div>
                                ...
                                <div class="p-review">
                                    <p class="txt">
                                        계획을 세우고 수험생활을 다시 시작하다 보니
                                        많을 것들을 촉박하지 않게 계획에 넣을 수 있었고, 
                            ...
                            <div class="swiper-slide">
                                <div class="p-info">
                                    <dl>
                                        <dt><div>2022</div>
                                            <p><strong>서강대학교 경영학부  </strong> 합격</p>
                                        </dt>
                                        <dd>러셀 중계 김선아</dd>
                                    </dl>
                                    <div>
                                ...
                                <div class="p-review">
                                    <p class="txt">
                                        수능 이후, 오래 쉬다가 공부를 다시 시작하면 
                                        습관이 다 무너져 습관 잡기가 정말 힘들 것 같다고 생각했습니다.
                                        이 시간들을 잘 활용하면 많은 것을 할 수 있다고 생각하여 일찍 시작하게 되었습니다.                                          
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="swiper">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                ...
                                <div class="p-review">
                                    <p class="tit">“겨울부터 빠르게 개념부터 정리하며 <br>
                                        최대한 많은 양을 정확하게 공부했습니다.”
                                    </p>
                                    <p class="txt">주위의 자극을 받아 집중할 수 있는 개방형 구조가 마음에 들었습니다. 컨디션이 안 좋은 날에도 주위에 열심히 집중하는 친구들을 보면서 자극이 되었고, 흐트러지지 않으려 애쓸 수 있었습니다.                                       
                                    </p>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="p-info">
                                    ...
                                    <div>
                                        <p><strong>15%</strong><span>향상</span></p>
                            ...
                            <div class="swiper-slide">
                                <div class="p-info">
                                    ...
                                    <div>
                                        <!-- <p><strong>15%</strong><span>향상</span></p> -->
                                        <div class="before" style="width: 45px;left: 8px;">*검정고시</div>
                                        <div class="after">296.5점</div>
                                        <div><img src="<%=Application("img_path_russel")%>/m_russel/intro/2024/first/cont02_graph01.jpg" alt="" /></div>
                                    </div>
                                </div>
                                <div class="p-review">
                                    <p class="tit">“실전 훈련에만 집중할 수 있도록 <br>
                                        남들보다 먼저 시작했습니다.”
                                    </p>
                            ...
                            <div class="swiper-slide">
                                <div class="p-info">
                                    ...
                                    <div>
                                        <p><strong>53%</strong><span>향상</span></p>

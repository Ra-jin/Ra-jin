<div class="cont03 js-cont-wrap js-cont">
    <h3 data-aos="flip-up" class="aos-init aos-animate">
        ...
        <% Else %>
        <img src="<%=Application("img_path_russel")%>/m_russel/<%=campusName%>/2024/regular_go_overall/cont03_tit.jpg" alt="" />
        <% End If %>
    </h3>
    ...
    <div class="inner">
        <div class="contbox">
            <div class="tit">
                ...
                <img src="<%=Application("img_path_russel")%>/m_russel/<%=campusName%>/2024/regular_go_overall/cont03_sl_tit.jpg" alt="" />
                <% Else %>
                ...
                <div class="swiper-container studyHall-slide">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            ...
                            <% Else %>
                            <p class="img"><img src="<%=Application("img_path_russel")%>/m_russel/<%=campusName%>/2024/regular_go_overall/cont03_tab01_img.png" alt="" /></p>
                            <% End If %>                         
                        </div>
                        <div class="swiper-slide">
                            <!-- 학습동선 최소화 -->
                            ...
                            <% Else %>
                            <p class="img"><img src="<%=Application("img_path_russel")%>/m_russel/<%=campusName%>/2024/regular_go_overall/cont03_tab02_img.png" alt="" /></p>
                            <% End If %>
                        </div>
                        <div class="swiper-slide">
                            <!-- 충분한 자습시간 -->
                            ...
                            <% Else %>
                            <p class="img"><img src="<%=Application("img_path_russel")%>/m_russel/<%=campusName%>/2024/regular_go_overall/cont03_tab03_img.png" alt="" /></p>
                            <% End If %>
                        </div>
                    </div>
                </div>
...
<div class="cont05 js-cont">
    <% If campus_code = "CD0257" Then '중계 %>
    <h3 data-aos="flip-up" class="aos-init aos-animate"><img src="<%=Application("img_path_russel")%>/m_russel/<%=campusName%>/2024/regular_go_overall/cont05_tit.jpg" alt="" /></h3>
    <% Else %>
    ...
    <!-- 연간 일정 -->
    <!-- #include virtual = "/intro/2024/regular_go_overall/schedule.asp" -->
    <div class="inner">
        <div class="s-wrap">
...
<div class="cont06 js-cont">
    <h3 data-aos="flip-up" class="aos-init aos-animate">
        <% If campus_code = "CD0257" Then '중계 %>
        <img src="<%=Application("img_path_russel")%>/m_russel/<%=campusName%>/2024/regular_go_overall/cont06_tit.jpg" alt="" />
        <% Else %>
    ...
    <div class="contbox">
        <div class="inner">
            ...
            <div class="program-slide-navi swiper-container">
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide">THE PREMIUM<br>모의고사</div>
        ...
        <div class="program-slide swiper-container">
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide">
                    <img src="<%=Application("img_path_russel")%>/m_russel/intro/2024/regular_go/cont06_img02.png" alt="" />
                    <a href="/intro/2022/premium/index.asp" title="" style="position:absolute;right:8%;top:12%;width:27.6%;height:6.39%;z-index:2;"></a>
                </div>
                <div class="swiper-slide">
                ...
                <% Else %>
                <div class="swiper-slide">
                    <img src="<%=Application("img_path_russel")%>/m_russel/intro/2024/regular_go_overall/cont06_img01.png" alt="" />
                    <a href="/event/2021/quel/default.asp" title="" style="position:absolute;right:8%;top:9.47%;width:27.6%;height:6.39%;z-index:2;"></a>
                </div>
                <div class="swiper-slide">
                    <img src="<%=Application("img_path_russel")%>/m_russel/intro/2024/regular_go_overall/cont06_img02.png" alt="" />
                    <a href="/intro/2022/premium/index.asp" title="" style="position:absolute;right:8%;top:12%;width:27.6%;height:6.39%;z-index:2;"></a>
                </div>
                ...
                <% End If %>
                <div class="swiper-slide">
                    <img src="<%=Application("img_path_russel")%>/m_russel/intro/2024/regular_go_overall/cont06_img04.png" alt="" />
                    <a href="/intro/info/2022/monthly/index.asp" title="" style="position:absolute;right:8%;top:11%;width:27.6%;height:6.39%;z-index:2;"></a>
                </div>
                <% End If %>
            </div>
...
<div class="bt-banner">
    <% If campus_code = "CD0257" Then '중계 %>
    <p>재학생에 최적화된<br> <%=txtCampus%> 재학생 종합반에서<br><strong>여러분의 목표 대학 합격이 확실해집니다.</strong></p>
    <% ElseIf campus_code = "CD0247" or campus_code = "CD0244" Then '강남/분당 %>
    ...
    <% Else %>
    <p>재학생에 최적화된 <br><%=txtCampus%> 재학생 종합반에서<br><strong>여러분의 최상위권 대입성공이 확실해집니다.</strong></p>
    <% End If %>
</div>

...
Select Case GetCampusVarsSiteMGC("_CAMPUS_CODE_")	' method.asp 인클루드 안한 페이지에서 오류날 수 있지만, 안쓰는 페이지가 없을거라 가정
	...
	Case "CD0244": '분당
                   ...
                   tit_01 = "접수 기간"
                   txt_01 = "<b>전석 마감, 대기자 접수 中</b><br><span class='f11'>(*모집요강 지원자격 해당자 순 접수)</span>"
                   txt_02 = "<b>온라인 대기 접수 후 성적표 제출</b><br>* <span class='f11'>온라인 대기 접수를 완료하면 이후 대기 순서에 따라 입학 절차를 개별적으로 안내해드립니다.</span>"

...
<div class="container bg-01">
    <!-- 입학절차안내 -->
    <p class="recruit-tit">러셀 대치 재학생 정규반<br><strong>입학 등록 절차</strong></p>
    ...
    <div class="step-txt-wrap">
        <div class="step-txt">
            ...
            <div class="btn goto-btn text-align-center mb10">
                <%if curYmdhmin >= 202302100900 then%>
                <a href="https://russeldc.megastudy.net/russel/apply/yonhab/apply.asp?app_cd=152" onclick="alert('원서접수는 PC페이지에서 이용 가능합니다.')" target="_blank">대기자 원서접수 바로가기</a> 
                <%else%>
                <a href="javascript:void(0)" onclick="alert('원서 접수는 2/10(금) 오전 9시 이후 가능합니다.')">원서접수 바로가기</a>
                <%end if%>
            </div>
    ...
    <!-- 모집요강 -->
    <p class="recruit-tit">러셀 대치 재학생 정규반<br><strong>모집요강 및 장학혜택</strong></p>

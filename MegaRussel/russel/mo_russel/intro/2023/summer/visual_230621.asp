...
Select Case GetCampusVarsSiteMGC("_CAMPUS_CODE_")	' method.asp 인클루드 안한 페이지에서 오류날 수 있지만, 안쓰는 페이지가 없을거라 가정
    ...
    Case "CD0247": '강남
                   ...
                   campusName = "cont_gn"
                   tit_01 = "모집 현황"
                   txt_01 = "고3 마감 (대기 접수  중)<br><span class='color-red f14'>고2 접수 마감</span>"
                   tit_02 = "운영 기간"
                   txt_02 = "7/17(월) ~ 8/15(화)"
                   tit_03 = "접수 방법"
                   txt_03 = "온라인 원서접수<br><span class='f12'>*원서접수 확인 후 개별 안내 예정</span>"
                   tab_name = "russel"
    ...
    Case "CD0250": '부천
                   ...
                   tit_03 = "접수 방법"
                   txt_03 = "현재 사전 예약 중 (*선착순 마감)<br><br>① 현 재원생 : 사전예약금 납부<br> (3층 입학처 문의)<br>② 신규생 : 온라인 원서접수 후 사전예약금 납부(현장/유선)"
                   tab_name = "russel"

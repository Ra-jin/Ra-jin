...
<% ElseIf campus_code = "CD0349" Then '러셀울산 %>
    <!-- 강사진 -->
    <!-- #include virtual = "/inc/t_list/t_list_full_us_03.asp" -->
    <!-- //강사진 -->
...
<% Else %>
    <div class="swiper mySwiper teacher-rolling">
        ...
        <div class="swiper-wrapper">
            ...
            <div class="swiper-slide">
                <dl class="t-name">
                    <dt>통합과학/<br>생명과학 I(고1&middot;고2)</dt>
                    <dd><strong>유한승</strong> 선생님</dd>
                </dl>
                <span class="t-img"><img src="<%=Application("img_path_russel")%>/teacher/slide/sci_yhs02.png" alt=""></span>
            </div>
        ...
        <% ElseIf campus_code = "CD0244" Then '러셀분당 %>
        <div class="swiper-wrapper">
            <!-- 국어 -->
            <div class="swiper-slide">
                <dl class="t-name">
        ...
        <% ElseIf campus_code = "CD0257" Then '러셀중계 %>
        <div class="swiper-wrapper">
            <!-- 국어 -->
            <div class="swiper-slide">
                <dl class="t-name">
            ...
            <div class="swiper-slide">
                ...
                <span class="t-img"><img src="<%=Application("img_path_russel")%>/teacher/slide/ko_gms.png" alt=""></span>
            </div>
            <div class="swiper-slide">
                <dl class="t-name">
                    <dt>국어(내신)</dt>
            ...
            <div class="swiper-slide">
                ...
                <span class="t-img"><img src="<%=Application("img_path_russel")%>/teacher/slide/eng_lhj02.png" alt=""></span>
            </div>
            <div class="swiper-slide">
                <dl class="t-name">
                    <dt>영어(내신)</dt>
...
<% end If %>
    ...
    <p class="r-txt">* 2023년 기준 수능 강사진이며, 2024년 강사진은 추후 공개 예정입니다.</p>
    <% ElseIf campus_code = "CD0257" Then '중계 %>
    <p class="r-txt">※ 2023년 출강 강사진 기준<br>
        ※ 강사진 순서는 가나다 순입니다.
    </p>
    <% ElseIf campus_code = "CD0342" OR campus_code = "CD0349" Then '러셀대구/울산 %>
    <p class="r-txt mt20">* 강사진 순서는 가나다 순입니다.<br>
    * 출강 강사진은 학원 운영 정책 상 변경될 수 있습니다.

    </p>
    <% Else %>
    <p class="r-txt mt20">※ 학원 운영에 따라 출강 선생님은 변경될 수 있습니다.</p>
    <% end If %>
</div>
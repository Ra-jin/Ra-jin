<div class="cont campus-wrap md">
    <p class="recruit-tit"><%=caumpus_name%> N수 정규반<br><span>등록 안내</span></p>
    <ul class="setp-diagram">
        ...
        <li>
            ...
            <span>N수 정규반<br>결제 및 등록</span>
        </li>
    </ul>
    <div class="step-txt-wrap">
        <ul class="list-bullet">
            <li class="txt-red">N수 정규반 등록은 ‘현장’에서만 가능합니다.</li>

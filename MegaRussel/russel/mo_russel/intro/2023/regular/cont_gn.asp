<div class="cont campus-wrap gn">
    ...
    <div class="step-txt-wrap">
        <div class="step-txt">
            <p class="step-tit">1) 2024 N수 정규반 원서접수</p>
            <a href="https://russelgn.megastudy.net/russel/apply/jaejung/apply.asp?app_cd=148" class="bt-gray02 btn-regular">원서접수 바로가기</a>
            <ul class="list-bullet m0 f14">
                <li>원서접수자 중 모집요강 기준에 따라 순차적으로 입학 안내드립니다.</li>
            </ul>
        </div>
        <div class="step-txt">
            <p class="step-tit" style="display: inline-block;margin-right: 5px;">2) 성적표 제출</p><a href="http://pf.kakao.com/_hKnRb" class="apply-btn">성적표 제출하기</a>
            <ul class="list-bullet m0 f14">
        ...
        <div class="step-txt">
            ...
            <ul class="step-list">
                ...
                <li class="mt10"><a href="https://mrusselgn.megastudy.net/board/notice_view.asp?code=25371" class="apply-btn">시간표 보러가기</a></li>
            </ul>
            <ul class="list-bullet m0 f14">

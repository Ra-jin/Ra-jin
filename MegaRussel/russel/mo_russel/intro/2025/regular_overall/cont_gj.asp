...
<div class="recruit-wrap">
    <div class="inner">
        ...
        %>
        <!-- //모집요강 자동화 시스템 영역 -->
        <a onclick="alert('원서접수는 PC 페이지에서 이용 가능합니다.');location.href='https://coregj.megastudy.net/russel/apply/jaejung/apply.asp?app_cd=181'" class="btn-common">원서접수 바로가기</a>
        ...
        <div class="step-txt-wrap">
            <div class="step-txt">
                ...
                <ul class="list-dot m0 mt0">
                    ...
                    <li>
                        온라인 원서접수 <br>
                        <a onclick="alert('원서접수는 PC 페이지에서 이용 가능합니다.');location.href='https://coregj.megastudy.net/russel/apply/jaejung/apply.asp?app_cd=181'" class="bt-gray-s ml10">원서접수 바로가기</a>
                    </li>
                </ul>
            </div>
            <div class="step-txt">
        ...
        <!-- 모집요강 및 지원혜택 -->
        <p class="recruit-tit">입학 기준 및 지원혜택</p>

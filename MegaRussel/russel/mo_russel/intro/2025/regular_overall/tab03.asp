<div class="cont js-cont-wrap <%=campusName%>">
    <div class="cont11 js-cont">
        <p><img src="<%=Application("img_path_russel")%>/m_russel/<%=campusName%>/2025/regular_overall/cont11_tit.jpg" alt="러셀 ㅇㅇ에는 실전 수능에 완벽하게 대비할 수 있는 최상위권 맞춤 실전 콘텐츠가 있습니다."></p>
        <div class="inner">
    ...
    <div class="cont12 js-cont">
        <% If campus_code =  "CD0250" then '부천 %>
        <p><img src="<%=Application("img_path_russel")%>/m_russel/<%=campusName%>/2025/regular_overall/cont12_tit.jpg" alt=""></p>
        <% Else %>
        <p><img src="<%=Application("img_path_russel")%>/m_russel/intro/2025/regular_overall/cont12_tit.jpg" alt=""></p>
        <% End If %>
        <div class="inner">
            ...
            <div class="box">
                ...
                <div class="mock-slide swiper-container">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <p><img src="<%=Application("img_path_russel")%>/m_russel/<%=campusName%>/2025/regular_overall/mock_img01.jpg" alt=""></p>
                        </div>
                        <div class="swiper-slide">
                            <p><img src="<%=Application("img_path_russel")%>/m_russel/<%=campusName%>/2025/regular_overall/mock_img02.jpg" alt=""></p>
                        </div>
                    </div>

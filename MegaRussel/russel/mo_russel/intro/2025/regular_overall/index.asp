...
<head>
    ...
    <meta name="title" content="2026 N수 종합반">
    <meta name="keywords" content="2026 N수 종합반, N수 종합반, 러셀 2026 N수 종합반, 메가스터디 러셀 N수 종합반">
    <meta name="description" content="바른공부 자습전용관 2026 N수 종합반">
...
<h2 class="sub-tit">
    ...
    <strong class="tit">2026 국수영 종합반</strong>
    <% Else %>
    <strong class="tit">2026 재수종합반</strong>
    <% End if %>
</h2>
<section class="sub-wrap">
    ...
    <div class="regular-wrap">
		...
		<!-- tab01 -->
		<!-- #include virtual = "/intro/2025/regular_overall/tab01.asp" -->
		<!-- //tab01 -->

        <!-- tab02 -->
		<!-- #include virtual = "/intro/2025/regular_overall/tab02.asp" -->
		<!-- //tab02 -->

        <!-- tab03 -->
		<!-- #include virtual = "/intro/2025/regular_overall/tab03.asp" -->
		<!-- //tab03 -->

        <!-- 입학준비물 -->
        <!-- #include virtual = "/intro/2025/regular_overall/pop.asp" -->   
        <!-- //입학준비물 -->

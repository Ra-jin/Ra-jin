...
<div class="recruit-wrap">
    <div class="inner">
        ...
        <div class="step-txt-wrap">
            <div class="step-txt">
                <p class="step-tit" style="display:inline-block;margin-right: 5px;">1) 단과 수업 선택 및 결제
                </p>
            ...
            <div class="step-txt">
                ...
                <ul class="list-base m0 mt0">
                    ...
                    <li>- 성적표 제출 : <u>최종 등록 시, 학원 방문하여 <strong class="color-red"> 성적표 사본(출력물) 제출(필수)</strong></u>
                    </li>
                    <li>※ 제출 불가한 성적표 : (예) 꼬리표, 수기(오피스) 편집, 인적사항 확인 불가한 성적표
                    </li>
                </ul>
            </div>

        ...
        <div class="step-txt-wrap">
            <div class="step-txt">
                ...
                <ul class="list-dot m0 mt0">
                    ...
                    <li>
                        온라인 원서접수 <br>                       
                        <a onclick="alert('원서접수는 PC 페이지에서 이용 가능합니다.'); location.href='https://russelus.megastudy.net/russel/apply/jaejung/apply.asp?app_cd=187';" class="bt-gray-s ml10">원서접수 바로가기</a>
                    </li>
                </ul>
            </div>
            <div class="step-txt">
            ...
            <div class="step-txt">
                <p class="step-tit">4) 반수반 최종 등록 확인</p>
                <ul class="list-dot m0 mt0">
                    <li>등원일 확정</li>
                    <li>사전 오리엔테이션 진행</li>
                </ul>

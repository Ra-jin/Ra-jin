...
<div class="recruit-wrap">
    <div class="inner">
        ...
        <div class="step-txt-wrap">
            <div class="step-txt">
                <p class="step-tit" style="display:inline-block;margin-right: 5px;">1) 원서접수 <a onclick="alert('원서접수는 PC 페이지에서 이용 가능합니다.'); location.href='https://russelct.megastudy.net/russel/apply/jaejung/apply.asp?app_cd=180'" class="bt-gray-s ml10">원서접수 바로가기</a></p>
                <p class="f14" style="color:#626262;letter-spacing:-0.5px;">① 온라인 원서접수 ② 사전예약금 납부</p>
            ...
            <div class="step-txt">
                ...
                <p class="f14" style="color:#626262;letter-spacing:-0.5px;">2026 N수 정규반 등록 완료</p>
                <ul class="list-bullet m0 mt0">

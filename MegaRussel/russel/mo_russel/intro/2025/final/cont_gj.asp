        ...
        <div class="step-txt-wrap">
            <div class="step-txt">
                ...
                <ul class="list-bar m0 mt0">
                    <li>온라인 상담 <a class="bt-gray-s ml10" href="https://pf.kakao.com/_swxoCb">바로가기</a></li>
            ...
            <div class="step-txt">
                ...
                <a class="bt-gray-s" href="https://pf.kakao.com/_swxoCb">성적표 제출 바로가기</a>
            </div>
            ...
            <div class="step-txt">
                ...
                <a class="bt-gray-s" onclick="alert('추후 오픈 예정입니다.')">정규·특강 단과 바로가기 </a>
            </div>

...
<div class="recruit-wrap">
    <div class="inner">
        ...
        <div class="step-txt-wrap">
            <div class="step-txt">
                <p class="step-tit" style="display:inline-block;margin-right: 5px;">1) 온라인 사전 접수 <a onclick="alert('추후 오픈 예정입니다.')" href="javascript:void(0)" class="bt-gray-s">원서접수 바로가기</a></p>

...
<div class="recruit-wrap">
    <div class="inner">
        ...
        <a onclick="alert('원서접수는 PC 페이지에서 이용 가능합니다.');" href="https://russelus.megastudy.net/russel/apply/yonhab/apply.asp?app_cd=192" class="btn-link mt20">원서접수 바로가기</a>
        ...
        <div class="step-txt-wrap">
            <div class="step-txt">
                <p class="step-tit" style="display:inline-block;margin-right: 5px;">1) 입학상담/원서접수 <a  onclick="alert('원서접수는 PC 페이지에서 이용 가능합니다.');" href="https://russelus.megastudy.net/russel/apply/yonhab/apply.asp?app_cd=192" class="bt-gray-s">원서접수 바로가기</a></p>

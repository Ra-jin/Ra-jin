...
<div class="recruit-wrap">
    <div class="inner">
        ...
        <div class="step-txt-wrap">
            <div class="step-txt">
                <!-- <p class="step-tit mb0" style="display:inline-block;margin-right: 5px;">1) 온라인 원서접수 후 사전예약금 납부 <a onclick="alert('원서접수는 PC 페이지에서 이용 가능합니다.'); location.href='https://corewj.megastudy.net/russel/apply/yonhab/apply.asp?app_cd=184'" class="bt-gray-s ml10">원서접수 바로가기</a></p> -->
                <p class="step-tit mb0" style="display:inline-block;margin-right: 5px;">1) 온라인 원서접수 후 사전예약금 납부 <a href="javascript:alert(`추후 오픈 예정입니다.`);"  class="bt-gray-s ml10">원서접수 바로가기</a></p>
        ...
        <div class="tbl-box p0">
            <div class="txt-coming">
                ...
                <p>
                    2026 하반기 재학생 정규반<br>
                    <strong>모집 요강 및 장학 혜택</strong>은<br>
                    추후 공개 예정입니다.
                </p>
            </div>
        </div>

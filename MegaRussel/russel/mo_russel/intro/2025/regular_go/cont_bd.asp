    ...
    <div class="inner">
        ...
        <ul class="setp-diagram">
            ...
            <li>
                ...
                <span>정규반 <br>최종 등록</span>
            </li>
        </ul>
        <div class="step-txt-wrap">
            <div class="step-txt">
                <p class="step-tit" style="display:inline-block;margin-right: 5px;">1) 온라인 원서접수 (성적표 제출) <a href="javascript:alert(`원서접수는 PC 페이지에서 이용 가능합니다.`); window.open('https://russelbd.megastudy.net/russel/apply/yonhab/apply.asp?app_cd=184')" class="bt-gray-s ml10">원서접수 바로가기</a></p>
                <ul class="list-bar ml0 m0 mt0">
                    <li>접수 방법 : 온라인 원서접수 후 성적표 등록</li>
                </ul>
                <ul class="list-bullet ml0 m0 mt10">
            ...
            <div class="step-txt">
                ...
                <ul class="list-bullet ml0 m0 mt10">
                    <li>수업 신청(결제) 완료 후 바자관 및 학습 콘텐츠 결제를 안내 드립니다.
                    </li>
                    <li>최종 등록(입학)이 완료되면 등록 완료 안내문자가 발송됩니다.
                    </li>
                    <li>입학일 전, 등원 방법 등을 개별적으로 안내 드립니다.
                    </li>

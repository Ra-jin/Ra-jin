<div class="cont js-cont-wrap <%=campusName%>">
    <div class="cont07 js-cont">
        ...
        <p><img src="<%=Application("img_path_russel")%>/m_russel/<%=campusName%>/2025/regular_go/cont08_tit.jpg" alt=""></p>
        <% Else %>
        <p><img src="<%=Application("img_path_russel")%>/m_russel/intro/2025/regular_go/cont08_tit.jpg" alt=""></p>
        <% End If %>
        <!-- <p><img src="<%=Application("img_path_russel")%>/m_russel/intro/2025/regular_go/cont08_img.jpg" alt=""></p> -->
        <div class="inner">
    ...
    <div class="cont08">
        <% If campus_code = "CD0257" Then '중계 %>
        <p><img src="<%=Application("img_path_russel")%>/m_russel/<%=campusName%>/2025/regular_go/cont09_tit.jpg" alt="재학생 맞춤 실전 콘텐츠 과목별 시행 일정"></p>
        <% Else %>
        <p><img src="<%=Application("img_path_russel")%>/m_russel/intro/2025/regular_go/cont09_tit.jpg" alt="최상위권 맞춤 실전 콘텐츠 과목별 시행 일정"></p>
        <% End If %>
        <div class="inner">
    ...
    <div class="btm-banner">
        ...
        <%=v_txt_grade%>에 최적화된<br>
        러셀 강남 재학생 최상위권반에서<br>
        <strong>여러분의 최상위권 대입성공이<br>
        확실해집니다.</strong>

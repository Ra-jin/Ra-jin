        ...
        <table class="tbl-type01 tbl-center" style="width: 640px;">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>30분</td>
                    <td rowspan="3">
                        <span class="ico-txt v mb5">학교 수업</span><br>
                        <span class="ico-txt b mb5">선택자습</span><br>
                        <span class="ico-txt r"> 담임 상담</span>
                    </td>
                    <td rowspan="3">
                        <span class="ico-txt v mb5">단과 수업</span><br>
        ...
        <table class="tbl-type01 tbl-center" style="width: 640px;">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>50분</td>
                    <td><span class="ico-txt s">선택자습</span></td>
                    <td class="color-red">심야자습<br>없음</td>
                </tr>
            </tbody>
        </table>
    </div>
        ...
        <table class="tbl-type01 tbl-center" style="width: 730px;">
            ...
            <tbody>
                <tr>
                    ...
                    <td>AM 07:00~AM 07:50</td>
                    <td>50분</td>
                    <td rowspan="7"><span class="ico-txt p">학교 수업</span></td>
                    <td colspan="2">-</td>
                </tr>
                <tr>
                    <td class="sticky">1교시</td>

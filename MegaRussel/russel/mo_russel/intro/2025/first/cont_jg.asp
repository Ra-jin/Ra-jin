    ...
    <div class="inner">
        ...
        <div class="step-txt-wrap">
            <div class="step-txt">
                ...
                <!-- <p class="f14 mt10" style="color:#626262;letter-spacing:-0.5px;">※ 단과 수업은 12월부터 개설됩니다.<br>
                    - 11월 : 단과 수업 X<br>
                    - 12월 : 단과 수업 O</p> -->
            </div>
            <div class="step-txt">
                ...
                <ul class="list-bar m0 mt0">
                    ...
                    <li>성적표 제출 : <span class="f14 underline">최종 등록 시, 학원 방문하여 </span><strong class="txt-red f14 underline">성적표 사본(출력물) 제출(필수)</strong></li>
                </ul>

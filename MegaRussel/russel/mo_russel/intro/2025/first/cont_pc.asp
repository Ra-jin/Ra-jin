...
<div class="recruit-wrap">
    <!-- 장학혜택 -->
    <!-- <p class="recruit-tit">러셀 평촌 재수생 우선선발반<br><strong>장학혜택</strong></p>
    <div class="tbl-box">
        <table class="tbl-type01 tbl-center">
            <thead>
                <tr>
                    <th style="border-bottom:0">재수생 우선선발반 12월 얼리버드 등록 혜택</th>
                </tr>
            </thead>
        </table>
        <div class="tbl-scroll-x">
            <table class="tbl-type01 tbl-center" style="width:150%;border-top:1px solid #262626">
                <colgroup>
                    <col style="width:28%">
                ...
                <tbody>
                    <tr>
                        <th class="bg-wh">12월 재수생 우선선발반</th>
                        <td>15만원</td>
                        <td>-</td>
                    </tr>
                </tbody>

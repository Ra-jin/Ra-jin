...
<!--프로모션 영역-->
<!-- <div class="cont-pro">
    <p><img src="<%=Application("img_path_russel")%>/m_russel/russel_dg/2025/first/cont_pro_img.jpg" alt="러셀 대구 재수생 우선선발반 특별 프로그램"></p>
    <a href="https://mrusseldg.megastudy.net/common/russel_danka/russel_danka.asp?idx=1822"></a>
</div> -->
<!--//프로모션 영역-->

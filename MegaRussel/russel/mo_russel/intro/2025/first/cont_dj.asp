...
<div class="recruit-wrap">
    <div class="inner">
        ...
        <div class="step-txt-wrap">
            <div class="step-txt">
                <p class="step-tit mb0" style="display:inline-block;margin-right: 5px;">1) 온라인 원서 접수 후 사전예약금 납부
                    <a onclick="alert('원서접수는 PC 페이지에서 이용 가능합니다.')" href="https://coredj.megastudy.net/russel/apply/jaejung/apply.asp?app_cd=179" class="bt-gray-s ml10">원서접수  바로가기</a></p>
            </div>
            <div class="step-txt">

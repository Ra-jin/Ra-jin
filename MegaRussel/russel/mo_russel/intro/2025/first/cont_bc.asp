...
<div class="recruit-wrap">
    <div class="inner">
        <p class="recruit-tit">러셀 부천 이벤트 전형 개설 (24.12~25.02 등록 한정)
        </p>
        ...
        <div class="step-txt-wrap">
            ...
            <div class="step-txt">
                ...
                <ul class="m0 f14">
                    <li>①모집요강 확인</li>
                    <li>② 단과 수업 선택 및 등록<br>(현장 또는 온라인 결제)</li>
                    <li>③ 성적표 제출 및 <br>
                        바른공부 자습전용관 등록 (현장 등록)</li>
                </ul>
            </div>
...
<div class="recruit-wrap type02">
    <div class="inner">
        ...
        <div class="tbl-box">
            <!-- <div class="tab-wrap">
                <a href="javascript:void(0);" class="on">12월<strong></strong></a>
                <a href="javascript:void(0);">1월<strong></strong></a>
            </div> -->
            <!-- 모집요강 자동화 시스템 영역 -->
            <%
        ...
        <!-- 러셀 부천 재수생 우선선발반 커리큘럼 -->
        <!-- <p class="recruit-tit">러셀 부천 재수생 우선선발반<br><strong>12월 커리큘럼</strong></p>
        <div class="tbl-box">

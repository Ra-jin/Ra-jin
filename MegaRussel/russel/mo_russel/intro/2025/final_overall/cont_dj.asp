...
<div class="recruit-wrap">
    <div class="inner">
        ...
        <div class="event-area">
            <p class="recruit-tit pt0"><strong>파이널 종합반 프로모션</strong></p>
            <div><img src="<%=Application("img_path_russel")%>/m_russel/core_dj/2025/final_overall/banner_promotion.jpg" alt="" /></div>
        </div>
        ...
        <div class="step-txt-wrap">
            ...
            <div class="step-txt">
                <p class="step-tit">5) 파이널 종합반 최종 등록 확인</p>
                <ul class="list-dot m0 mt0">

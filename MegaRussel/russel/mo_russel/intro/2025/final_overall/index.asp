...
<head>
    ...
    <meta name="title" content="2026 파이널 종합반" />
    <!-- #include virtual = "/intro/2025/final_overall/meta_seo.asp" -->
...
<h2 class="sub-tit">
    ...
    <strong class="tit">2026 파이널 종합반</strong>
</h2>
<section class="sub-wrap">
    ...
    <div class="final-wrap">
		<!--visual-->
		<!-- #include virtual = "/intro/2025/final_overall/visual.asp" -->
		<!--//visual-->
		...
		<div class="container <%=campusName%>">
            ...
            <div class="cont00 js-cont-wrap js-cont">
                ...
                <%
                    ...
                    dirFile = "/intro/2025/final_overall/"&campusName02&".asp"
		...
		<!-- tab01_winter -->
		<!-- #include virtual = "/intro/2025/final_overall/tab01.asp" -->
		<!-- //tab01 -->

        <!-- tab02 -->
		<!-- #include virtual = "/intro/2025/final_overall/tab02.asp" -->
		<!-- //tab02 -->

        <div class="mask-bg" style="display: none;"></div>

        <p><a href="tel:<%=tel%>" class="bt-tel"><span>문의전화 <%=tel%></span></a></p>
        <p><a href="<%=pc_url%>intro/2025/final_overall/index.asp" target="_blank" class="bt-pc telBtm">PC페이지로 이동</a></p>
    </div>
	<!--//regular-wrap -->
</section>

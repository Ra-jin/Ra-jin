    ...
    <div class="inner">
        ...
        <table class="tbl-plan-new typeA">
            ...
            <tbody>
                ...
                <tr>
                    <th><span>현재 모집 중</span><br>7~8월</th>
                    <td>썸머스쿨 <br>
                        <a onclick="alert('원서접수는 PC 페이지에서 이용 가능합니다.'); location.href='https://russelgn.megastudy.net/russel/apply/yonhab/apply.asp?app_cd=189'">원서접수 바로가기</a>
                    </td>
                </tr>
                <tr>
                    <th>9~11월</th>
        ...
        <div class="step-txt-wrap">
            <div class="step-txt">
                <p class="step-tit" style="display:inline-block;margin-right: 5px;">1) 원서 접수
                    <a class="bt-gray-s ml10" onclick="alert('원서접수는 PC 페이지에서 이용 가능합니다.'); location.href='https://russelgn.megastudy.net/russel/apply/yonhab/apply.asp?app_cd=189'">원서접수 바로가기</a>
                </p>
            ...
            <div class="step-txt">
                ...
                <ul class="list-bullet m0 mt0">
                    <li>반별 필수 수강 시수에 맞춰 수강 희망하는 강의를 등록합니다.</li>
                </ul>
            </div>

        ...
        <div class="step-txt-wrap">
            ...
            <div class="step-txt">
                ...
                <ul class="list-bar m0 mt0">
                    <li>성적표 제출 후 반편성이 완료되면, 강의 필수 수강 조건에 해당하는 경우에 강의를 등록합니다. (필수 수강 시수 미충족 시 입학 불가)</li>
                </ul>
                <p class="f14" style="color:#626262;letter-spacing:-0.5px;">※ 성적표 미 제출 시 그린 전형으로 배정됩니다.</p>
            </div>

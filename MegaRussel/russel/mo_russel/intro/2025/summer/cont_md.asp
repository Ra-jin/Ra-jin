...
<div class="event-area">
    <div><img src="<%=Application("img_path_russel")%>/m_russel/russel_md/2025/summer/banner_promotion.jpg" alt="" /></div>
</div>
    ...
    <div class="inner">
        ...
        <ul class="setp-diagram">
            <li>
                ...
                <span>온라인 원서 접수<br>및 성적표 제출</span>
            </li>
            <li>
                <div><strong>2</strong></div>
                <span>강의 선택 <br> 및 학원 방문 실등록 <br>(6월 예정)</span>
            </li>
        </ul>
        <div class="step-txt-wrap">
            <div class="step-txt">
                <p class="step-tit" style="display:inline-block;margin-right: 5px;">1) 온라인 원서 접수 및 성적표 제출</p>
                <ul class="list-bar m0 mt0">
                    <li>반드시 학생 ID로 로그인 하신 후 온라인 원서 접수 진행 바랍니다.</li>
                    <li class="color-red">온라인 원서 접수 시, 성적표 사진 파일 등록은 필수입니다. </li>
                    <li class="color-red">성적표 재제출로 인한 전형 변경은 썸머스쿨 개강일 전까지만 가능합니다. (썸머스쿨 시작일 이후 변경 불가능)</li>
            ...
            <div class="step-txt">
                <p class="step-tit">2) 강의 선택 및 학원 방문 실등록 <br> <span class="color-red f14 fw500">[전형에 따라 모집 인원은 상이할 수 있습니다.]</span></p>
                <ul class="list-bar m0 mt0">
                    <li>썸머스쿨 실등록은 <span class="color-red f14">‘현장’</span>에서만 가능합니다.</li>
                    <li class="color-red">원서 접수를 완료한 학생, 학부모 대상으로 순차적으로 유선 연락 또는 문자를 통해 입학 절차 안내가 이뤄집니다.</li>
                    <li class="color-red">온라인 전형 접수 우선 등록을 하였더라도 전형별 인원에 따라 등록이 불가할 수 있습니다.</li>
            ...
            <div class="step-txt">
                ...
                <ul class="list-bar m0 mt0">
                    <li>자습은 2관에서 진행됩니다.</li>
                    <li class="color-red">2학기부터는 [재학생 정규반] 지원 정책으로 변경 적용됩니다. [의무 시수 0T]</li>

...
<div class="layer-tt">
    ...
    <p class="bt-close-tt"><img src="<%=Application("img_path_russel")%>/m_russel/btn/btn_close_b.png" alt=""></p>
</div>
...
<div class="layer-tt">
    ...
    <ul class="list-star f11">
        <li>평일 오전 영어 프로그램은 영단어&amp;듣기TEST로 진행되며 학원별 운영은 상이할 수 있습니다.
        </li>
        <li>학원별 운영 시간표는 상이하므로 학원별 페이지를 확인하시기 바랍니다.</li>
    </ul>
    <p class="bt-close-tt"><img src="<%=Application("img_path_russel")%>/m_russel/btn/btn_close_b.png" alt=""></p>
...
<div class="layer-tt">
    ...
    <ul class="list-star f11">
        <li>학원 사정 상, 운영시간은 변경될 수 있습니다.</li>
    </ul>
        ...
        <table class="tbl-type01 tbl-center" style="width: 640px;">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>70분</td>
                    <td colspan="2" rowspan="3"><span class="ico-txt b">의무자습</span></td>
                    <td rowspan="3"><span class="ico-txt s">선택자습</span></td>
                </tr>
                <tr>
                    <td class="sticky">5교시</td>
                ...
                <tr>
                    ...
                    <td>100분</td>
                    <td colspan="2" rowspan="2"><span class="ico-txt b">의무자습</span></td>
                    <td rowspan="2"><span class="ico-txt s">선택자습</span></td>
                </tr>
                <tr>
                    <td class="sticky">8교시</td>
        ...
        <table class="tbl-type01 tbl-center" style="width: 640px;">
            ...
            <tbody>
                <tr>
                    ...
                    <td>30분</td>
                    <td>
                        <span class="ico-txt p">영단어 TEST</span>
                    </td>
                    <td>
                ...
                <tr>
                    ...
                    <td colspan="2" rowspan="2">
                        <span class="ico-txt b mb5">정규자습</span><br>
                        <span class="ico-txt r mb5">담임상담</span><br>
                ...
                <tr>
                    ...
                    <td colspan="2" rowspan="3">
                        <span class="ico-txt p mb5">영어듣기</span><br>
                        <span class="ico-txt b mb5">정규자습</span><br>
                        <span class="ico-txt r mb5">담임상담</span><br>
                ...
                <tr>
                    ...
                    <td>22:20~23:00</td>
                    <td>40분</td>
                    <td colspan="2" rowspan="2"><span class="ico-txt s">심야 선택자습</span></td>
...
<div class="layer-tt">
    ...
    <ul class="list-star f11">
        <li>학원별 운영 시간표는 상이하므로 학원별 페이지를 확인하시기 바랍니다.
        </li>
    </ul>
    <p class="bt-close-tt"><img src="<%=Application("img_path_russel")%>/m_russel/btn/btn_close_b.png" alt=""></p>
</div>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td rowspan="3">
                        ...
                        <span class="ico-txt v ml5">단과<br>수업</span>
                        <span class="ico-txt r ml5" style="padding:2px 7px;">상<br>담</span>
                        <span class="ico-txt p ml5">영어<br>
                        프로그램</span>
                    </td>
                    <td rowspan="3">
                        <span class="ico-txt b ml5">의무<br>자습</span>

...
<head>
	...
	<link rel="stylesheet" type="text/css" href="/css/fns.css" media="all" />
	...
	<section class="sub">
		<div class="inBox">
			...
			<div class="agree-wrap">				
				<ul>
					<li class="agree-tit"><label for="check_1"><input type="checkbox" name="선택" id="check_1">상품이용 및 환불규정 안내 <span>(필수)</span></label>
						<ul class="agree-pre">
							<li class="agree-info">
								<ul>
					...
					<li class="agree-tit"><label><input type="checkbox" name="" id="check_2">개인정보처리 및 이용동의 <span>(필수)</span></label>
						<ul class="agree-pre">
							<li class="agree-info">
								<ul>
					...
					<li class="agree-tit"><label><input type="checkbox" name="" id="check_3">개인정보의  제3자 위탁 제공 동의 <span>(필수)</span></label>	
						<ul class="agree-pre">
							<li class="agree-info">
								<ul>
			...
			$(function(){
				$('.agree-wrap .agree-tit').on('click', function(){
					var $root = $(this);
					$('.agree-wrap .agree-tit').removeClass("on");
					$root.addClass('on');
				  });
			});

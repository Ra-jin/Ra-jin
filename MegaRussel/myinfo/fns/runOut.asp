...
<div class="wrap">
	<header class="sub">
        <a href="/index.asp" class="btnPrev">소진현황</a>
		...
		<div class="inBox">
			<div class="tabCommon">
				<ul class="tabList no-2">
					...
					<li class="on"><a href="runOut.asp">소진현황</a></li>
					<li class="last"><a href="refund_list.asp">환불현황</a></li>
				</ul>
				<div class="tabCon">
					<div class="tabConList on">
						<h2 class="blind">소진 현황</h2>
						<div class="title-wrap">
							<h3 class="title">소진 현황</h3>
							<p class="pos-r table-bottom-text">※ 소진내역은 최대 6개월까지만 제공됩니다.</p>
						</div>
						<div class="tb-type2">
							<table summary="">
								<caption></caption>

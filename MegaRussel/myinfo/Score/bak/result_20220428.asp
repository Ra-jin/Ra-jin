			...
			<div class="tabCommon">
				...
				<div class="tabCon">
					<div class="tabConList">
						...
						<div class="tb-type2 score-result">
                                    ...
                                    If RS.EOF <> True Then
                                        DO WHILE NOT RS.EOF %>
                                            <tr>
                                                ...
                                                <td><a href="#none" onclick="javascript:fnc_pop('<%= RS("TM_TRY_CD") %>');return false;" class="btnType-b-l">상세보기</a></td>
                                            </tr>
...
<script>
	...
	function fnc_pop(try_cd){
		window.open("popResult.asp?try_cd="+try_cd,"","width=1020, height=768, resizable=no, scrollbars=yes, status=no, left=50px, top=100px");
	}
</script>
</body>
</html>

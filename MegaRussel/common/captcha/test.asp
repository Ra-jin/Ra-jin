		...
		<form name="form1" id="form1" method="post">
			...
			if Request.ServerVariables("REQUEST_METHOD") = "POST" and IsEmpty(Request.Form("btnRetry")) then
				...
				if IsEmpty(Session("ASPCAPTCHA")) or Trim(Session("ASPCAPTCHA")) = "" then
					lblResult = "This session has expired."
					lblColor = "red"
				else
			...
			%>
				<p>
					<span style="color: <%=lblColor%>; font-weight: bold;"><%=lblResult%></span>
				</p>
			...
			%>
				...
				<a href="javascript:void(0);" onclick="RefreshImage('imgCaptcha');">Get a new challenge</a>
				<br />

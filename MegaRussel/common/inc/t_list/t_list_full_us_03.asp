...
<style>
    .teacher-wrap.fullPage .teacher-sub-list li {height:440px !important;}
</style>
    ...
    <div class="teacher-sub-list swiper-container">
        <ul class="swiper-wrapper">
            ...
            <li class="swiper-slide t-lsj">
                ...
                <div class="ico-box">
                    <p class="none"><span>러셀<br>울산</span></p>
                    <p><span>러셀<br>강남</span></p>
                </div>
            </li>              
            <li class="swiper-slide">
            ...
            <li class="swiper-slide">
                ...
                <p class="pic"><img src="<%=Application("img_path_russel")%>/teacher/slide/math_cjh02.png" alt="" /></p>
                <div class="ico-box">
                    <p><span>러셀<br>울산</span></p>
                </div>
            </li>
            ...
            <li class="swiper-slide">
                ...
                <p class="pic"><img src="<%=Application("img_path_russel")%>/teacher/slide/eng_lhj02.png" alt="" /></p>
                <div class="ico-box">
                    <p><span>러셀<br>울산</span></p>
                </div>
            </li>  
            ...
            <li class="swiper-slide t-ldj">
                <div class="info-box">
                    <span class="cate live">대치동 LIVE 단과</span>
                    <span class="t-sub">동사/세사/한국사/통사</span>
            ...
            <li class="swiper-slide t-ljs">
                ...
                <div class="ico-box">
                    <p><span>러셀<br>울산</span></p>
                    <p class="none"><span>러셀<br>평촌</span></p>
                </div>
            </li>
            <!-- //과탐 -->
...
<script>
    ...
    $(function() {
        ...
        //재수생우선선발반
        if(path_name.indexOf("/first/") > -1){
            //이다지t 과목변경
            $(".t-ldj .t-sub").text('동아시아사/세계사/한국사')



        }else if(path_name.indexOf("/winter/") > -1){
            //이다지t 과목변경
            $(".t-ldj .t-sub").text('동사/세사/한국사')

            //이승주t 이지선t 딱지 제거
            $(".t-lsj .ico-box .none").css('display', 'none')
            $(".t-ljs .ico-box .none").css('display', 'none')

            //이지선t 현장단과로 딱지 변경
            $(".t-ljs .cate").removeClass('live');
            $(".t-ljs .cate").text('현장 단과')


        }else if(path_name.indexOf("/regular/") > -1){
            //이다지t 과목변경
            $(".t-ldj .t-sub").text('동사/세사/한국사')
        }

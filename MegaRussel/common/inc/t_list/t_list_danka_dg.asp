<!-- 대구 : 정규 단과 고3,고2 -->
<link href="/common/css/t_list.css" rel="stylesheet" type="text/css">
<div class="teacher-wrap">
    <!-- tab-subject -->
    <div class="tab-subject">
        <a href="" class="on">국어</a>
        <a href="">수학</a>
        <a href="">영어</a>
        <a href="">사탐</a>
        <a href="">과탐</a>
    ...
    <div class="list-wrap on">
        <div class="teacher-sub-list swiper-container">
            <ul class="swiper-wrapper">
                <li class="swiper-slide">
                    <div class="info-box">
                        ...
                        <span class="t-explain">메가스터디 인강 1위</span>
                    </div>
                ...
                <li class="swiper-slide">
                    <div class="info-box">
                        <p class="cate"><span>현장 단과</span></p>
                        <span class="t-sub">국어</span>
                        <p class="t-info"><span><strong>구성은</strong> 선생님</span></p>
                        <p class="t-explain"><span>서강대학교 교육대학원<br>국어교육 석사</span></p>
                    </div>
                ...
                <li class="swiper-slide">
                    <div class="info-box">
                        <p class="cate"><span>현장 단과</span></p>
                        <span class="t-sub">국어</span>
                        <p class="t-info"><span><strong>김강민</strong> 선생님</span></p>
                        <p class="t-explain"><span>한양대학교<br>국어교육학과 졸업</span></p>
                    </div>
                ...
                <li class="swiper-slide">
                    <div class="info-box">
                        <p class="cate"><span>현장 단과</span></p>
                        <span class="t-sub">국어</span>
                        <p class="t-info"><span><strong>박수빈</strong> 선생님</span></p>
                        <p class="t-explain"><span>중상위권 맞춤 수업</span></p>
                    </div>
                ...
                <li class="swiper-slide">
                    <div class="info-box">
                        ...
                        <span class="t-explain">메가스터디 인강</span>
                    </div>
            ...
            <!-- Add Arrows -->
            <div class="swiper-button-prev"><img src="<%=Application("img_path_russel")%>/teacher/slide/t_slide_prev.png" alt="" /></div>
            <div class="swiper-button-next"><img src="<%=Application("img_path_russel")%>/teacher/slide/t_slide_next.png" alt="" /></div>
        </div>
    </div>
    <!-- //국어 -->
            ...
            <ul class="swiper-wrapper">
                ...
                <li class="swiper-slide">
                    <div class="info-box">
                        ...
                        <span class="t-explain">포항 공대 졸업</span>
                    </div>
                ...
                <li class="swiper-slide">
                    <div class="info-box">
                        ...
                        <span class="t-explain">성균관대학교 대학원<br>수학교육 졸업</span>
                    </div>
            ...
            <ul class="swiper-wrapper">             
                ...
                <!-- <li class="swiper-slide">
                    <div class="info-box">
                        ...
                        <span class="t-info"><strong>손고운</strong> 선생님</span>
                        <span class="t-explain">메가스터디 인강</span>
                    </div>
                    <p class="pic"><img src="<%=Application("img_path_russel")%>/teacher/slide/soc_skw.png" alt="" /></p>
                    <div class="ico-box">
                        <p><span>러셀<br>대치</span></p>
                        <p><span>러셀<br>분당</span></p>
                        <p class="i-blue"><span><strong>메가스터디</strong> 인강</span></p>
...
<script>   
    ...
    $(function(){
        ...
        var $bt_t    = $('.tab-subject a');
        var $cont_t  = $('.teacher-wrap .list-wrap');

        $bt_t.on('click',function(e){
            e.preventDefault();
            var idx = $(this).index()

            $(this).addClass('on').siblings().removeClass('on')
            $cont_t.eq(idx).addClass('on').siblings().removeClass('on')
        })
    ...
    function tDankSlide(){
        ...
        $(".teacher-sub-list").each(function(index){
            var $this = $(this);
            var t_Slide = $this.addClass("js-t-slide-" + parseInt(index+1));
            var $slide = t_Slide.children().find('.swiper-slide');            

	        if($slide.length >= 4){
                var tSwiper = new Swiper(t_Slide ,{
                    autoplay: {
                        delay: 6000,
                ...
                t_Slide.children('.swiper-button-prev, .swiper-button-next').css('display','none')
            }            
        });
    }
</script>
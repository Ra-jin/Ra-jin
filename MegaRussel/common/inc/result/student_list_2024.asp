    ...
    <div class="student-result-swiper swiper-container">
        <div class="swiper-wrapper">
            <div class="swiper-slide">
                ...
                <img src="<%=Application("img_path_russel")%>/common/inc/result/st_kmg.png" alt="">
            </div>
            <div class="swiper-slide">
                <strong class="info-n">성종현</strong>
                <span class="info-c">2024 러셀 분당 재원생</span>
                <span class="info-u">서울대 의예과</span>
                <img src="<%=Application("img_path_russel")%>/common/inc/result/st_sjh.png" alt="">
            </div>
            <div class="swiper-slide">
                <strong class="info-n">임OO</strong>
                <span class="info-c">2024 러셀CORE 광주 재원생</span>
                <span class="info-u">서울대 의예과</span>
                <img src="<%=Application("img_path_russel")%>/common/inc/result/st_shadow.png" alt="">
            </div>
            <div class="swiper-slide">
            ...
            <div class="swiper-slide">
                ...
                <span class="info-u">서울대 의예과</span>
                <img src="<%=Application("img_path_russel")%>/common/inc/result/st_nhj.png" alt="">
            </div>
            <div class="swiper-slide">
                <strong class="info-n">이상후</strong>
                <span class="info-c">2023 러셀CORE 대전 재원생</span>
                <span class="info-u">서울대 의예과</span>
                <img src="<%=Application("img_path_russel")%>/common/inc/result/st_lsh.png" alt="">
            </div>
            <div class="swiper-slide">
                <strong class="info-n">이윤서</strong>
                <span class="info-c">2023 러셀 강남 재원생</span>
                <span class="info-u">서울대 의예과</span>
                <img src="<%=Application("img_path_russel")%>/common/inc/result/st_lys.png" alt="">
            </div>
            <div class="swiper-slide">
                <strong class="info-n">이정우</strong>
                <span class="info-c">2023 러셀 영통 재원생</span>
                <span class="info-u">서울대 의예과</span>
                <img src="<%=Application("img_path_russel")%>/common/inc/result/st_ljw.png" alt="">
            </div>
            <div class="swiper-slide">
                <strong class="info-n">이주연</strong>
                <span class="info-c">2023 러셀 분당 재원생</span>
                <span class="info-u">서울대 의예과</span>
                <img src="<%=Application("img_path_russel")%>/common/inc/result/st_ljy.png" alt="">
            </div>
            <div class="swiper-slide">
                <strong class="info-n">홍석우</strong>
                <span class="info-c">2023 러셀 대치 재원생</span>
                <span class="info-u">서울대 의예과</span>
                <img src="<%=Application("img_path_russel")%>/common/inc/result/st_hsw.png" alt="">
            </div>
            <div class="swiper-slide">
                <strong class="info-n">김OO</strong>
                <span class="info-c">2023 러셀 대치 재원생</span>
            ...
            <div class="swiper-slide">
                ...
                <span class="info-u">서울대 의예과</span>
                <img src="<%=Application("img_path_russel")%>/common/inc/result/st_ksy.png" alt="">
            </div>
            <div class="swiper-slide">
                <strong class="info-n">김이지</strong>
                <span class="info-c">2022 러셀 대치 재원생</span>
                <span class="info-u">서울대 의예과</span>
                <img src="<%=Application("img_path_russel")%>/common/inc/result/st_kej.png" alt="">
            </div>
            <div class="swiper-slide">
                <strong class="info-n">주현빈</strong>
                <span class="info-c">2022 러셀 대치 재원생</span>
                <span class="info-u">서울대 의예과</span>
                <img src="<%=Application("img_path_russel")%>/common/inc/result/st_jhb.png" alt="">
            </div>
            <div class="swiper-slide">
                <strong class="info-n">한다연</strong>
                <span class="info-c">2022 러셀 대치 재원생</span>
                <span class="info-u">서울대 의예과</span>
                <img src="<%=Application("img_path_russel")%>/common/inc/result/st_hdy.png" alt="">
            </div>
            <div class="swiper-slide">
                <strong class="info-n">박OO</strong>
                <span class="info-c">2022 러셀 대치 재원생</span>
            ...
            <div class="swiper-slide">
                ...
                <img src="<%=Application("img_path_russel")%>/common/inc/result/st_sjw.png" alt="">
            </div>
            <div class="swiper-slide">
                <strong class="info-n">염우진</strong>
                <span class="info-c">2021 러셀 분당 재원생</span>
                <span class="info-u">서울대학교 의예과</span>
                <img src="<%=Application("img_path_russel")%>/common/inc/result/st_ywj.png" alt="">
            </div>
            <div class="swiper-slide">
                <strong class="info-n">유서환</strong>
                <span class="info-c">2021 러셀 평촌 재원생</span>
                <span class="info-u">서울대학교 의예과</span>
                <img src="<%=Application("img_path_russel")%>/common/inc/result/st_ysh.png" alt="">
            </div>
            <div class="swiper-slide">
                <strong class="info-n">조성재</strong>
                <span class="info-c">2021 러셀 목동 재원생</span>
                <span class="info-u">서울대학교 의예과</span>
                <img src="<%=Application("img_path_russel")%>/common/inc/result/st_jsj.png" alt="">
            </div>
            <div class="swiper-slide">
                <strong class="info-n">조형준</strong>
                <span class="info-c">2021 러셀 센텀 재원생</span>
                <span class="info-u">서울대학교 의예과</span>
                <img src="<%=Application("img_path_russel")%>/common/inc/result/st_jhj.png" alt="">
            </div>
            <div class="swiper-slide">
                <strong class="info-n">최재원</strong>
                <span class="info-c">2021 러셀 센텀 재원생</span>
                <span class="info-u">서울대학교 의예과</span>
                <img src="<%=Application("img_path_russel")%>/common/inc/result/st_cjw.png" alt="">
            </div>
            <div class="swiper-slide">
                <strong class="info-n">김OO</strong>
            ...
            <div class="swiper-slide bg-v">
                ...
                <span class="info-u">서울대학교 의예과</span>
                <img src="<%=Application("img_path_russel")%>/common/inc/result/st_kbr.png" alt="">
            </div>
            <div class="swiper-slide bg-v">
                <strong class="info-n">양지헌</strong>
                <span class="info-c">2020 러셀 강남 재원생</span>
                <span class="info-u">서울대학교 의예과</span>
                <img src="<%=Application("img_path_russel")%>/common/inc/result/st_yjh.png" alt="">
            </div>
            <div class="swiper-slide bg-v">
                <strong class="info-n">이준수</strong>
                <span class="info-c">2020 러셀 분당 재원생</span>
                <span class="info-u">서울대학교 의예과</span>
                <img src="<%=Application("img_path_russel")%>/common/inc/result/st_ljs.png" alt="">
            </div>
            <div class="swiper-slide bg-v">
                <strong class="info-n">장지용</strong>
                <span class="info-c">2020 러셀 대치 재원생</span>
                <span class="info-u">서울대학교 의예과</span>
                <img src="<%=Application("img_path_russel")%>/common/inc/result/st_jjy.png" alt="">
            </div>
            <div class="swiper-slide bg-v">

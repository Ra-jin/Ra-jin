		...
		<div class="contentWrap">
			...
			<div class="contentArea">
				...
				<div class="content">
					...
					<% Call MenuBBSDrawPage_View(gMenuBBSGubunCode, VARS("code"), "/common/notice/notice.asp", "/common/notice/notice_view.asp", "", VARS)  %>
						<br/><br/>
					<% Call MenuBBSDrawPage_List(gMenuBBSNaviCode, gMenuBBSGubunCode, True, VARS("curPage"), 20, 10, False, "/common/notice/notice.asp", "/common/notice/notice_view.asp", "", VARS) %>

	...
	<div id="container">
		...
		<div class="contentWrap">
			...
			<div class="contentArea">
				<div class="titleDiv">
					<h3><strong>대입컨설팅 입시분석</strong></h3>
					<p class="txt">대입컨설팅센터 전문 컨설턴트의 입시분석 영상입니다.</p>
				</div>
				<!-- // titleDiv -->

				<div class="content">

					<% Call MenuBBSDrawPage_View(gMenuBBSGubunCode, VARS("code"), "/common/notice/consult.asp", "/common/notice/consult_view.asp", "", VARS)  %>
						<br/><br/>
					<% Call MenuBBSDrawPage_List(gMenuBBSNaviCode, gMenuBBSGubunCode, True, VARS("curPage"), 20, 10, False, "/common/notice/consult.asp", "/common/notice/consult_view.asp", "", VARS) %>

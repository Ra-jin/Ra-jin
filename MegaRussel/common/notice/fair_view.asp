	...
	<div id="container">
		...
		<div class="contentWrap">
			...
			<div class="contentArea">
				...
				<div class="content">
					<% Call MenuBBSDrawPage_View(gMenuBBSGubunCode, VARS("code"), "/common/notice/fair.asp", "/common/notice/fair_view.asp", "", VARS) %>
					<br/><br/>
					<% Call MenuBBSDrawPage_List(gMenuBBSNaviCode, gMenuBBSGubunCode, True, VARS("curPage"), 20, 10, False, "/common/notice/fair.asp", "/common/notice/fair_view.asp", "", VARS) %>
				</div><!-- // content -->
			</div>
			<!-- // contentArea :: 본문내용 -->

	...
	<div id="container">
		...
		<div class="contentWrap">
			...
			<div class="contentArea">
				...
				<!-- // titleDiv -->
				<div class="content">
					<% Call MenuBBSDrawPage_List(gMenuBBSNaviCode, gMenuBBSGubunCode, True, VARS("curPage"), 20, 10, True, "/common/notice/consult.asp", "/common/notice/consult_view.asp", "", VARS) %>
				</div>

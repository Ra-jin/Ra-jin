...
<div id="wrapper">
	...
	<div id="container">
		...
		<div class="contentWrap">
			...
			<div class="contentArea">
				<div class="titleDiv">
					<h3>입시정보</h3>
					<p class="txt">메가스터디학원의 다양한 입시정보를 전해드립니다.</p>
				</div>
				<!-- // titleDiv -->

				<div class="content">

					<% Call MenuBBSDrawPage_View(gMenuBBSGubunCode, VARS("code"), "/common/notice/enews.asp", "/common/notice/enews_view.asp", "", VARS)  %>
						<br/><br/>
					<% Call MenuBBSDrawPage_List(gMenuBBSNaviCode, gMenuBBSGubunCode, True, VARS("curPage"), 20, 10, False, "/common/notice/enews.asp", "/common/notice/enews_view.asp", "", VARS) %>
	...
	<!--  최하단메뉴//-->
	<!--#include virtual="/library/include/common/bottom_common.asp" -->
	<!--  //최하단메뉴-->
